...
- `DataList.Root`: A wrapper component that displays child elements (`DataList.Item`).
- `DataList.Item`: A component for list items.
- `DataList.Term`: A component that displays the term for an item.
- `DataList.Description`: A component that displays the description for an item.

Alternatively, you can omit `DataList.Item` by setting `items`.
