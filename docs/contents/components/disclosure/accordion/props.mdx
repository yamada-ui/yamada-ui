...
<PropsCard
  ...
  name="icon"
  type="string | number | boolean | ((props: { isDisabled: boolean; isExpanded: boolean; }) => ReactNode) | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<...> | ReactPortal"
