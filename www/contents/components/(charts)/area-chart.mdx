...
`AreaChart` enables Recharts' accessibility layer by default, so keyboard interaction is handled on the chart surface.

| Key          | Description                                                                                           | State                |
| ------------ | ----------------------------------------------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Moves the active data point to the next point and displays the tooltip. Focus stays on the chart.     | `withTooltip={true}` |
| `ArrowLeft`  | Moves the active data point to the previous point and displays the tooltip. Focus stays on the chart. | `withTooltip={true}` |
...
| `svg`     | `tabIndex={0}`       | Makes the chart surface keyboard focusable. |
