import{d as Kn,r as d,a as Xn,h as w,bR as Wn,f as Qn,g as Zn,aL as Yn,j as e,m as er,C as nr,bS as En,V as An,Q as Bn}from"./iframe-BC438ITz.js";import{P as Hn}from"./props-table-rYOs7oHH.js";import{u as Ln,C as _n}from"./index.esm-B9_pg0mH.js";import{F as I}from"./for-BFcfN9kX.js";import{i as u,b as rr}from"./input-GygFIjM9.js";import{u as tr}from"./index-C5SDMhPA.js";import{c as sr}from"./index-DDGUrq8Z.js";import{u as Gn,F as y}from"./use-field-props-Bp0OdyNw.js";import{G as or}from"./group-fEwsKjio.js";import"./preload-helper-C1FmrZbK.js";import"./grid-CRb6i7-K.js";import"./grid-item-B1Vc9uQ3.js";import"./flex-J2GmhlL8.js";import"./heading-DHFrLMAO.js";import"./use-input-border-CrbWhMEU.js";import"./index-BpyZLV-p.js";import"./use-breakpoint-CRoB3noN.js";import"./use-breakpoint-value-iNfHLDOJ.js";import"./use-color-mode-value-Dfyp9oAk.js";var ge,be,Se,Ie,Pe,je,Fe,ve,Re,Ce,ye,ke,ze,we,Ve,Me;const ar=Kn({base:{field:{...u.base,textAlign:"center"},root:{}},variants:{filled:{field:(ge=u.variants)==null?void 0:ge.filled},flushed:{field:(be=u.variants)==null?void 0:be.flushed},outline:{field:(Se=u.variants)==null?void 0:Se.outline},plain:{field:(Ie=u.variants)==null?void 0:Ie.plain}},sizes:{xs:{field:{boxSize:(Pe=u.sizes)==null?void 0:Pe.xs.minH,fontSize:(je=u.sizes)==null?void 0:je.xs.fontSize}},sm:{field:{boxSize:(Fe=u.sizes)==null?void 0:Fe.sm.minH,fontSize:(ve=u.sizes)==null?void 0:ve.sm.fontSize}},md:{field:{boxSize:(Re=u.sizes)==null?void 0:Re.md.minH,fontSize:(Ce=u.sizes)==null?void 0:Ce.md.fontSize}},lg:{field:{boxSize:(ye=u.sizes)==null?void 0:ye.lg.minH,fontSize:(ke=u.sizes)==null?void 0:ke.lg.fontSize}},xl:{field:{boxSize:(ze=u.sizes)==null?void 0:ze.xl.minH,fontSize:(we=u.sizes)==null?void 0:we.xl.fontSize}},"2xl":{field:{boxSize:(Ve=u.sizes)==null?void 0:Ve["2xl"].minH,fontSize:(Me=u.sizes)==null?void 0:Me["2xl"].fontSize}}},defaultProps:{size:"md",variant:"outline"}}),{DescendantsContext:ir,useDescendant:lr,useDescendants:ur}=sr(),xe=n=>n==null?void 0:n.split(""),he=(n,r)=>(r==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(n),dr=(n={})=>{const r=d.useId(),{context:{labelId:i}={},props:{id:f=r,type:p="number",autoFocus:m,defaultValue:h,disabled:P,items:F=4,manageFocus:g=!0,mask:S,otp:W=!1,placeholder:v="◯",readOnly:Q,value:Jn,onChange:Z,onComplete:b,...te},ariaProps:se,dataProps:oe,eventProps:Y}=Gn(n),l=ur(),[ae,ee]=d.useState(!0),[ie,le]=d.useState(-1),[j,k]=tr({defaultValue:xe(h)||[],value:xe(Jn),onChange:t=>Z==null?void 0:Z(t.join(""))}),ue=d.useCallback(t=>{if(!ae||!g)return;const a=l.nextValue(t,!1);a&&requestAnimationFrame(()=>a.node.focus())},[l,ae,g]),ne=d.useCallback((t,a)=>{const o=t==="next"?l.nextValue(a,!1):l.prevValue(a,!1);if(!o)return;const x=o.node.value.length;requestAnimationFrame(()=>{o.node.focus(),o.node.setSelectionRange(0,x)})},[l]),R=d.useCallback((t,a,o=!0)=>{var C;let x=[...j];x[a]=t,k(x),x=x.filter(Boolean),t!==""&&x.length===l.count()?(b==null||b(x.join("")),(C=l.value(a))==null||C.node.blur()):o&&ue(a)},[j,k,l,b,ue]),de=d.useCallback((t,a)=>{let o=a;return t!=null&&t.length&&(t.startsWith(a.charAt(0))?o=a.charAt(1):t.startsWith(a.charAt(1))&&(o=a.charAt(0))),o},[]),ce=d.useCallback(t=>({target:a})=>{var C;const o=a.value,x=j[t],z=de(x,o);if(z===""){R("",t);return}if(o.length>2){if(!he(o,p))return;const re=o.split("").filter((xr,$n)=>$n<l.count());k(re),re.length===l.count()&&(b==null||b(re.join("")),(C=l.value(t))==null||C.node.blur())}else he(z,p)&&R(z,t),ee(!0)},[l,de,b,R,k,p,j]),pe=d.useCallback(t=>a=>{g&&Xn(a,{ArrowLeft:o=>{o.preventDefault(),ne("prev",t)},ArrowRight:o=>{o.preventDefault(),ne("next",t)},Backspace:o=>{if(o.target.value===""){const x=l.prevValue(t,!1);if(!x)return;R("",t-1,!1),x.node.focus(),ee(!0)}else ee(!1)}},{preventDefault:!1})},[l,ne,g,R]),me=d.useCallback(t=>()=>le(t),[]),fe=d.useCallback(()=>le(-1),[]);d.useEffect(()=>{if(!m)return;const t=l.firstValue();t&&requestAnimationFrame(()=>t.node.focus())},[m,l]);const Nn=d.useCallback(t=>({role:"group",...te,...t}),[te]),Un=d.useCallback(({"aria-labelledby":t,index:a,...o})=>({...se,...oe,type:S?"password":p==="number"?"tel":"text","aria-labelledby":Qn(t,i),autoComplete:W?"one-time-code":"off",disabled:P,inputMode:p==="number"?"numeric":"text",placeholder:ie===a&&!Q&&!o.readOnly?"":v,readOnly:Q,value:j[a]||"",...Wn(o),id:`${f}${a?`-${a}`:""}`,onBlur:w(Y.onBlur,o.onBlur,fe),onChange:w(o.onChange,ce(a)),onFocus:w(Y.onFocus,o.onFocus,me(a)),onKeyDown:w(o.onKeyDown,pe(a))}),[se,oe,Y,S,p,i,W,P,ie,Q,v,j,f,fe,ce,me,pe]);return{descendants:l,items:F,getInputProps:Un,getRootProps:Nn}},{ComponentContext:cr,useComponentContext:pr,withContext:mr,withProvider:fr}=Zn("pin-input",ar),s=fr(({children:n,errorBorderColor:r,focusBorderColor:i,...f})=>{const{descendants:p,items:m,getInputProps:h,getRootProps:P}=dr(f),F=d.useMemo(()=>{const S=Yn(n);return S.length?S:Array.from({length:m},(W,v)=>e.jsx(c,{index:v},v))},[n,m]),g=d.useMemo(()=>({errorBorderColor:r,focusBorderColor:i,getInputProps:h}),[h,r,i]);return e.jsx(ir,{value:p,children:e.jsx(cr,{value:g,children:e.jsx(or,{...P(),children:F})})})},"root")(),c=mr(rr,"field")(void 0,({ref:n,index:r,...i})=>{const{errorBorderColor:f,focusBorderColor:p,getInputProps:m}=pr(),{register:h}=lr(),{props:P,ariaProps:F,dataProps:g,eventProps:S}=Gn(i);return{...m({errorBorderColor:f,focusBorderColor:p,...F,...g,...S,...P,ref:er(h,n),index:r})}}),qr={component:s,title:"Components / PinInput"},V=()=>e.jsx(s,{}),M=()=>e.jsx(I,{each:[3,4,5,6],children:(n,r)=>e.jsx(s,{items:n},r)}),D=()=>e.jsx(Hn,{variant:"stack",columns:["outline","filled","flushed"],rows:nr,children:(n,r,i)=>e.jsx(s,{colorScheme:r,variant:n},i)}),O=()=>e.jsx(Hn,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(n,r,i)=>e.jsx(s,{size:n,variant:r},i)}),q=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{type:"alphanumeric"})]}),T=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{defaultValue:"1234"}),e.jsx(s,{defaultValue:"123"})]}),E=()=>{const{page:n}=En();return e.jsx(s,{onComplete:()=>n.start({duration:5e3})})},A=()=>e.jsx(s,{otp:!0}),B=()=>e.jsx(s,{mask:!0}),H=()=>e.jsx(s,{manageFocus:!1}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,disabled:!0},r)}),e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(c,{disabled:!0,index:0}),e.jsx(c,{disabled:!0,index:1}),e.jsx(c,{disabled:!0,index:2}),e.jsx(c,{disabled:!0,index:3})]},r)}),e.jsx(y,{disabled:!0,errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",children:e.jsx(s,{})})]}),_=()=>e.jsxs(e.Fragment,{children:[e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,readOnly:!0},r)}),e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(c,{index:0,readOnly:!0}),e.jsx(c,{index:1,readOnly:!0}),e.jsx(c,{index:2,readOnly:!0}),e.jsx(c,{index:3,readOnly:!0})]},r)}),e.jsx(y,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",readOnly:!0,children:e.jsx(s,{})})]}),G=()=>e.jsxs(e.Fragment,{children:[e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,invalid:!0},r)}),e.jsx(I,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(c,{index:0,invalid:!0}),e.jsx(c,{index:1,invalid:!0}),e.jsx(c,{index:2,invalid:!0}),e.jsx(c,{index:3,invalid:!0})]},r)}),e.jsx(y,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",invalid:!0,label:"Please one-time password",children:e.jsx(s,{})})]}),J=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{focusBorderColor:"green.500"}),e.jsx(s,{errorBorderColor:"orange.500",invalid:!0})]}),N=()=>e.jsxs(s,{children:[e.jsx(c,{index:0}),e.jsx(c,{index:1}),e.jsx(c,{index:2}),e.jsx(c,{index:3})]}),U=()=>e.jsx(s,{placeholder:"💩"}),$=()=>{const{page:n}=En(),[r,i]=d.useState(""),f=()=>n.start({duration:5e3});return e.jsx(s,{value:r,onChange:i,onComplete:f})},K=()=>{var p;const{control:n,formState:{errors:r},handleSubmit:i}=Ln(),f=m=>console.log("submit:",m);return e.jsxs(An,{as:"form",onSubmit:i(f),children:[e.jsx(y,{errorMessage:(p=r.pinInput)==null?void 0:p.message,invalid:!!r.pinInput,label:"Token",children:e.jsx(_n,{name:"pinInput",control:n,render:({field:m})=>e.jsx(s,{...m}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(Bn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},X=()=>{var m;const n={pinInput:"5"},{control:r,formState:{errors:i},handleSubmit:f}=Ln({defaultValues:n}),p=h=>console.log("submit:",h);return e.jsxs(An,{as:"form",onSubmit:f(p),children:[e.jsx(y,{errorMessage:(m=i.pinInput)==null?void 0:m.message,invalid:!!i.pinInput,label:"Token",children:e.jsx(_n,{name:"pinInput",control:r,render:({field:h})=>e.jsx(s,{...h}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(Bn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var De,Oe,qe;V.parameters={...V.parameters,docs:{...(De=V.parameters)==null?void 0:De.docs,source:{originalSource:`() => {
...
}`,...(Je=(Ge=O.parameters)==null?void 0:Ge.docs)==null?void 0:Je.source}}};var Ne,Ue,$e;q.parameters={...q.parameters,docs:{...(Ne=q.parameters)==null?void 0:Ne.docs,source:{originalSource:`() => {
  return <>
      <PinInput.Root />

      <PinInput.Root type="alphanumeric" />
    </>;
}`,...($e=(Ue=q.parameters)==null?void 0:Ue.docs)==null?void 0:$e.source}}};var Ke,Xe,We;T.parameters={...T.parameters,docs:{...(Ke=T.parameters)==null?void 0:Ke.docs,source:{originalSource:`() => {
  return <>
...
}`,...(bn=(gn=G.parameters)==null?void 0:gn.docs)==null?void 0:bn.source}}};var Sn,In,Pn;J.parameters={...J.parameters,docs:{...(Sn=J.parameters)==null?void 0:Sn.docs,source:{originalSource:`() => {
  return <>
      <PinInput.Root />
...
}`,...(Pn=(In=J.parameters)==null?void 0:In.docs)==null?void 0:Pn.source}}};var jn,Fn,vn;N.parameters={...N.parameters,docs:{...(jn=N.parameters)==null?void 0:jn.docs,source:{originalSource:`() => {
  return <PinInput.Root>
...
}`,...(vn=(Fn=N.parameters)==null?void 0:Fn.docs)==null?void 0:vn.source}}};var Rn,Cn,yn;U.parameters={...U.parameters,docs:{...(Rn=U.parameters)==null?void 0:Rn.docs,source:{originalSource:`() => {
  return <PinInput.Root placeholder="💩" />;
}`,...(yn=(Cn=U.parameters)==null?void 0:Cn.docs)==null?void 0:yn.source}}};var kn,zn,wn;$.parameters={...$.parameters,docs:{...(kn=$.parameters)==null?void 0:kn.docs,source:{originalSource:`() => {
  const {
    page
  } = useLoading();
...
}`,...(wn=(zn=$.parameters)==null?void 0:zn.docs)==null?void 0:wn.source}}};var Vn,Mn,Dn;K.parameters={...K.parameters,docs:{...(Vn=K.parameters)==null?void 0:Vn.docs,source:{originalSource:`() => {
  interface Data {
    pinInput: string;
  }
  const {
...
}`,...(Dn=(Mn=K.parameters)==null?void 0:Mn.docs)==null?void 0:Dn.source}}};var On,qn,Tn;X.parameters={...X.parameters,docs:{...(On=X.parameters)==null?void 0:On.docs,source:{originalSource:`() => {
  interface Data {
    pinInput: string;
  }
