...
| ------------ | --------------------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Keeps focus on the chart and shows the tooltip for the next data point.     | `withTooltip={true}` |
| `ArrowLeft`  | Keeps focus on the chart and shows the tooltip for the previous data point. | `withTooltip={true}` |
...
| --------- | ------------------------------------ | ---------------------------------------------------- |
| `svg`     | `role="application"`, `tabIndex={0}` | Indicates the chart is a focusable application area. |
