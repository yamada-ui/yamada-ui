...
:::tip
If you want to display a list of terms and their descriptions, use [DataList](/docs/components/data-list).
:::

:::tip
If you want to display a list of column names and their corresponding data, consider using [NativeTable](/docs/components/native-table).
:::
