import{j as r,T as o}from"./iframe-Bn8cMbTR.js";import{u as i}from"./index-BcIfbz0J.js";import"./preload-helper-D9Z9MdNV.js";import"./index-B3Oypcl0.js";const x={title:"Hooks / useAsync"},e=()=>{const{error:s,loading:n,value:t}=i(async()=>new Promise((a,c)=>{setTimeout(()=>{Math.random()>.5?a("✌️"):c(new Error("A pseudo random error occurred"))},3e3)}),[]);return n?r.jsx(o,{children:"Loading..."}):s?r.jsxs(o,{children:["Error: ",s.message]}):r.jsxs(o,{children:["Value: ",t]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  const {
    error,
    loading,
    value
