...
Yamada UIは、人工知能（AI）ツールの支援を活用した貢献を含め、すべての方からの貢献を歓迎します。AIを用いて貢献を行う場合は、以下の[AI利用ポリシー](/docs/community/ai-policy)に従ってください。
...
3. 変更を行い、[コミット規約](#commit-convention)に従ってコミットします。
