import{aq as x,r as d,j as g,B as m,ar as k}from"./iframe-Bly_QBCH.js";import{u as B}from"./index-Bzdo0mDY.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bcta51Fc.js";const p=(n,a,{loading:s=!1,loadingOptions:u,processing:i=!0}={})=>{const e=x(),{finish:o,loading:C,start:t}=B(),l=!!s,y=d.useCallback(async(...w)=>{try{return i&&t(),l&&e[s].start(u),await n(...w)}finally{i&&o(),l&&e[s].finish()}},[...a,i,l,e,s,u,n,t,o]),f=d.useMemo(()=>({finish:o,start:t}),[o,t]);return[C,y,f]},E={title:"Hooks / useAsyncCallback"},c=()=>{const[n,a]=p(async()=>{await k(3e3)},[]);return g.jsx(m,{loading:n,onClick:a,children:"Click me"})},r=()=>{const[n,a]=p(async()=>{await k(3e3)},[],{loading:"page"});return g.jsx(m,{loading:n,onClick:a,children:"Click me"})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => {
