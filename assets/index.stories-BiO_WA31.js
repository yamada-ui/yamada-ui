import{aB as c,j as p}from"./iframe-BeS4TnDj.js";import{u as e}from"./index-D1xWl5zn.js";import{B as u}from"./box-BhQ0r-Rd.js";import{u as d}from"./use-breakpoint-BfYkKzyo.js";import"./preload-helper-C1FmrZbK.js";import"./use-breakpoint-value-BNKmug4C.js";import"./use-color-mode-value-CWApeZ7_.js";const M={title:"Hooks / useValue"},o=()=>{const{colorMode:s}=c(),a=d(),l=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),i=e(["whiteAlpha.800","blackAlpha.800"]);return p.jsxs(u,{bg:l,color:i,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',a,'", colorMode is "',s,'"']})};var r,t,n;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
