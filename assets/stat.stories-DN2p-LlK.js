import{bb as U,bc as L,bd as k,k as I,ac as H,j as e,F as E,E as _,G as F,C as f}from"./iframe-Bly_QBCH.js";import{P as b}from"./props-table-C3vMHLRE.js";import"./preload-helper-PPVm8Dsz.js";import"./grid-BGUI98px.js";import"./grid-item-HANaGcfZ.js";import"./for-6VbXiyE7.js";import"./flex-ClwVNL9a.js";import"./heading-CT_rir98.js";const A=[["path",{d:"M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z",key:"14u9p9"}]],O=U("triangle",A),D=L(k)({as:O}),K=I({base:{helperMessage:{alignItems:"center",color:"fg.muted",display:"inline-flex"},icon:{"&[data-type='decrease']":{color:"fg.error",fill:"fg.error",transform:"rotate(180deg)"},"&[data-type='increase']":{color:"fg.success",fill:"fg.success"},fontSize:"1em",me:"1",verticalAlign:"middle"},label:{color:"fg.muted",fontWeight:"medium"},root:{display:"flex",flexDirection:"column"},unit:{color:"fg.muted",fontWeight:"initial",letterSpacing:"initial"},value:{alignItems:"baseline",color:"colorScheme.solid",display:"inline-flex",fontFeatureSettings:'"pnum"',fontVariantNumeric:"proportional-nums",fontWeight:"semibold",letterSpacing:"tight",lineHeight:"1",verticalAlign:"baseline"}},props:{centerContent:{false:{root:{alignItems:"flex-start"}},true:{root:{alignItems:"center"}}}},sizes:{xs:{helperMessage:{fontSize:"xs"},label:{fontSize:"sm"},root:{gap:"1"},unit:{fontSize:"sm"},value:{fontSize:"3xl",gap:"1"}},sm:{helperMessage:{fontSize:"xs"},label:{fontSize:"sm"},root:{gap:"1"},unit:{fontSize:"sm"},value:{fontSize:"4xl",gap:"1"}},md:{helperMessage:{fontSize:"sm"},label:{fontSize:"md"},root:{gap:"2"},unit:{fontSize:"md"},value:{fontSize:"5xl",gap:"1.5"}},lg:{helperMessage:{fontSize:"sm"},label:{fontSize:"md"},root:{gap:"2"},unit:{fontSize:"md"},value:{fontSize:"6xl",gap:"2"}}},defaultProps:{size:"md"}}),{withContext:i,withProvider:W}=F("stat",K),t=W(({children:s,helperMessage:r,icon:a,label:j,value:M,helperMessageProps:v,iconProps:z,labelProps:T,valueProps:y,...C})=>{const[w,P,R,V]=H(s,o,l,g);return e.jsxs(E.dl,{...C,children:[P??e.jsx(o,{...T,children:j}),R??e.jsx(l,{...y,children:M}),V??e.jsxs(g,{...v,children:[a?e.jsx(x,{type:a,...z}):null,r]}),w]})},"root")(),x=i(({type:s="increase",...r})=>{const{t:a}=_("stat");return e.jsx(D,{"aria-label":a(s==="increase"?"Increased by":"Decreased by"),"data-type":s,...r})},"icon")(),o=i("dt","label")(),l=i("dd","value")(),n=i("span","unit")(),g=i("dd","helperMessage")(),Y={component:t,title:"Components / Stat"},c=()=>e.jsxs(t,{children:[e.jsx(o,{children:"Total Page Views"}),e.jsx(l,{children:"1,993,818"}),e.jsxs(g,{children:[e.jsx(x,{type:"increase"}),"21% more than last month"]})]}),m=()=>e.jsx(t,{helperMessage:"21% more than last month",icon:"increase",label:"Total Page Views",value:"1,993,818"}),p=()=>e.jsx(b,{columns:["xs","sm","md","lg"],rows:f,children:(s,r,a)=>e.jsx(t,{colorScheme:r,size:s,label:"Time to complete",value:e.jsxs(e.Fragment,{children:["8",e.jsx(n,{children:"hr"}),"18",e.jsx(n,{children:"min"})]})},a)}),u=()=>e.jsx(b,{variant:"stack",rows:f,children:(s,r,a)=>e.jsx(t,{colorScheme:r,helperMessage:"21% more than last month",label:"Total Likes",value:"818K"},a)}),d=()=>e.jsx(t,{centerContent:!0,helperMessage:"From August 1 to August 18",icon:"increase",label:"Downloads",value:"18K"}),S=()=>e.jsxs(e.Fragment,{children:[e.jsx(t,{label:"Time to complete",value:e.jsxs(e.Fragment,{children:["8",e.jsx(n,{children:"hr"}),"18",e.jsx(n,{children:"min"})]})}),e.jsxs(t,{children:[e.jsx(o,{children:"Time to complete"}),e.jsxs(l,{children:["8",e.jsx(n,{children:"hr"}),"18",e.jsx(n,{children:"min"})]})]})]}),h=()=>e.jsxs(e.Fragment,{children:[e.jsx(t,{helperMessage:"21% more than last month",icon:"decrease",label:"Total Page Views",value:"1,993,818"}),e.jsxs(t,{children:[e.jsx(o,{children:"Total Page Views"}),e.jsx(l,{children:"1,993,818"}),e.jsxs(g,{children:[e.jsx(x,{type:"decrease"}),"21% more than last month"]})]})]});c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => {
  return <Stat.Root>
