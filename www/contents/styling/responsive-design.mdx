...
:::tip
By default, responsive design using `@media(max-width)` media queries is adopted. If you want to use `@media(min-width)` media queries, please refer to the [Breakpoints](/docs/theming/breakpoints#media-queries).
:::
