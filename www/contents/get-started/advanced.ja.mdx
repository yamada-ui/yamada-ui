...
:::note
詳しくは[レイヤースタイル](/docs/styling/layer-styles)をご覧ください。
:::
...
:::note
詳しくは[テキストスタイル](/docs/styling/text-styles)をご覧ください。
:::
...
:::note
詳しくは[アニメーション](/docs/styling/animation)をご覧ください。
:::
...
:::note
詳しくは[Motion](/docs/components/motion)をご覧ください。
:::
