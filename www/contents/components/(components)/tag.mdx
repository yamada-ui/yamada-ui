...
:::tip
If you want to highlight the status of an item, use a [Badge](/docs/components/badge).
:::
...
| --------------------------------- | -------------------- | -------------------------------------- |
| `span.ui-tag__icon--close-button` | `role="button"`      | Indicates that this is a close button. |
