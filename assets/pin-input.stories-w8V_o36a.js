import{d as Ce,r as c,a as Re,h as w,bH as ye,g as ke,ab as ze,j as e,m as we,C as Ve,b8 as fe,V as xe,S as he}from"./iframe-DJ0yX4dv.js";import{P as ge}from"./props-table-BghCA-CF.js";import{u as Se,C as be}from"./index.esm-B6dNvjql.js";import{F as b}from"./for-DYqikCUI.js";import{i as d,b as Me}from"./input-CcCaO-E-.js";import{u as De}from"./index-Cxp2UHtg.js";import{c as Oe}from"./index-CeEhajmR.js";import{u as Ie,F}from"./use-field-props-Dn_XRDl3.js";import{G as qe}from"./group-BLk3tCQn.js";import"./preload-helper-PPVm8Dsz.js";import"./grid-DQ8CIDMJ.js";import"./grid-item-cFKDS_xu.js";import"./flex-DF7MWlRZ.js";import"./heading-BZy_ed_2.js";import"./use-input-border-DFoZHVae.js";import"./index-Bsr4q0ET.js";import"./use-breakpoint-DvjERWIj.js";import"./use-breakpoint-value-XHGZ9LH9.js";import"./use-color-mode-value-HUZW6Q_L.js";const Te=Ce({base:{field:{...d.base,textAlign:"center"},root:{}},variants:{filled:{field:d.variants?.filled},flushed:{field:d.variants?.flushed},outline:{field:d.variants?.outline},plain:{field:d.variants?.plain}},sizes:{xs:{field:{boxSize:d.sizes?.xs.minH,fontSize:d.sizes?.xs.fontSize}},sm:{field:{boxSize:d.sizes?.sm.minH,fontSize:d.sizes?.sm.fontSize}},md:{field:{boxSize:d.sizes?.md.minH,fontSize:d.sizes?.md.fontSize}},lg:{field:{boxSize:d.sizes?.lg.minH,fontSize:d.sizes?.lg.fontSize}},xl:{field:{boxSize:d.sizes?.xl.minH,fontSize:d.sizes?.xl.fontSize}},"2xl":{field:{boxSize:d.sizes?.["2xl"].minH,fontSize:d.sizes?.["2xl"].fontSize}}},defaultProps:{size:"md",variant:"outline"}}),{DescendantsContext:Ee,useDescendant:Ae,useDescendants:Be}=Oe(),pe=r=>r?.split(""),me=(r,t)=>(t==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(r),He=(r={})=>{const t=c.useId(),{props:{id:i=t,type:l="number",autoFocus:m,defaultValue:x,disabled:g,manageFocus:h=!0,mask:I,otp:P=!1,placeholder:S="◯",readOnly:C,value:R,onChange:Pe,onComplete:y,...ee},ariaProps:ne,dataProps:re,eventProps:W}=Ie(r),u=Be(),[te,Z]=c.useState(!0),[se,oe]=c.useState(-1),[v,k]=De({defaultValue:pe(x)||[],value:pe(R),onChange:n=>Pe?.(n.join(""))}),ae=c.useCallback(n=>{if(!te||!h)return;const o=u.nextValue(n,!1);o&&requestAnimationFrame(()=>o.node.focus())},[u,te,h]),Q=c.useCallback((n,o)=>{const a=n==="next"?u.nextValue(o,!1):u.prevValue(o,!1);if(!a)return;const f=a.node.value.length;requestAnimationFrame(()=>{a.node.focus(),a.node.setSelectionRange(0,f)})},[u]),j=c.useCallback((n,o,a=!0)=>{let f=[...v];f[o]=n,k(f),f=f.filter(Boolean),n!==""&&f.length===u.count()?(y?.(f.join("")),u.value(o)?.node.blur()):a&&ae(o)},[v,k,u,y,ae]),ie=c.useCallback((n,o)=>{let a=o;return n?.length&&(n.startsWith(o.charAt(0))?a=o.charAt(1):n.startsWith(o.charAt(1))&&(a=o.charAt(0))),a},[]),le=c.useCallback(n=>({target:o})=>{const a=o.value,f=v[n],z=ie(f,a);if(z===""){j("",n);return}if(a.length>2){if(!me(a,l))return;const Y=a.split("").filter((Ne,Fe)=>Fe<u.count());k(Y),Y.length===u.count()&&(y?.(Y.join("")),u.value(n)?.node.blur())}else me(z,l)&&j(z,n),Z(!0)},[u,ie,y,j,k,l,v]),ue=c.useCallback(n=>o=>{h&&Re(o,{ArrowLeft:a=>{a.preventDefault(),Q("prev",n)},ArrowRight:a=>{a.preventDefault(),Q("next",n)},Backspace:a=>{if(a.target.value===""){const f=u.prevValue(n,!1);if(!f)return;j("",n-1,!1),f.node.focus(),Z(!0)}else Z(!1)}},{preventDefault:!1})},[u,Q,h,j]),de=c.useCallback(n=>()=>oe(n),[]),ce=c.useCallback(()=>oe(-1),[]);c.useEffect(()=>{if(!m)return;const n=u.firstValue();n&&requestAnimationFrame(()=>n.node.focus())},[m,u]);const ve=c.useCallback(n=>({role:"group",...ee,...n}),[ee]),je=c.useCallback(({index:n,...o})=>({...ne,...re,type:I?"password":l==="number"?"tel":"text",autoComplete:P?"one-time-code":"off",disabled:g,inputMode:l==="number"?"numeric":"text",placeholder:se===n&&!C&&!o.readOnly?"":S,readOnly:C,value:v[n]||"",...ye(o),id:`${i}${n?`-${n}`:""}`,onBlur:w(W.onBlur,o.onBlur,ce),onChange:w(o.onChange,le(n)),onFocus:w(W.onFocus,o.onFocus,de(n)),onKeyDown:w(o.onKeyDown,ue(n))}),[ne,re,W,I,l,g,C,i,P,se,S,v,ce,le,de,ue]);return{descendants:u,getInputProps:je,getRootProps:ve}},{ComponentContext:Le,useComponentContext:_e,withContext:Ge,withProvider:Je}=ke("pin-input",Te),s=Je(({children:r,errorBorderColor:t,focusBorderColor:i,items:l=4,...m})=>{const{descendants:x,getInputProps:g,getRootProps:h}=He(m),I=c.useMemo(()=>{const S=ze(r);return S.length?S:Array.from({length:l},(C,R)=>e.jsx(p,{index:R},R))},[r,l]),P=c.useMemo(()=>({errorBorderColor:t,focusBorderColor:i,getInputProps:g}),[g,t,i]);return e.jsx(Ee,{value:x,children:e.jsx(Le,{value:P,children:e.jsx(qe,{...h(),children:I})})})},"root")(),p=Ge(Me,"field")(void 0,({ref:r,index:t,...i})=>{const{errorBorderColor:l,focusBorderColor:m,getInputProps:x}=_e(),{register:g}=Ae(),{props:h,ariaProps:I,dataProps:P,eventProps:S}=Ie(i);return{...x({errorBorderColor:l,focusBorderColor:m,...I,...P,...S,...h,ref:we(g,r),index:t})}}),pn={component:s,title:"Components / PinInput"},V=()=>e.jsx(s,{}),M=()=>e.jsx(b,{each:[3,4,5,6],children:(r,t)=>e.jsx(s,{items:r},t)}),D=()=>e.jsx(ge,{variant:"stack",columns:["outline","filled","flushed"],rows:Ve,children:(r,t,i)=>e.jsx(s,{colorScheme:t,variant:r},i)}),O=()=>e.jsx(ge,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(r,t,i)=>e.jsx(s,{size:r,variant:t},i)}),q=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{type:"alphanumeric"})]}),T=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{defaultValue:"1234"}),e.jsx(s,{defaultValue:"123"})]}),E=()=>{const{page:r}=fe();return e.jsx(s,{onComplete:()=>r.start({duration:5e3})})},A=()=>e.jsx(s,{otp:!0}),B=()=>e.jsx(s,{mask:!0}),H=()=>e.jsx(s,{manageFocus:!1}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsx(s,{variant:r,disabled:!0},t)}),e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsxs(s,{variant:r,children:[e.jsx(p,{disabled:!0,index:0}),e.jsx(p,{disabled:!0,index:1}),e.jsx(p,{disabled:!0,index:2}),e.jsx(p,{disabled:!0,index:3})]},t)}),e.jsx(F,{disabled:!0,errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",children:e.jsx(s,{})})]}),_=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsx(s,{variant:r,readOnly:!0},t)}),e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsxs(s,{variant:r,children:[e.jsx(p,{index:0,readOnly:!0}),e.jsx(p,{index:1,readOnly:!0}),e.jsx(p,{index:2,readOnly:!0}),e.jsx(p,{index:3,readOnly:!0})]},t)}),e.jsx(F,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",readOnly:!0,children:e.jsx(s,{})})]}),G=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsx(s,{variant:r,invalid:!0},t)}),e.jsx(b,{each:["outline","filled","flushed"],children:(r,t)=>e.jsxs(s,{variant:r,children:[e.jsx(p,{index:0,invalid:!0}),e.jsx(p,{index:1,invalid:!0}),e.jsx(p,{index:2,invalid:!0}),e.jsx(p,{index:3,invalid:!0})]},t)}),e.jsx(F,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",invalid:!0,label:"Please one-time password",children:e.jsx(s,{})})]}),J=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{focusBorderColor:"green.500"}),e.jsx(s,{errorBorderColor:"orange.500",invalid:!0})]}),N=()=>e.jsxs(s,{children:[e.jsx(p,{index:0}),e.jsx(p,{index:1}),e.jsx(p,{index:2}),e.jsx(p,{index:3})]}),U=()=>e.jsx(s,{placeholder:"💩"}),$=()=>{const{page:r}=fe(),[t,i]=c.useState(""),l=()=>r.start({duration:5e3});return e.jsx(s,{value:t,onChange:i,onComplete:l})},K=()=>{const{control:r,formState:{errors:t},handleSubmit:i}=Se(),l=m=>console.log("submit:",m);return e.jsxs(xe,{as:"form",onSubmit:i(l),children:[e.jsx(F,{errorMessage:t.pinInput?.message,invalid:!!t.pinInput,label:"Token",children:e.jsx(be,{name:"pinInput",control:r,render:({field:m})=>e.jsx(s,{...m}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(he,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},X=()=>{const r={pinInput:"5"},{control:t,formState:{errors:i},handleSubmit:l}=Se({defaultValues:r}),m=x=>console.log("submit:",x);return e.jsxs(xe,{as:"form",onSubmit:l(m),children:[e.jsx(F,{errorMessage:i.pinInput?.message,invalid:!!i.pinInput,label:"Token",children:e.jsx(be,{name:"pinInput",control:t,render:({field:x})=>e.jsx(s,{...x}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(he,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`() => {
