...
:::tip
`HydrationContext`は、オプショナルです。`HydrationContext`は、コンポーネントに`suppressHydrationWarning`が設定された場合に、子要素にその値を伝播させるために使用します。
:::
...
:::tip
`HydrationContext`は、オプショナルです。`HydrationContext`は、ルートコンポーネントに`suppressHydrationWarning`が設定された場合に、スロットコンポーネントにその値を伝播させるために使用します。
:::
