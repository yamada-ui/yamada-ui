...
}`,...(P=(L=x.parameters)==null?void 0:L.docs)==null?void 0:P.source}}};var N,Y,G;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`() => {
  return <>
...
}`,...(re=(ee=z.parameters)==null?void 0:ee.docs)==null?void 0:re.source}}};var ae,te,oe;S.parameters={...S.parameters,docs:{...(ae=S.parameters)==null?void 0:ae.docs,source:{originalSource:`() => {
  return <>
...
}`,...(oe=(te=S.parameters)==null?void 0:te.docs)==null?void 0:oe.source}}};var se,ne,le;v.parameters={...v.parameters,docs:{...(se=v.parameters)==null?void 0:se.docs,source:{originalSource:`() => {
  return <>
...
}`,...(le=(ne=v.parameters)==null?void 0:ne.docs)==null?void 0:le.source}}};var ie,de,ce;y.parameters={...y.parameters,docs:{...(ie=y.parameters)==null?void 0:ie.docs,source:{originalSource:`() => {
  return <>
...
}`,...(ze=(be=w.parameters)==null?void 0:be.docs)==null?void 0:ze.source}}};var Se,ve,ye;k.parameters={...k.parameters,docs:{...(Se=k.parameters)==null?void 0:Se.docs,source:{originalSource:`() => {
  type Data = {
    textarea: string;
  };
...
}`,...(ye=(ve=k.parameters)==null?void 0:ve.docs)==null?void 0:ye.source}}};const Sr=["basic","withSize","withVariant","withResize","withAutosize","withBorderColor","isDisabled","isReadonly","isInvalid","stylingPlaceholder","useResize","reactHookForm","reactHookFormWithDefaultValue"];export{Sr as __namedExportsOrder,p as basic,zr as default,S as isDisabled,y as isInvalid,v as isReadonly,w as reactHookForm,k as reactHookFormWithDefaultValue,j as stylingPlaceholder,T as useResize,b as withAutosize,z as withBorderColor,g as withResize,x as withSize,f as withVariant};
