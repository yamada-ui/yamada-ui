...
:::note
`Motion` uses [Motion](https://motion.dev) internally. If you want to know more about the component's features, please refer to the [React motion component](https://motion.dev/docs/react-motion-component).
:::
...
:::note
Variants' animation to know more about the animation of variants, please refer to the [Variants](https://motion.dev/docs/react-animation#variants).
:::
...
:::note
Hover's animation to know more about the animation of hover, please refer to the [React hover animation guide](https://motion.dev/docs/react-hover-animation).
:::
...
:::note
Click/Tap's animation to know more about the animation of click/tap, please refer to the [Tap](https://motion.dev/docs/react-gestures#tap).
:::
...
:::note
Focus's animation to know more about the animation of focus, please refer to the [Focus](https://motion.dev/docs/react-gestures#focus).
:::
...
:::note
Drag's animation to know more about the animation of drag, please refer to the [React drag animation guide](https://motion.dev/docs/react-drag).
:::
