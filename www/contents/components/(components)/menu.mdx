...
:::tip
Use `Menu` for a compact list of actions or commands opened from a trigger. If users are choosing a value for a form field, use [Select](/docs/components/select).
:::
