...
}`,...(Jr=(qr=Se.parameters)==null?void 0:qr.docs)==null?void 0:Jr.source}}};var Zr,Qr,eo;Oe.parameters={...Oe.parameters,docs:{...(Zr=Oe.parameters)==null?void 0:Zr.docs,source:{originalSource:`() => {
  return <>
...
}`,...(jo=(Do=Le.parameters)==null?void 0:Do.docs)==null?void 0:jo.source}}};const ct=["basic","withSize","withVariant","withMultiple","withAccept","withMaxSize","withMaxFiles","withStatus","useOnDrop","useOnDropAccepted","useOnDropRejected","withBorderColor","isDisabled","isReadonly","isInvalid","isLoading","customLoading","useOpen"];export{ct as __namedExportsOrder,ze as basic,Re as customLoading,at as default,Ce as isDisabled,_e as isInvalid,Ie as isLoading,Pe as isReadonly,Fe as useOnDrop,Ee as useOnDropAccepted,Se as useOnDropRejected,Le as useOpen,ve as withAccept,Oe as withBorderColor,Ae as withMaxFiles,Te as withMaxSize,be as withMultiple,ye as withSize,we as withStatus,ke as withVariant};
