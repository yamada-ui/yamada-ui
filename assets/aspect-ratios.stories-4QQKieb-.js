import{j as e,E as a,T as o,bC as i}from"./iframe-B58gGoPv.js";import{H as d}from"./heading-Cefe2Dmh.js";import{F as l}from"./for-Bky_3Tl1.js";import{C as c,b as m}from"./container-CMvolHod.js";const b={title:"Theme / Tokens / Aspect Ratios"},r=()=>e.jsxs(e.Fragment,{children:[e.jsx(d,{children:"Aspect Ratios"}),e.jsx(c,{children:e.jsx(m,{alignItems:"center",display:"grid",gap:"lg",gridTemplateColumns:"repeat(auto-fill, minmax({sizes.xs}, 1fr))",children:e.jsx(l,{each:Object.entries(i),children:([t,n],s)=>e.jsxs(a,{aspectRatio:t,bg:"bg",borderColor:"border.subtle",borderWidth:"1px",flexDirection:"column",rounded:"l2",children:[e.jsx(o,{children:t}),e.jsx(o,{color:"fg.muted",children:n})]},s)})})})]});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => {
  return <>
