import{j as r,T as o}from"./iframe-Gd2wA5UH.js";import{u as i}from"./index-BNB2xLLI.js";import"./preload-helper-PPVm8Dsz.js";import"./index-LIYpIBCz.js";const x={title:"Hooks / useAsync"},e=()=>{const{error:s,loading:n,value:t}=i(async()=>new Promise((a,c)=>{setTimeout(()=>{Math.random()>.5?a("✌️"):c(new Error("A pseudo random error occurred"))},3e3)}),[]);return n?r.jsx(o,{children:"Loading..."}):s?r.jsxs(o,{children:["Error: ",s.message]}):r.jsxs(o,{children:["Value: ",t]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  const {
    error,
    loading,
    value
