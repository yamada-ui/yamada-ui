import{j as o,Q as u,ah as m,T as p}from"./iframe-BkSt7vyM.js";import{u as d}from"./index-I2nvmVQ6.js";import{M as s}from"./motion-BG9Zn0Dn.js";import{B as x}from"./box-D31hHSyQ.js";import{u as y}from"./use-scroll-BzIy0IZk.js";import{u as e}from"./use-transform-DCltKgo9.js";import"./preload-helper-PPVm8Dsz.js";const j={component:s,title:"Components / Motion / Utils"},t=()=>{const[n,{toggle:i}]=d();return o.jsxs(o.Fragment,{children:[o.jsx(u,{onClick:i,children:"Please click"}),o.jsx(m,{children:n?o.jsx(s,{animate:{opacity:1},bg:"mono",color:"mono.contrast",exit:{opacity:0},initial:{opacity:0},p:"md",rounded:"l2",children:"Motion"}):null})]})},r=()=>{const{scrollYProgress:n}=y(),i=e(n,[0,1],[0,400]),l=e(n,[0,1],[0,-400]),a=e(n,[0,1],[0,200]),c=e(n,[0,1],[0,-200]);return o.jsxs(x,{h:"300vh",position:"relative",w:"full",children:[o.jsx(p,{children:"Please scroll"}),o.jsx(s,{style:{y:i},bg:"info",boxSize:"2xs",left:"0",position:"absolute",rounded:"full",top:"110vh"}),o.jsx(s,{style:{y:l},bg:"success",boxSize:"sm",left:"20%",position:"absolute",rounded:"full",top:"120vh"}),o.jsx(s,{style:{y:a},bg:"warning",boxSize:"3xs",position:"absolute",right:"30%",rounded:"full",top:"110vh"}),o.jsx(s,{style:{y:c},bg:"danger",boxSize:"xs",position:"absolute",right:"0",rounded:"full",top:"120vh"})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const [visible, {
    toggle
  }] = useBoolean();
  return <>
