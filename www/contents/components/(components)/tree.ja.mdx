...
| `li.ui-tree__item`        | `role="treeitem"`      | ツリーの項目であることを示します。                                                                 |
...
|                           | `aria-labelledby`      | 関連した`span.ui-tree__label`の`id`を設定します。                                                  |
| `span.ui-tree__label`     | `id`                   | `li.ui-tree__item`と`ul.ui-tree__group`と`input.ui-tree__checkbox`を関連付けするために使用する`id` |
