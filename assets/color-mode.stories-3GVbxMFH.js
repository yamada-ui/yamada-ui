import{j as d}from"./jsx-runtime-X2b_N9AH.js";import{o as p,G as t}from"./factory-C0k1XOS4.js";import{B as u}from"./box-DKSEjJIJ.js";import"./index-uCp2LrAq.js";import"./_commonjsHelpers-BosuxZz1.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-xaNYqS-v.js";const w={title:"System / Styles / Color Mode"},o=()=>{const{colorMode:e}=p();return d.jsxs(u,{bg:["blackAlpha.800","whiteAlpha.800"],p:"md",rounded:"md",color:["whiteAlpha.800","blackAlpha.800"],transitionProperty:"all",transitionDuration:"normal",children:['The current colorMode is "',e,'"']})},r=()=>{const{colorMode:e}=p(),m=t("blackAlpha.800","whiteAlpha.800"),h=t("whiteAlpha.800","blackAlpha.800");return d.jsxs(u,{bg:m,p:"md",rounded:"md",color:h,transitionProperty:"all",transitionDuration:"normal",children:['The current colorMode is "',e,'"']})};var a,l,n;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
