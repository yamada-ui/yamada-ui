...
<PackageManagers
  packageNameOrCommand={{
    pnpm: "pnpm add @yamada-ui/react react react-dom",
    npm: "npm install @yamada-ui/react react react-dom",
    yarn: "yarn @yamada-ui/react react react-dom",
    bun: "bun install @yamada-ui/react react react-dom",
  }}
/>
...
```json live=false title=tsconfig.json highlight={11}
{
  "compilerOptions": {
    "target": "ESNext",
    "module": "ESNext",
