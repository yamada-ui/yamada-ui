---
title: Card
description: "`Card`は、関連する情報をグループ化して表示するコンポーネントです。デフォルトでは、`article`要素をレンダリングします。"
...
::::tip
関連する情報をカード形式ではなく、汎用的なセクションとしてレイアウトしたい場合は、[Container](/docs/components/container)の使用を検討してください。
::::
