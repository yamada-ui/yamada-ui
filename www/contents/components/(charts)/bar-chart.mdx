...
| ------------ | --------------------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Moves the active data point forward and displays the tooltip. Focus remains on the chart surface. | `withTooltip={true}` |
| `ArrowLeft`  | Moves the active data point backward and displays the tooltip. Focus remains on the chart surface. | `withTooltip={true}` |
| `Enter`      | Toggles the tooltip display for the active data point. Focus remains on the chart surface.         | `withTooltip={true}` |
...
|           | `tabIndex={0}`                     | Makes the chart surface focusable for keyboard interaction.   |
