...
:::tip
If you are using it as a close button, consider using [CloseButton](/docs/components/close-button).
:::

:::tip
If you are using it as a file selection button, consider using [FileButton](/docs/components/file-button).
:::
