...
describe("<Modal />", () => {
  ...
  test("sets `displayName` and `__styled__` correctly", () => {
    ...
    expect(Modal.Root.__styled__).toBe("ModalRoot")
    expect(Modal.Overlay.displayName).toBe("ModalOverlay")
    expect(Modal.Overlay.__styled__).toBe("ModalOverlay")
    expect(Modal.OpenTrigger.displayName).toBe("ModalOpenTrigger")
    expect(Modal.OpenTrigger.__styled__).toBe("ModalOpenTrigger")
    expect(Modal.CloseTrigger.displayName).toBe("ModalCloseTrigger")
    expect(Modal.CloseTrigger.__styled__).toBe("ModalCloseTrigger")
    expect(Modal.CloseButton.displayName).toBe("ModalCloseButton")
    expect(Modal.CloseButton.__styled__).toBe("ModalCloseButton")
    expect(Modal.Content.displayName).toBe("ModalContent")
    expect(Modal.Content.__styled__).toBe("ModalContent")
    expect(Modal.Header.displayName).toBe("ModalHeader")
    expect(Modal.Header.__styled__).toBe("ModalHeader")
    expect(Modal.Title.displayName).toBe("ModalTitle")
    expect(Modal.Title.__styled__).toBe("ModalTitle")
    expect(Modal.Body.displayName).toBe("ModalBody")
    expect(Modal.Body.__styled__).toBe("ModalBody")
    expect(Modal.Footer.displayName).toBe("ModalFooter")
    expect(Modal.Footer.__styled__).toBe("ModalFooter")
  })
