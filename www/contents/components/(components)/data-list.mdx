...
:::tip
If you want to display a list of single items, use [List](/docs/components/list).
:::

:::tip
`DataList` is used to display a list of terms and their descriptions.
If you want to display item names in the header or display a list that includes items other than terms and descriptions, consider using [NativeTable](/docs/components/native-table).
:::

:::tip
If you want to loop through array elements and render components, use [For](/docs/components/for).
:::
