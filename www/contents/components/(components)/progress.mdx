...
The `Progress` follows the [WAI-ARIA - Meter](https://www.w3.org/WAI/ARIA/apg/patterns/meter/) for accessibility.
...
|            | `aria-label`         | Provides a label for the progress bar. |
