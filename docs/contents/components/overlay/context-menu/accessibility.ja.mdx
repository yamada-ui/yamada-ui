...
| `ArrowUp`    | 無効ではない次の項目をフォーカスします。最後の項目の場合は無効ではない最初の項目をフォーカスします。 | -                |
...
| コンポーネント       | ロールと属性            | 使い方                                                                                                                                                   |
| -------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ContextMenuTrigger` | `id`                    | `MenuList`と関連付けるために使用する`id`。                                                                                                               |
...
|                      | `id`                    | `ContextMenuTrigger`または`MenuItemButton`と関連付けるために使用する`id`。                                                                               |
|                      | `tabindex`              | `"-1"`を設定します。                                                                                                                                     |
|                      | `aria-activedescendant` | フォーカスされた項目の`id`を設定します。                                                                                                                 |
|                      | `aria-labelledby`       | 関連した`ContextMenuTrigger`または`MenuItemButton`の`id`を設定します。                                                                                   |
