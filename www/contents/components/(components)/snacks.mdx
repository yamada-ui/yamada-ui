...
:::note
`gutter` applies negative margin by default. If you want to disable negative margin, set `negativeMargins` to `false`.
:::
...
To limit the number of displays, set a number to the `limit` prop. By default, `3` is set.
