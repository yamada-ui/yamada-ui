...
:::note
For more information, see the [Theming](/docs/theming).
:::
...
:::warning
In order to switch themes, you need to prepare multiple themes. For more details, see the [Switching Themes](/docs/theming/switching-themes).
:::
