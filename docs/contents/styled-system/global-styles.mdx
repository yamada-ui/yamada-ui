...
If you have chosen [Individually](/getting-started/installation/individually) or [Minimal](/getting-started/installation/minimal) during installation and installed `@yamada-ui/core`, the global style components are not being called.
