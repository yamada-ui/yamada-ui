...
}`,...(sn=(rn=E.parameters)==null?void 0:rn.docs)==null?void 0:sn.source}}};var an,ln,tn;M.parameters={...M.parameters,docs:{...(an=M.parameters)==null?void 0:an.docs,source:{originalSource:`() => {
  return <>
...
}`,...(tn=(ln=M.parameters)==null?void 0:ln.docs)==null?void 0:tn.source}}};var dn,mn,An;D.parameters={...D.parameters,docs:{...(dn=D.parameters)==null?void 0:dn.docs,source:{originalSource:`() => {
...
}`,...(kn=(Sn=G.parameters)==null?void 0:Sn.docs)==null?void 0:kn.source}}};var En,Mn,Dn;O.parameters={...O.parameters,docs:{...(En=O.parameters)==null?void 0:En.docs,source:{originalSource:`() => {
  return <>
      ...
      <Accordion icon={({
      isExpanded
    }) => isExpanded ? <PlusIcon color={["blackAlpha.800", "whiteAlpha.700"]} /> : <MinusIcon color={["blackAlpha.800", "whiteAlpha.700"]} />}>
        <AccordionItem label="孫悟空少年編">
          地球の人里離れた山奥に住む尻尾の生えた少年・孫悟空はある日、西の都からやって来た少女・ブルマと出会う。そこで、7つ集めると神龍（シェンロン）が現れ、どんな願いでも一つだけ叶えてくれるというドラゴンボールの存在を、さらに育ての親である孫悟飯の形見として大切に持っていた球がその1つ「四星球（スーシンチュウ）」であることを知り、ブルマと共に残りのドラゴンボールを探す旅に出る。
        </AccordionItem>
...
}`,...(Dn=(Mn=O.parameters)==null?void 0:Mn.docs)==null?void 0:Dn.source}}};var Nn,Tn,Vn;K.parameters={...K.parameters,docs:{...(Nn=K.parameters)==null?void 0:Nn.docs,source:{originalSource:`() => {
...
}`,...(Vn=(Tn=K.parameters)==null?void 0:Tn.docs)==null?void 0:Vn.source}}};const ke=["basic","withVariant","withDefaultIndex","withIsToggle","withIsMultiple","withIconHidden","isDisabled","customLabel","customPanel","customIcon","customControl"];export{ke as __namedExportsOrder,E as basic,K as customControl,O as customIcon,H as customLabel,G as customPanel,Se as default,F as isDisabled,D as withDefaultIndex,V as withIconHidden,T as withIsMultiple,N as withIsToggle,M as withVariant};
