...
}`,...(T=(P=m.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var H,M,O;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`() => {
  return <Wrap gap="md">
      {colorSchemes.map(colorScheme => <Checkbox key={colorScheme} colorScheme={colorScheme} defaultIsChecked>
          {colorScheme}
        </Checkbox>)}
    </Wrap>;
}`,...(O=(M=p.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var z,_,E;k.parameters={...k.parameters,docs:{...(z=k.parameters)==null?void 0:z.docs,source:{originalSource:`() => {
  return <Checkbox defaultIsChecked>孫悟空</Checkbox>;
}`,...(E=(_=k.parameters)==null?void 0:_.docs)==null?void 0:E.source}}};var U,J,K;b.parameters={...b.parameters,docs:{...(U=b.parameters)==null?void 0:U.docs,source:{originalSource:`() => {
  return <>
...
}`,...(K=(J=b.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var L,Q,X;C.parameters={...C.parameters,docs:{...(L=C.parameters)==null?void 0:L.docs,source:{originalSource:`() => {
  return <>
...
}`,...(me=(xe=I.parameters)==null?void 0:xe.docs)==null?void 0:me.source}}};var pe,ke,be;N.parameters={...N.parameters,docs:{...(pe=N.parameters)==null?void 0:pe.docs,source:{originalSource:`() => {
  interface Data {
    checkbox: boolean;
...
}`,...(be=(ke=N.parameters)==null?void 0:ke.docs)==null?void 0:be.source}}};var Ce,ve,fe;G.parameters={...G.parameters,docs:{...(Ce=G.parameters)==null?void 0:Ce.docs,source:{originalSource:`() => {
  interface Data {
    checkbox: boolean;
    checkboxGroup: string[];
  }
...
}`,...(fe=(ve=G.parameters)==null?void 0:ve.docs)==null?void 0:fe.source}}};const cr=["basic","withSize","withColorScheme","withDefaultIsChecked","isDisabled","isReadonly","isInvalid","indeterminate","withGroup","customControl","customControlGroup","customHook","reactHookForm","reactHookFormWithDefaultValue"];export{cr as __namedExportsOrder,x as basic,j as customControl,S as customControlGroup,I as customHook,ar as default,f as indeterminate,b as isDisabled,v as isInvalid,C as isReadonly,N as reactHookForm,G as reactHookFormWithDefaultValue,p as withColorScheme,k as withDefaultIsChecked,g as withGroup,m as withSize};
