...
For some media types like `print`, convenient shorthands are available. Please refer to [At-Rules](/docs/styling/style-props#at-rules) for available properties.
...
To use other at-rules, define them in `css`.
