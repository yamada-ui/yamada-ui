...
<Alert status='warning'>
  <AlertIcon />
  [個別](/docs/getting-started/installation/individually)や[最小限](/docs/getting-started/installation/minimal)でインストールした場合は、`useLoading`が含まれていません。ローディングを使用したい場合は、[こちら](/docs/styled-system/loading#個別や最小限でインストールしている場合)をご覧ください。
</Alert>
...
<Alert status='warning'>
  <AlertIcon />
  [個別](/docs/getting-started/installation/individually)や[最小限](/docs/getting-started/installation/minimal)でインストールした場合は、`useNotice`が含まれていません。通知を使用したい場合は、[こちら](/docs/styled-system/notification#個別や最小限でインストールしている場合)をご覧ください。
</Alert>
