...
import { MessageCirclePlus as OriginalMessageCirclePlus } from "lucide-react"
 ...
 */
export const MessageCirclePlusIcon = forwardRef<IconProps, "svg">(
  (props, ref) => <Icon ref={ref} as={OriginalMessageCirclePlus} {...props} />,
)
