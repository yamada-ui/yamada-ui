  ...
  return (
    <VStack>
      ...
      <LineChart.Root
        data={data}
        lines={[
          { activeDot: { r: "8" }, dataKey: "uv", dot: { r: "5" } },
          { dataKey: "pv", dot: CustomizedDot, withActiveDot: false },
        ]}
      />

      <LineChart.Root
        data={data}
        lines={[{ dataKey: "uv" }, { dataKey: "pv", strokeDasharray: "5 5" }]}
  ...
  return (
    <VStack>
      ...
      <LineChart.Root
        data={data}
        lines={[
          { dataKey: "uv", yAxisId: "left" },
          { dataKey: "pv", yAxisId: "right" },
        ]}
      >
...
export const DisableAnimation: Story = () => {
  ...
  return (
    <LineChart.Root
      data={data}
      lines={[{ dataKey: "uv", isAnimationActive: false }, { dataKey: "pv" }]}
    />
  )
}
...
export const ConnectNull: Story = () => {
  ...
  return (
    <VStack>
      <LineChart.Root data={data} lines={[{ dataKey: "pv" }]} />

      <LineChart.Root
        data={data}
        lines={[{ connectNulls: true, dataKey: "pv" }]}
      />
    </VStack>
  )
}
