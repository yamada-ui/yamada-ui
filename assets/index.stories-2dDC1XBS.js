import{r,j as o}from"./iframe-Bly_QBCH.js";import{B as t}from"./badge-GO4t0Zbo.js";import"./preload-helper-PPVm8Dsz.js";function i(e){return window.addEventListener("online",e),window.addEventListener("offline",e),()=>{window.removeEventListener("online",e),window.removeEventListener("offline",e)}}function s(){return window.navigator.onLine}function a(e=()=>!0){return r.useSyncExternalStore(i,s,e)}const m={title:"Hooks / useOnline"},n=()=>{const e=a();return o.jsx(t,{colorScheme:e?"green":"red",children:e?"Online":"Offline"})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
