...
The `IconButton` follows the [WAI-ARIA - Button Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/button/) for accessibility.
...
| --------- | -------------------- | ------------------------------------------------- |
| `Icon`    | `role="img"`         | Indicates that this is an image.                  |
