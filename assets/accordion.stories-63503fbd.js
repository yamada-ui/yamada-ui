...
}`,...(Cn=(gn=O.parameters)==null?void 0:gn.docs)==null?void 0:Cn.source}}};var wn,Pn,yn;K.parameters={...K.parameters,docs:{...(wn=K.parameters)==null?void 0:wn.docs,source:{originalSource:`() => {
  return <Accordion>
      <AccordionItem label='孫悟空少年編'>
        <Text>
          地球の人里離れた山奥に住む尻尾の生えた少年・孫悟空はある日、西の都からやって来た少女・ブルマと出会う。そこで、7つ集めると神龍（シェンロン）が現れ、どんな願いでも一つだけ叶えてくれるというドラゴンボールの存在を、さらに育ての親である孫悟飯の形見として大切に持っていた球がその1つ「四星球（スーシンチュウ）」であることを知り、ブルマと共に残りのドラゴンボールを探す旅に出る。
...
//# sourceMappingURL=accordion.stories-63503fbd.js.map
