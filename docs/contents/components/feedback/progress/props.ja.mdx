...
<PropsCard
  ...
  type='"link" | "border" | "danger" | "warning" | "success" | "primary" | "info" | "secondary" | Color | "current" | "focus" | "whiteAlpha.50" | "whiteAlpha.100" | "whiteAlpha.200" | ... 316 more ... | ColorModeArray<...>'
