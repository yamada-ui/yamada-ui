...
| `Enter`     | Selects the focused item. When there is no focused item and the input has text, selects the first matching item. | -                   |
...
| --------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `Autocomplete.Root`   | `role="combobox"`          | Indicates that this is a combobox.                                                                              |
|                       | `aria-expanded`            | Sets to `"true"` when the listbox is open, and `"false"` when it is closed.                                     |
|                       | `aria-haspopup="listbox"`  | Indicates that there is a listbox.                                                                              |
...
| `AutocompleteContent` | `role="listbox"`           | Indicates that this is a listbox.                                                                               |
...
| `Autocomplete.Group`  | `role="group"`             | Indicates that this is a group of options.                                                                      |
|                       | `aria-labelledby`          | Sets the `id` of the group label.                                                                               |
| `Autocomplete.Label`  | `role="presentation"`      | Indicates that this is presentational.                                                                          |
| `AutocompleteIcon`    | `role="button"`            | When `clearable` and has a value, indicates that this is a button.                                              |
|                       | `aria-label="Clear value"` | Sets to `"Clear value"`.                                                                                        |
|                       | `aria-disabled`            | Sets to `"true"` when `disabled` or `readOnly` is set.                                                          |
