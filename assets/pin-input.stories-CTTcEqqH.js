import{j as e}from"./extends-CwFRzn3r.js";import{r as l}from"./index-BwDkhjyp.js";import{u as fn,C as xn}from"./index.esm-DXPXqkjk.js";import{u as Tn}from"./index-CsH8woeS.js";import{c as En}from"./index-ByFQ-olM.js";import{u as Pn,f as An,F as b}from"./form-control-DALmJTHd.js";import{p as zn,X as Nn,z as Ln,h as y,q as Hn,b as jn,c as bn,a as Jn}from"./factory-DBrfn43w.js";import{f as Fn}from"./forward-ref-BWI-Phbn.js";import{a as Un}from"./use-component-style-DhRiPQIp.js";import{o as Xn}from"./theme-provider-Cr3m0r8P.js";import{u as Cn}from"./loading-provider-CMJK-0oJ.js";import{V as Sn}from"./stack-BJEIbY7f.js";import{B as yn}from"./button-HzRyJIss.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BM4h2_aq.js";import"./Combination-IUp2vs9T.js";import"./loading-iPLDeGho.js";import"./icon-CVPWgGuL.js";import"./use-var-DcJHaFAf.js";import"./index-CGy0U2a3.js";import"./motion-B7t0mTYZ.js";import"./portal-Dkok86ly.js";import"./index-Drt3gf4w.js";import"./factory-CWrzRNZL.js";import"./use-ripple-C_jFl7Io.js";const de=o=>o==null?void 0:o.split(""),me=(o,a)=>(a==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(o),[Gn,Wn]=zn({name:"PinInputContext",errorMessage:`PinInputContext returned is 'undefined'. Seems you forgot to wrap the components in "<PinInput />"`}),{DescendantsContextProvider:$n,useDescendant:Kn,useDescendants:Zn}=En(),n=Fn(({errorBorderColor:o,focusBorderColor:a,...m},g)=>{const[I,h]=Un("PinInput",{errorBorderColor:o,focusBorderColor:a,...m});let{id:c,type:d="number",className:wn,autoFocus:Z,children:vn,defaultValue:Vn,items:Dn=4,manageFocus:F=!0,mask:Q,otp:Y=!1,placeholder:ee="○",value:kn,onChange:U,onComplete:f,...Mn}=Pn(Xn(h));const[{"aria-readonly":Qn,disabled:ne,readOnly:X,...G},Rn]=Nn(Mn,An),_n=l.useId();c??(c=_n);const i=Zn(),[se,W]=l.useState(!0),[re,te]=l.useState(-1);l.useEffect(()=>{if(!Z)return;const s=i.firstValue();s&&requestAnimationFrame(()=>s.node.focus())},[Z,i]);const[x,C]=Tn({defaultValue:de(Vn)||[],value:de(kn),onChange:s=>U==null?void 0:U(s.join(""))}),oe=l.useCallback(s=>{if(!se||!F)return;const r=i.nextValue(s,void 0,!1);r&&requestAnimationFrame(()=>r.node.focus())},[i,se,F]),P=l.useCallback((s,r,u=!0)=>{var j;let p=[...x];p[r]=s,C(p),p=p.filter(Boolean),s!==""&&p.length===i.count()?(f==null||f(p.join("")),(j=i.value(r))==null||j.node.blur()):u&&oe(r)},[x,C,i,f,oe]),ae=l.useCallback((s,r)=>{let u=r;return s!=null&&s.length&&(s.startsWith(r.charAt(0))?u=r.charAt(1):s.startsWith(r.charAt(1))&&(u=r.charAt(0))),u},[]),ie=l.useCallback(s=>({target:r})=>{var j;const u=r.value,p=x[s],S=ae(p,u);if(S===""){P("",s);return}if(u.length>2){if(!me(u,d))return;const K=u.split("").filter((Yn,Bn)=>Bn<i.count());C(K),K.length===i.count()&&(f==null||f(K.join("")),(j=i.value(s))==null||j.node.blur())}else me(S,d)&&P(S,s),W(!0)},[i,ae,f,P,C,d,x]),ue=l.useCallback(s=>({key:r,target:u})=>{if(!(r!=="Backspace"||!F))if(u.value===""){const p=i.prevValue(s,void 0,!1);if(!p)return;P("",s-1,!1),p.node.focus(),W(!0)}else W(!1)},[i,F,P]),le=l.useCallback(s=>()=>te(s),[]),ce=l.useCallback(()=>te(-1),[]),qn=l.useCallback(({index:s,...r})=>({type:Q?"password":d==="number"?"tel":"text",inputMode:d==="number"?"numeric":"text",...G,...Ln(r),id:`${c}-${s}`,autoComplete:Y?"one-time-code":"off",disabled:ne,placeholder:re===s&&!X&&!r.readOnly?"":ee,readOnly:X,value:x[s]||"",onBlur:y(r.onBlur,ce),onChange:y(r.onChange,ie(s)),onFocus:y(r.onFocus,le(s)),onKeyDown:y(r.onKeyDown,ue(s))}),[d,Q,G,c,x,ie,ue,le,ce,Y,re,ne,X,ee]),On={alignItems:"center",display:"flex",...I.container};let $=Hn(vn);if(!$.length)for(let s=0;s<Dn;s++)$.push(e.jsx(t,{},s));return e.jsx($n,{value:i,children:e.jsx(Gn,{value:{styles:I,getInputProps:qn},children:e.jsx(jn.div,{ref:g,className:bn("ui-pin-input",wn),role:"group",__css:On,...G,...Rn,children:$})})})});n.displayName="PinInput";n.__ui__="PinInput";const t=Fn(({className:o,...a},m)=>{const{styles:g,getInputProps:I}=Wn(),{index:h,register:c}=Kn();a=Pn(a);const d={...g.field};return e.jsx(jn.input,{className:bn("ui-pin-input__field",o),...I({...a,ref:Jn(c,m),index:h}),__css:d})});t.displayName="PinInputField";t.__ui__="PinInputField";const ys={component:n,title:"Components / Forms / PinInput"},w=()=>e.jsx(n,{}),v=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{size:"xs"}),e.jsx(n,{size:"sm"}),e.jsx(n,{size:"md"}),e.jsx(n,{size:"lg"})]}),V=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{variant:"outline"}),e.jsx(n,{variant:"filled"}),e.jsx(n,{variant:"flushed"}),e.jsx(n,{variant:"unstyled"})]}),D=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{items:3}),e.jsx(n,{items:4}),e.jsx(n,{items:5}),e.jsx(n,{items:6})]}),k=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{type:"alphanumeric"})]}),M=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{defaultValue:"1234"}),e.jsx(n,{defaultValue:"123"})]}),R=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{focusBorderColor:"green.500"}),e.jsx(n,{errorBorderColor:"orange.500",isInvalid:!0})]}),_=()=>{const{page:o}=Cn();return e.jsx(n,{onComplete:()=>o.start({duration:5e3})})},q=()=>e.jsx(n,{otp:!0}),O=()=>e.jsx(n,{mask:!0}),B=()=>e.jsxs(n,{children:[e.jsx(t,{}),e.jsx(t,{}),e.jsx(t,{}),e.jsx(t,{})]}),T=()=>e.jsx(n,{placeholder:"💩"}),E=()=>{const{page:o}=Cn(),[a,m]=l.useState(""),g=()=>o.start({duration:5e3});return e.jsx(n,{value:a,onChange:m,onComplete:g})},A=()=>e.jsx(n,{manageFocus:!1}),z=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isDisabled:!0}),e.jsxs(n,{children:[e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0})]}),e.jsx(b,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isDisabled:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),N=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isReadOnly:!0}),e.jsxs(n,{children:[e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0})]}),e.jsx(b,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isReadOnly:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isInvalid:!0}),e.jsxs(n,{children:[e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0})]}),e.jsx(b,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isInvalid:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),H=()=>{var h;const{control:o,formState:{errors:a},handleSubmit:m,watch:g}=fn(),I=c=>console.log("submit:",c);return console.log("watch:",g()),e.jsxs(Sn,{as:"form",onSubmit:m(I),children:[e.jsx(b,{errorMessage:(h=a.pinInput)==null?void 0:h.message,isInvalid:!!a.pinInput,label:"Token",children:e.jsx(xn,{name:"pinInput",control:o,render:({field:c})=>e.jsx(n,{...c}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(yn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},J=()=>{var c;const o={pinInput:"5"},{control:a,formState:{errors:m},handleSubmit:g,watch:I}=fn({defaultValues:o}),h=d=>console.log("submit:",d);return console.log("watch:",I()),e.jsxs(Sn,{as:"form",onSubmit:g(h),children:[e.jsx(b,{errorMessage:(c=m.pinInput)==null?void 0:c.message,isInvalid:!!m.pinInput,label:"Token",children:e.jsx(xn,{name:"pinInput",control:a,render:({field:d})=>e.jsx(n,{...d}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(yn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var pe,ge,Ie;w.parameters={...w.parameters,docs:{...(pe=w.parameters)==null?void 0:pe.docs,source:{originalSource:`() => {
  return <PinInput />;
...
}`,...(Ue=(Je=B.parameters)==null?void 0:Je.docs)==null?void 0:Ue.source}}};var Xe,Ge,We;T.parameters={...T.parameters,docs:{...(Xe=T.parameters)==null?void 0:Xe.docs,source:{originalSource:`() => {
  return <PinInput placeholder="💩" />;
}`,...(We=(Ge=T.parameters)==null?void 0:Ge.docs)==null?void 0:We.source}}};var $e,Ke,Ze;E.parameters={...E.parameters,docs:{...($e=E.parameters)==null?void 0:$e.docs,source:{originalSource:`() => {
  const {
    page
  } = useLoading();
...
}`,...(hn=(In=J.parameters)==null?void 0:In.docs)==null?void 0:hn.source}}};const ws=["basic","withSize","withVariant","withFields","withType","withDefaultValue","withBorderColor","withOnComplete","useOneTimePassword","maskingValue","customFields","customPlaceholder","customControl","disabledFocusManagement","isDisabled","isReadonly","isInvalid","reactHookForm","reactHookFormWithDefaultValue"];export{ws as __namedExportsOrder,w as basic,E as customControl,B as customFields,T as customPlaceholder,ys as default,A as disabledFocusManagement,z as isDisabled,L as isInvalid,N as isReadonly,O as maskingValue,H as reactHookForm,J as reactHookFormWithDefaultValue,q as useOneTimePassword,R as withBorderColor,M as withDefaultValue,D as withFields,_ as withOnComplete,v as withSize,k as withType,V as withVariant};
