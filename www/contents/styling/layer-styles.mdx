...
The styles defined in the theme are in the [layer-styles.ts](https://github.com/yamada-ui/yamada-ui/blob/main/packages/react/src/theme/styles/layer-styles.ts).
