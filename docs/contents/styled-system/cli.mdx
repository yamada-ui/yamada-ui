...
To generate the type of theme, run one of the following scripts.
...
If you want to continuously generate types while customizing the theme, run one of the following scripts.
