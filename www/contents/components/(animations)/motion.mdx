...
:::tip
`Motion` is a general-purpose animation component. Use it when you need more flexible or lower-level control over animations than the other animation components provide.
:::
