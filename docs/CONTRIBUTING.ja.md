...
1. [リポジトリ](https://github.com/yamada-ui/yamada-docs)をフォークします。
...
1. [リポジトリ](https://github.com/yamada-ui/yamada-docs)をフォークし、クローンします。
...
3. 変更を行い、[コミット規約](https://github.com/yamada-ui/yamada-ui/blob/main/README.md#commit-convention)に従ってコミットします。もしテストが必要な場合、[Tips for Test](https://github.com/yamada-ui/yamada-ui/wiki/Tips-for-Test-in-Japanese)を確認してください。
