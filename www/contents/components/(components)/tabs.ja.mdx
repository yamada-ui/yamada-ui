...
| --------------------- | ------------------ | --------------------------------------------------------------------------------------------------------- |
| `div.ui-tabs__list`   | `role="tablist"`   | タブリストであることを示します。                                                                          |
|                       | `aria-orientation` | `orientation`の値に基づいて`"horizontal"`または`"vertical"`を設定します。デフォルトは`"horizontal"`です。 |
| `button.ui-tabs__tab` | `role="tab"`       | タブであることを示します。                                                                                |
|                       | `aria-selected`    | タブが選択されている場合は`"true"`を設定し、選択されていない場合は`"false"`を設定します。                 |
|                       | `aria-controls`    | 関連した`div.ui-tabs__panel`の`id`を設定します。                                                          |
| `div.ui-tabs__panel`  | `role="tabpanel"`  | タブパネルであることを示します。                                                                          |
|                       | `aria-labelledby`  | 関連した`button.ui-tabs__tab`の`id`を設定します。                                                         |
