...
const data: IntlData = {
  ...
  calendar: {
    ...
    "Go to the next month": "前往下个月",
    "Go to the previous month": "前往上个月",
    Today: "今天",
  },
  carousel: {
    "Go to next slide": "前往下一张幻灯片",
    "Go to previous slide": "前往上一张幻灯片",
    "Go to {page} slide": "前往第{page}张幻灯片",
    Slides: "幻灯片",
