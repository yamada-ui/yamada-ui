import{a as e,j as a,F as g}from"./jsx-runtime-yA-pgArV.js";import{r as I}from"./index-IybTgENJ.js";import{u as bn,C as Sn}from"./index.esm-PVkfQNar.js";import{u as Tn}from"./index-xewpD759.js";import{c as En}from"./index-y7fBSNyz.js";import{u as Cn,f as _n,F as v}from"./form-control-t3274UO5.js";import{c as An,O as zn,t as Ln,h as O,v as Nn,u as Fn,a as yn,s as Hn}from"./factory-LMyrE5lk.js";import{f as wn}from"./forward-ref-6T0UNPU-.js";import{u as jn}from"./use-component-style-KGYGTazl.js";import{o as Jn}from"./theme-provider-JJMfppNb.js";import{u as vn}from"./loading-provider-TSpPVN5z.js";import{V as Vn}from"./stack-Mcw13KPE.js";import{B as Dn}from"./button-9VUarSO2.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-_OkO9XJu.js";import"./index-i9SU6yQS.js";import"./component-G3mliOEp.js";import"./loading-d5fto5LV.js";import"./index-Fmh4I4_s.js";import"./index-_Bu2kJOQ.js";import"./index-sG_FZBUS.js";import"./icon-U1tgplMe.js";import"./motion-0mtyYxKC.js";import"./motion-XoqD_6Np.js";import"./index-xpiohnTl.js";import"./container-portal-26CUbQuD.js";import"./index-xIHD0DlW.js";const pe=s=>s==null?void 0:s.split(""),Ie=(s,i)=>(i==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(s),[Un,Gn]=An({strict:!1,name:"PinInputContext"}),{DescendantsContextProvider:Xn,useDescendants:$n,useDescendant:Kn}=En(),n=wn(({focusBorderColor:s,errorBorderColor:i,...c},d)=>{const[m,h]=jn("PinInput",{focusBorderColor:s,errorBorderColor:i,...c});let{id:l,className:b,type:y="number",placeholder:re="○",value:Mn,defaultValue:kn,autoFocus:te,manageFocus:V=!0,otp:se=!1,mask:oe,onChange:Q,onComplete:f,items:Rn=4,children:xn,...D}=Cn(Jn(h));l??(l=I.useId());const u=$n(),[ae,Y]=I.useState(!0),[ie,ue]=I.useState(-1);I.useEffect(()=>{if(!te)return;const r=u.firstValue();r&&requestAnimationFrame(()=>r.node.focus())},[te,u]);const[w,M]=Tn({value:pe(Mn),defaultValue:pe(kn)||[],onChange:r=>Q==null?void 0:Q(r.join(""))}),le=I.useCallback(r=>{if(!ae||!V)return;const t=u.nextValue(r,void 0,!1);t&&requestAnimationFrame(()=>t.node.focus())},[u,ae,V]),k=I.useCallback((r,t,P=!0)=>{var R;let p=[...w];p[t]=r,M(p),p=p.filter(Boolean),r!==""&&p.length===u.count()&&p.every(S=>S!=null&&S!=="")?(f==null||f(p.join("")),(R=u.value(t))==null||R.node.blur()):P&&le(t)},[w,M,u,f,le]),ce=I.useCallback((r,t)=>{let P=t;return r!=null&&r.length&&(r[0]===t.charAt(0)?P=t.charAt(1):r[0]===t.charAt(1)&&(P=t.charAt(0))),P},[]),On=I.useCallback(({index:r,...t})=>{const P=({target:S})=>{var me;const C=S.value,x=w[r],F=ce(x,C);if(F===""){k("",r);return}if(C.length>2){if(!Ie(C,y))return;const ne=C.split("").filter((Wn,Bn)=>Bn<u.count());M(ne),ne.length===u.count()&&(f==null||f(ne.join("")),(me=u.value(r))==null||me.node.blur())}else Ie(F,y)&&k(F,r),Y(!0)},p=({key:S,target:C})=>{var x;if(!(S!=="Backspace"||!V))if(C.value===""){const F=u.prevValue(r,void 0,!1);if(!F)return;k("",r-1,!1),(x=F.node)==null||x.focus(),Y(!0)}else Y(!1)},de=()=>ue(r),R=()=>ue(-1);return{inputMode:y==="number"?"numeric":"text",type:oe?"password":y==="number"?"tel":"text",...zn(D,_n),...Ln(t),id:`${l}-${r}`,value:w[r]||"",onChange:O(t.onChange,P),onKeyDown:O(t.onKeyDown,p),onFocus:O(t.onFocus,de),onBlur:O(t.onBlur,R),autoComplete:se?"one-time-code":"off",placeholder:ie===r&&!D.readOnly&&!t.readOnly?"":re}},[u,ie,ce,l,V,oe,f,se,re,D,k,M,y,w]),qn={display:"flex",alignItems:"center",...m.container};let ee=Nn(xn);if(!ee.length)for(let r=0;r<Rn;r++)ee.push(e(o,{},r));return e(Xn,{value:u,children:e(Un,{value:{getInputProps:On,styles:m},children:e(Fn.div,{ref:d,className:yn("ui-pin-input",b),...D,__css:qn,children:ee})})})}),o=wn(({className:s,...i},c)=>{const{getInputProps:d,styles:m}=Gn(),{index:h,register:l}=Kn();i=Cn(i);const b={...m.field};return e(Fn.input,{className:yn("ui-pin-input__field",s),...d({...i,ref:Hn(l,c),index:h}),__css:b})}),wr={title:"Components / Forms / PinInput",component:n},q=()=>e(n,{}),B=()=>a(g,{children:[e(n,{size:"xs"}),e(n,{size:"sm"}),e(n,{size:"md"}),e(n,{size:"lg"})]}),T=()=>a(g,{children:[e(n,{variant:"outline"}),e(n,{variant:"filled"}),e(n,{variant:"flushed"}),e(n,{variant:"unstyled"})]}),E=()=>a(g,{children:[e(n,{items:3}),e(n,{items:4}),e(n,{items:5}),e(n,{items:6})]}),_=()=>a(g,{children:[e(n,{}),e(n,{type:"alphanumeric"})]}),A=()=>a(g,{children:[e(n,{defaultValue:"1234"}),e(n,{defaultValue:"123"})]}),z=()=>a(g,{children:[e(n,{}),e(n,{focusBorderColor:"green.500"}),e(n,{isInvalid:!0,errorBorderColor:"orange.500"})]}),L=()=>{const{page:s}=vn();return e(n,{onComplete:()=>s.start({duration:5e3})})},N=()=>e(n,{otp:!0}),H=()=>e(n,{mask:!0}),j=()=>a(n,{children:[e(o,{}),e(o,{}),e(o,{}),e(o,{})]}),J=()=>e(n,{placeholder:"💩"}),U=()=>{const{page:s}=vn(),[i,c]=I.useState("");return e(n,{value:i,onChange:c,onComplete:()=>s.start({duration:5e3})})},G=()=>e(n,{manageFocus:!1}),X=()=>a(g,{children:[e(n,{isDisabled:!0}),a(n,{children:[e(o,{isDisabled:!0}),e(o,{isDisabled:!0}),e(o,{isDisabled:!0}),e(o,{isDisabled:!0})]}),e(v,{isDisabled:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e(n,{})})]}),$=()=>a(g,{children:[e(n,{isReadOnly:!0}),a(n,{children:[e(o,{isReadOnly:!0}),e(o,{isReadOnly:!0}),e(o,{isReadOnly:!0}),e(o,{isReadOnly:!0})]}),e(v,{isReadOnly:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e(n,{})})]}),K=()=>a(g,{children:[e(n,{isInvalid:!0}),a(n,{children:[e(o,{isInvalid:!0}),e(o,{isInvalid:!0}),e(o,{isInvalid:!0}),e(o,{isInvalid:!0})]}),e(v,{isInvalid:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e(n,{})})]}),W=()=>{var h;const{control:s,handleSubmit:i,watch:c,formState:{errors:d}}=bn(),m=l=>console.log("submit:",l);return console.log("watch:",c()),a(Vn,{as:"form",onSubmit:i(m),children:[e(v,{isInvalid:!!d.pinInput,label:"Token",errorMessage:(h=d.pinInput)==null?void 0:h.message,children:e(Sn,{name:"pinInput",control:s,rules:{required:{value:!0,message:"This is required."},minLength:{value:4,message:"This is required."}},render:({field:l})=>e(n,{...l})})}),e(Dn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},Z=()=>{var l;const s={pinInput:"5"},{control:i,handleSubmit:c,watch:d,formState:{errors:m}}=bn({defaultValues:s}),h=b=>console.log("submit:",b);return console.log("watch:",d()),a(Vn,{as:"form",onSubmit:c(h),children:[e(v,{isInvalid:!!m.pinInput,label:"Token",errorMessage:(l=m.pinInput)==null?void 0:l.message,children:e(Sn,{name:"pinInput",control:i,rules:{required:{value:!0,message:"This is required."},minLength:{value:4,message:"This is required."}},render:({field:b})=>e(n,{...b})})}),e(Dn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var ge,he,fe;q.parameters={...q.parameters,docs:{...(ge=q.parameters)==null?void 0:ge.docs,source:{originalSource:`() => {
  return <PinInput />;
}`,...(fe=(he=q.parameters)==null?void 0:he.docs)==null?void 0:fe.source}}};var Pe,be,Se;B.parameters={...B.parameters,docs:{...(Pe=B.parameters)==null?void 0:Pe.docs,source:{originalSource:`() => {
  return <>
      <PinInput size="xs" />
...
}`,...(Ve=(ve=E.parameters)==null?void 0:ve.docs)==null?void 0:Ve.source}}};var De,Me,ke;_.parameters={..._.parameters,docs:{...(De=_.parameters)==null?void 0:De.docs,source:{originalSource:`() => {
  return <>
      <PinInput />

      <PinInput type="alphanumeric" />
    </>;
}`,...(ke=(Me=_.parameters)==null?void 0:Me.docs)==null?void 0:ke.source}}};var Re,xe,Oe;A.parameters={...A.parameters,docs:{...(Re=A.parameters)==null?void 0:Re.docs,source:{originalSource:`() => {
  return <>
      <PinInput defaultValue="1234" />

      <PinInput defaultValue="123" />
    </>;
}`,...(Oe=(xe=A.parameters)==null?void 0:xe.docs)==null?void 0:Oe.source}}};var qe,Be,Te;z.parameters={...z.parameters,docs:{...(qe=z.parameters)==null?void 0:qe.docs,source:{originalSource:`() => {
  return <>
      <PinInput />
...
}`,...(Pn=(fn=Z.parameters)==null?void 0:fn.docs)==null?void 0:Pn.source}}};const vr=["basic","withSize","withVariant","withFields","withType","withDefaultValue","withBorderColor","withOnComplete","useOneTimePassword","maskingValue","customFields","costomPlaceholder","customControl","disabledFocusManagement","isDisabled","isReadonly","isInvalid","reactHookForm","reactHookFormWithDefaultValue"];export{vr as __namedExportsOrder,q as basic,J as costomPlaceholder,U as customControl,j as customFields,wr as default,G as disabledFocusManagement,X as isDisabled,K as isInvalid,$ as isReadonly,H as maskingValue,W as reactHookForm,Z as reactHookFormWithDefaultValue,N as useOneTimePassword,z as withBorderColor,A as withDefaultValue,E as withFields,L as withOnComplete,B as withSize,_ as withType,T as withVariant};
