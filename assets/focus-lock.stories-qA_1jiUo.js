import{n as e}from"./chunk-jRWAZmH_.js";import{t}from"./jsx-runtime-D_578c1K.js";import{t as n}from"./collapse-CYjXbcOG.js";import{t as r}from"./collapse-C5uMEhgM.js";import{a as i,t as a}from"./use-disclosure-CHo7k9vF.js";import{a as o,t as s}from"./input-DMZ0UAAt.js";import{l as c,t as l}from"./button-DVpvdSsT.js";import{n as u,t as d}from"./focus-lock-BGFscW9C.js";import{r as f}from"./z-stack-DbXms5Iu.js";import{Dt as p}from"./iframe-0y96wZ5W.js";var m,h,g,_;e((()=>{d(),a(),l(),r(),s(),p(),m=t(),h={component:u,parameters:{layout:`centered`},title:`Components / FocusLock`},g=()=>{let{open:e,onToggle:t}=i({defaultOpen:!0});return(0,m.jsxs)(f,{align:`flex-start`,gap:`0`,children:[(0,m.jsx)(c,{onClick:t,children:`Please Click`}),(0,m.jsx)(n,{open:e,children:(0,m.jsx)(u,{children:(0,m.jsxs)(f,{bg:`bg.panel`,mt:`lg`,p:`lg`,rounded:`l2`,children:[(0,m.jsx)(o,{bg:`bg`,placeholder:`This is Input`}),(0,m.jsx)(c,{alignSelf:`flex-end`,children:`Button`})]})})})]})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {
  const {
    open,
    onToggle
  } = useDisclosure({
