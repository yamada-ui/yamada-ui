...
The `MonthPicker` follows the [WAI-ARIA - Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/) for accessibility.

If you are not using `FormControl`, set `aria-label` or `aria-labelledby` to `MonthPicker`.
...
| ----------------------------------------- | ------------------------ | ---------------------------------------------------------------------------------- |
| `MonthPickerField` <Tag>Internal</Tag>    | `role="combobox"`        | Indicates that this is a combobox.                                                 |
