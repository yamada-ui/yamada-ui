import{d as ye,r as c,a as ke,h as z,bT as ze,f as we,aN as Ve,j as e,m as Me,l as De,bU as xe,V as he,R as ge,C as Oe}from"./iframe-Bs84aKEy.js";import{P as be}from"./props-table-CZLMG-_b.js";import{u as Ie,C as Se}from"./index.esm-BSaIS1GP.js";import{F as b}from"./for-Dtp-BHqT.js";import{i as d,b as Te}from"./input-BC9azzRR.js";import{u as qe}from"./index-Dy6zJzlt.js";import{c as Ee}from"./index-LRypqHzW.js";import{u as Pe,F as C}from"./use-field-props-D_173Fo0.js";import{G as Ae}from"./group-B5D7YYq5.js";import"./preload-helper-PPVm8Dsz.js";import"./grid-BkQmt718.js";import"./grid-item-D4WrON59.js";import"./flex-B0qvFXwS.js";import"./heading-CjfTRMVh.js";import"./use-input-border-CS8Xj7mL.js";import"./index-_LgU1ZSp.js";import"./use-breakpoint-BRW9SUDP.js";import"./use-breakpoint-value-BxihJe0e.js";import"./use-color-mode-value-DJAEIbEc.js";const Be=ye({base:{field:{...d.base,textAlign:"center"},root:{}},variants:{filled:{field:d.variants?.filled},flushed:{field:d.variants?.flushed},outline:{field:d.variants?.outline},plain:{field:d.variants?.plain}},sizes:{xs:{field:{boxSize:d.sizes?.xs.minH,fontSize:d.sizes?.xs.fontSize}},sm:{field:{boxSize:d.sizes?.sm.minH,fontSize:d.sizes?.sm.fontSize}},md:{field:{boxSize:d.sizes?.md.minH,fontSize:d.sizes?.md.fontSize}},lg:{field:{boxSize:d.sizes?.lg.minH,fontSize:d.sizes?.lg.fontSize}},xl:{field:{boxSize:d.sizes?.xl.minH,fontSize:d.sizes?.xl.fontSize}},"2xl":{field:{boxSize:d.sizes?.["2xl"].minH,fontSize:d.sizes?.["2xl"].fontSize}}},defaultProps:{size:"md",variant:"outline"}}),{DescendantsContext:He,useDescendant:Le,useDescendants:_e}=Ee(),me=n=>n?.split(""),fe=(n,r)=>(r==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(n),Ne=(n={})=>{const r=c.useId(),{context:{labelId:i}={},props:{id:m=r,type:l="number",autoFocus:x,defaultValue:I,disabled:S,items:v=4,manageFocus:h=!0,mask:g,otp:X=!1,placeholder:j="◯",readOnly:W,value:ve,onChange:je,onComplete:R,...ne},ariaProps:re,dataProps:te,eventProps:Z}=Pe(n),u=_e(),[se,Q]=c.useState(!0),[oe,ae]=c.useState(-1),[P,y]=qe({defaultValue:me(I)||[],value:me(ve),onChange:t=>je?.(t.join(""))}),ie=c.useCallback(t=>{if(!se||!h)return;const a=u.nextValue(t,!1);a&&requestAnimationFrame(()=>a.node.focus())},[u,se,h]),Y=c.useCallback((t,a)=>{const o=t==="next"?u.nextValue(a,!1):u.prevValue(a,!1);if(!o)return;const f=o.node.value.length;requestAnimationFrame(()=>{o.node.focus(),o.node.setSelectionRange(0,f)})},[u]),F=c.useCallback((t,a,o=!0)=>{let f=[...P];f[a]=t,y(f),f=f.filter(Boolean),t!==""&&f.length===u.count()?(R?.(f.join("")),u.value(a)?.node.blur()):o&&ie(a)},[P,y,u,R,ie]),le=c.useCallback((t,a)=>{let o=a;return t?.length&&(t.startsWith(a.charAt(0))?o=a.charAt(1):t.startsWith(a.charAt(1))&&(o=a.charAt(0))),o},[]),ue=c.useCallback(t=>({target:a})=>{const o=a.value,f=P[t],k=le(f,o);if(k===""){F("",t);return}if(o.length>2){if(!fe(o,l))return;const ee=o.split("").filter((Ke,Re)=>Re<u.count());y(ee),ee.length===u.count()&&(R?.(ee.join("")),u.value(t)?.node.blur())}else fe(k,l)&&F(k,t),Q(!0)},[u,le,R,F,y,l,P]),de=c.useCallback(t=>a=>{h&&ke(a,{ArrowLeft:o=>{o.preventDefault(),Y("prev",t)},ArrowRight:o=>{o.preventDefault(),Y("next",t)},Backspace:o=>{if(o.target.value===""){const f=u.prevValue(t,!1);if(!f)return;F("",t-1,!1),f.node.focus(),Q(!0)}else Q(!1)}},{preventDefault:!1})},[u,Y,h,F]),ce=c.useCallback(t=>()=>ae(t),[]),pe=c.useCallback(()=>ae(-1),[]);c.useEffect(()=>{if(!x)return;const t=u.firstValue();t&&requestAnimationFrame(()=>t.node.focus())},[x,u]);const Fe=c.useCallback(t=>({role:"group",...ne,...t}),[ne]),Ce=c.useCallback(({"aria-labelledby":t,index:a,...o})=>({...re,...te,type:g?"password":l==="number"?"tel":"text","aria-labelledby":we(t,i),autoComplete:X?"one-time-code":"off",disabled:S,inputMode:l==="number"?"numeric":"text",placeholder:oe===a&&!W&&!o.readOnly?"":j,readOnly:W,value:P[a]||"",...ze(o),id:`${m}${a?`-${a}`:""}`,onBlur:z(Z.onBlur,o.onBlur,pe),onChange:z(o.onChange,ue(a)),onFocus:z(Z.onFocus,o.onFocus,ce(a)),onKeyDown:z(o.onKeyDown,de(a))}),[re,te,Z,g,l,i,X,S,oe,W,j,P,m,pe,ue,ce,de]);return{descendants:u,items:v,getInputProps:Ce,getRootProps:Fe}},{ComponentContext:Ge,useComponentContext:Je,withContext:Ue,withProvider:$e}=De("pin-input",Be),s=$e(({children:n,errorBorderColor:r,focusBorderColor:i,...m})=>{const{descendants:l,items:x,getInputProps:I,getRootProps:S}=Ne(m),v=c.useMemo(()=>{const g=Ve(n);return g.length?g:Array.from({length:x},(X,j)=>e.jsx(p,{index:j},j))},[n,x]),h=c.useMemo(()=>({errorBorderColor:r,focusBorderColor:i,getInputProps:I}),[I,r,i]);return e.jsx(He,{value:l,children:e.jsx(Ge,{value:h,children:e.jsx(Ae,{...S(),children:v})})})},"root")(),p=Ue(Te,"field")(void 0,({ref:n,index:r,...i})=>{const{errorBorderColor:m,focusBorderColor:l,getInputProps:x}=Je(),{register:I}=Le(),{props:S,ariaProps:v,dataProps:h,eventProps:g}=Pe(i);return{...x({errorBorderColor:m,focusBorderColor:l,...v,...h,...g,...S,ref:Me(I,n),index:r})}}),xn={component:s,title:"Components / PinInput"},w=()=>e.jsx(s,{}),V=()=>e.jsx(b,{each:[3,4,5,6],children:(n,r)=>e.jsx(s,{items:n},r)}),M=()=>e.jsx(be,{variant:"stack",columns:["outline","filled","flushed"],rows:Oe,children:(n,r,i)=>e.jsx(s,{colorScheme:r,variant:n},i)}),D=()=>e.jsx(be,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(n,r,i)=>e.jsx(s,{size:n,variant:r},i)}),O=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{type:"alphanumeric"})]}),T=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{defaultValue:"1234"}),e.jsx(s,{defaultValue:"123"})]}),q=()=>{const{page:n}=xe();return e.jsx(s,{onComplete:()=>n.start({duration:5e3})})},E=()=>e.jsx(s,{otp:!0}),A=()=>e.jsx(s,{mask:!0}),B=()=>e.jsx(s,{manageFocus:!1}),H=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,disabled:!0},r)}),e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(p,{disabled:!0,index:0}),e.jsx(p,{disabled:!0,index:1}),e.jsx(p,{disabled:!0,index:2}),e.jsx(p,{disabled:!0,index:3})]},r)}),e.jsx(C,{disabled:!0,errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",children:e.jsx(s,{})})]}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,readOnly:!0},r)}),e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(p,{index:0,readOnly:!0}),e.jsx(p,{index:1,readOnly:!0}),e.jsx(p,{index:2,readOnly:!0}),e.jsx(p,{index:3,readOnly:!0})]},r)}),e.jsx(C,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",label:"Please one-time password",readOnly:!0,children:e.jsx(s,{})})]}),_=()=>e.jsxs(e.Fragment,{children:[e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsx(s,{variant:n,invalid:!0},r)}),e.jsx(b,{each:["outline","filled","flushed"],children:(n,r)=>e.jsxs(s,{variant:n,children:[e.jsx(p,{index:0,invalid:!0}),e.jsx(p,{index:1,invalid:!0}),e.jsx(p,{index:2,invalid:!0}),e.jsx(p,{index:3,invalid:!0})]},r)}),e.jsx(C,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",invalid:!0,label:"Please one-time password",children:e.jsx(s,{})})]}),N=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{focusBorderColor:"green.500"}),e.jsx(s,{errorBorderColor:"orange.500",invalid:!0})]}),G=()=>e.jsxs(s,{children:[e.jsx(p,{index:0}),e.jsx(p,{index:1}),e.jsx(p,{index:2}),e.jsx(p,{index:3})]}),J=()=>e.jsx(s,{placeholder:"💩"}),U=()=>{const{page:n}=xe(),[r,i]=c.useState(""),m=()=>n.start({duration:5e3});return e.jsx(s,{value:r,onChange:i,onComplete:m})},$=()=>{const{control:n,formState:{errors:r},handleSubmit:i}=Ie(),m=l=>console.log("submit:",l);return e.jsxs(he,{as:"form",onSubmit:i(m),children:[e.jsx(C,{errorMessage:r.pinInput?.message,invalid:!!r.pinInput,label:"Token",children:e.jsx(Se,{name:"pinInput",control:n,render:({field:l})=>e.jsx(s,{...l}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(ge,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},K=()=>{const n={pinInput:"5"},{control:r,formState:{errors:i},handleSubmit:m}=Ie({defaultValues:n}),l=x=>console.log("submit:",x);return e.jsxs(he,{as:"form",onSubmit:m(l),children:[e.jsx(C,{errorMessage:i.pinInput?.message,invalid:!!i.pinInput,label:"Token",children:e.jsx(Se,{name:"pinInput",control:r,render:({field:x})=>e.jsx(s,{...x}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(ge,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`() => {
