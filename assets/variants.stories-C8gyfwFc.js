...
}`,...(m=(p=s.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var h,x,v;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`() => {
...
}`,...(v=(x=a.parameters)==null?void 0:x.docs)==null?void 0:v.source}}};var f,b,y;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`() => {
  const list: Variants = useMemo(() => ({
    hidden: {
      opacity: 0,
      transition: {
...
}`,...(y=(b=d.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var g,w,M;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`() => {
  const list: Variants = useMemo(() => ({
    hidden: {
      opacity: 0
    },
...
}`,...(M=(w=l.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var k,j,L;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`() => {
  const variants: Variants = useMemo(() => ({
    hidden: {
      opacity: 0,
      pathLength: 0
...
}`,...(L=(j=c.parameters)==null?void 0:j.docs)==null?void 0:L.source}}};const S=["Basic","Propagation","Orchestration","DynamicVariants","ValueSpecific"];export{s as Basic,l as DynamicVariants,d as Orchestration,a as Propagation,c as ValueSpecific,S as __namedExportsOrder,C as default};
