...
:::note
Available pseudo-elements are listed in the [Style Props](/docs/styling/style-props#pseudo-elements).
:::
...
:::note
Available pseudo-classes are listed in the [Style Props](/docs/styling/style-props#pseudo-classes).
:::
...
:::note
Available selectors are listed in the [Style Props](/docs/styling/style-props#selectors).
:::
...
:::note
Available group selectors are listed in the [Style Props](/docs/styling/style-props#selectors).
:::
...
:::note
Available peer selectors are listed in the [Style Props](/docs/styling/style-props#selectors).
:::
