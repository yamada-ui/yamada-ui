...
| ------------ | --------------------------------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Keeps focus on the chart surface and displays the tooltip for the next data point.      | `withTooltip={true}` |
| `ArrowLeft`  | Keeps focus on the chart surface and displays the tooltip for the previous data point.  | `withTooltip={true}` |
| `Enter`      | Toggles the tooltip display for the active data point while focus stays on the chart.   | `withTooltip={true}` |
...
| `svg`     | `tabIndex={0}`       | Makes the chart surface focusable by keyboard.     |
