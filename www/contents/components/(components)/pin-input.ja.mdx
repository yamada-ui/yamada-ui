...
| `Backspace`  | 現在のフィールドが空の場合、前の項目をクリアしてフォーカスを移動します。 | -    |

### ARIAロールと属性

| コンポーネントと要素        | ロールと属性       | 使い方                                                                                                                                                                                           |
| --------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `div.ui-pin-input__root`    | `role="group"`     | グループであることを示します。                                                                                                                                                                   |
| `input.ui-pin-input__field` | `aria-invalid`     | `invalid`が設定されている場合は`"true"`を設定します。                                                                                                                                            |
