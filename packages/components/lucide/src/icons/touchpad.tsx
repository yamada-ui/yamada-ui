...
import { Touchpad as OriginalTouchpad } from "lucide-react"
 ...
 */
export const TouchpadIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalTouchpad} {...props} />
))
