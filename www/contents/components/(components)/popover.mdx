...
tags: ["overlay", "disclosure", "floating"]
...
:::tip
Use `Popover` for contextual information or controls connected to a trigger. For short non-interactive supplementary information, use [Tooltip](/docs/components/tooltip); for blocking decisions, use [Modal](/docs/components/modal).
:::
...
|                   | `id`                     | Used to associate with `Popover.Trigger`.                                                |
