...
tags: ["scrollable", "animation", "list"]
...
::::tip
カルーセルの操作やスライド挙動が不要で、スクロール可能なコンテナーが必要な場合は、[ScrollArea](/docs/components/scroll-area)の使用を検討してください。
::::
...
| 要素                                | ロールと属性                      | 使い方                                                                                                    |
| ----------------------------------- | --------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `section.ui-carousel__root`         | `aria-roledescription="carousel"` | カルーセルであることを示します。                                                                          |
| `div.ui-carousel__list`             | `aria-live`                       | `autoplay`が`"true"`の場合は`"off"`を設定し、`"false"`の場合は`"polite"`を設定します。                    |
|                                     | `id`                              | 前後のトリガーの`aria-controls`に関連付けるために使用する`id`。                                           |
| `div.ui-carousel__item`             | `role="tabpanel"`                 | タブパネルであることを示します。                                                                          |
|                                     | `aria-label`                      | `"1 / 4"`のように、現在のスライドの番号を設定します。                                                     |
|                                     | `aria-roledescription="slide"`    | スライドであることを示します。                                                                            |
|                                     | `id`                              | `button.ui-carousel__indicator`の`aria-controls`に関連付けるために使用する`id`。                          |
| `button.ui-carousel__trigger--prev` | `aria-controls`                   | 関連した`div.ui-carousel__list`の`id`を設定します。                                                       |
|                                     | `aria-label`                      | `"前のスライドに移動する"`を設定します。                                                                  |
| `button.ui-carousel__trigger--next` | `aria-controls`                   | 関連した`div.ui-carousel__list`の`id`を設定します。                                                       |
|                                     | `aria-label`                      | `"次のスライドに移動する"`を設定します。                                                                  |
| `div.ui-carousel__indicators`       | `role="tablist"`                  | タブリストであることを示します。                                                                          |
|                                     | `aria-label`                      | `"スライド"`を設定します。                                                                                |
|                                     | `aria-orientation`                | `orientation`の値に基づいて`"horizontal"`または`"vertical"`を設定します。デフォルトは`"horizontal"`です。 |
| `button.ui-carousel__indicator`     | `role="tab"`                      | タブであることを示します。                                                                                |
|                                     | `aria-controls`                   | 関連した`div.ui-carousel__item`の`id`を設定します。                                                       |
|                                     | `aria-label`                      | `"1スライドに移動する"`のように、移動先のスライドの番号を設定します。                                     |
|                                     | `aria-selected`                   | 関連したスライドが選択されている場合は`"true"`を設定し、選択されていない場合は`"false"`を設定します。     |

## 類似のコンポーネント

<Similar name="carousel" />
