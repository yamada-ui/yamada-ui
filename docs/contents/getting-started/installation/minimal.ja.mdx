...
<Alert status='warning'>
  <AlertIcon />
  [基本を学ぶ](/docs/getting-started/installation/basic)や[応用を学ぶ](/docs/getting-started/installation/advanced)など多くのページは、[すべて](/docs/getting-started/installation)でインストールしている想定で説明されています。
</Alert>
...
テーマをインストール後、アプリケーションのルートに`ThemeProvider`を追加し、`@yamada-ui/theme`から[デフォルトのテーマ](/docs/styled-system/theming/default-theme)と[コンフィグ](/docs/styled-system/configure/default-config)を渡します。もし、あなたのテーマやコンフィグがある場合は、そちらを渡します。
...
<Alert status='info'>
  <AlertIcon />
  テーマやコンフィグをカスタマイズしたい場合は、[テーマをカスタマイズする](/docs/styled-system/theming/customize-theme)と[コンフィグをカスタマイズする](/docs/styled-system/configure/customize-config)をご覧ください。
</Alert>
