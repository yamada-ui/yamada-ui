import{n as M,o as Z,r as c,X as $,P as D,m as L,j as e,s as T,q as _,t as q,aK as K,V as z,E as w}from"./iframe-CDvKCJeY.js";import{H as R}from"./h-stack-B-oxGLsD.js";import{F as k}from"./for-Dx7nH0k1.js";import{B as l}from"./box-xTzNsHnl.js";import{S as E}from"./separator-CK2hvrAr.js";const O=M({base:{gap:"lg",overflow:"hidden",position:"relative"}}),{withContext:X}=Z("stack--depth",O),A=X(({css:t,children:n,direction:r="end",fit:x=!0,reverse:o=!1,startIndex:H=0,...I})=>{r==="start-center"&&(r="start"),r==="end-center"&&(r="end");const V=c.useRef(new Map),[W,v]=c.useState({height:0,width:0}),F=c.useCallback(s=>r.startsWith("start")?{[o?"top":"bottom"]:s}:r.startsWith("end")?{[o?"bottom":"top"]:s}:{[o?"bottom":"top"]:0},[r,o]),y=c.useCallback(s=>r.endsWith("-start")?{[o?"left":"right"]:s}:r.endsWith("-end")?{[o?"right":"left"]:s}:{[o?"right":"left"]:0},[r,o]),P=c.useMemo(()=>$(n).map((a,d)=>{const p=c.createRef();V.current.set(d,p);const i=a.key??d,f=H+d,h=`calc({space} * ${d})`,m={position:"absolute",zIndex:f,...F(h),...y(h)},u={...a.props,ref:L(a.props.ref,p),css:D(a.props.css,m)},j=c.cloneElement(a,u);return e.jsx(c.Fragment,{children:j},i)}),[n,H,F,y]);return c.useEffect(()=>{if(!x)return;let s=r.endsWith("-start"),g=r.startsWith("start"),a=0,d=0;o&&(s=!s,g=!g);for(const p of V.current.values()){if(!p.current)continue;let{offsetHeight:i,offsetLeft:f,offsetParent:h,offsetTop:m,offsetWidth:u}=p.current;h&&(s&&(f=(h?.offsetWidth??0)-f-u),g&&(m=(h?.offsetHeight??0)-m-i),u+=f,i+=m,u>a&&(a=u),i>d&&(d=i))}v({height:d,width:a})},[P,r,o,x]),e.jsx(T.div,{css:t,minHeight:x?`${W.height}px`:void 0,minWidth:x?`${W.width}px`:void 0,...I,children:P})})(void 0,t=>{const n=_(t.css,{gap:"space"});return{...q(t,{gap:"space"}),css:n}}),Y={component:K,title:"Components / Stack"},b=()=>e.jsx(z,{children:e.jsx(k,{each:["info","success","warning","error"],children:(t,n)=>e.jsx(l,{bg:t,color:"white",p:"md",rounded:"l2",children:"Box"},n)})}),B=()=>e.jsx(R,{children:e.jsx(k,{each:["info","success","warning","error"],children:(t,n)=>e.jsx(l,{bg:t,color:"white",p:"md",rounded:"l2",children:"Box"},n)})}),C=()=>e.jsx(k,{each:["end","start","center-end","center-start","end-start","end-end","start-start","start-end"],children:t=>e.jsx(A,{direction:t,children:["info","success","warning","error"].map((n,r)=>e.jsx(l,{bg:n,color:"white",p:"md",rounded:"l2",children:"Box"},r))},t)}),S=()=>e.jsxs(e.Fragment,{children:[e.jsxs(z,{separator:e.jsx(E,{}),children:[e.jsx(l,{bg:"info",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"success",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"warning",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"error",color:"white",p:"md",rounded:"l2",children:"Box"})]}),e.jsxs(R,{h:"2xs",separator:e.jsx(E,{}),children:[e.jsx(w,{bg:"info",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"success",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"warning",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"error",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"})]})]});b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
  return <VStack>
...
}`,...S.parameters?.docs?.source}}};const ee=["Vertical","Horizontal","Depth","Border"];export{S as Border,C as Depth,B as Horizontal,b as Vertical,ee as __namedExportsOrder,Y as default};
