import{n as Ve,I as we,d as Qe,a7 as Ze,r as u,ap as er,A as rr,bj as ke,h as z,m as Ie,a as nr,aa as tr,e as De,g as or,j as e,C as ar,J as V,V as Ee}from"./iframe-6Bjnmk15.js";import{P as Ge}from"./props-table-ols_EFU2.js";import{u as qe,C as Be}from"./index.esm-B9t4C2Hk.js";import{g as q,i as p,a as sr,u as ur,b as Ae}from"./input-C14uX6bY.js";import{b as lr}from"./button.style-BS6NiYW5.js";import{t as Te,a as Fe,c as ir}from"./number-CcP_arM8.js";import{u as cr}from"./index-CX0CAc80.js";import{u as dr}from"./index-CH5OoyLC.js";import{u as mr,F as T}from"./use-field-props-CJllY30F.js";import{c as Me}from"./createLucideIcon-dBwzvMsk.js";import{u as pr}from"./group-D6hRHRN8.js";import{I as P,a as pe,b as fe}from"./input-group-BT5CX_mw.js";import{C as fr}from"./chevron-down-icon-BzEuVkY8.js";import{F as O}from"./for-DmT075i_.js";import{H as hr}from"./h-stack-DkB3151u.js";import{I as ze}from"./icon-button-CbRY8Yre.js";import{B as He}from"./button-CsD90Sgr.js";import{P as _e}from"./plus-icon-BQm6ktzX.js";import{M as Ke}from"./minus-icon-DJOu7Skw.js";import"./preload-helper-D9Z9MdNV.js";import"./grid-BOPRDfru.js";import"./grid-item-b6_EoPjA.js";import"./flex-DoVac8e8.js";import"./heading-OelD6mpu.js";import"./use-input-border-D6r5drvY.js";import"./index-DRWHxUSc.js";import"./use-breakpoint-Dh_Zsenw.js";import"./use-breakpoint-value-DpYoCjbb.js";import"./use-color-mode-value-CCXFyZ78.js";import"./use-ripple-DerRjSwg.js";import"./rings-B9NsMSz3.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gr=[["path",{d:"m12 14 4-4",key:"9kzdfg"}],["path",{d:"M3.34 19a10 10 0 1 1 17.32 0",key:"19p75a"}]],Ir=Me("gauge",gr),Sr=Ve(we)({as:xr}),w=Ve(we)({as:Ir}),vr=Qe({base:{button:{...lr.base,flex:"1",lineHeight:"1",rounded:"l1"},control:{display:"flex",flexDirection:"column"},decrement:{},field:p.base,increment:{},root:{}},variants:{base:{button:{layerStyle:"ghost",focusVisibleRing:"none",_hover:{layerStyle:"ghost.hover"},_focusVisible:{layerStyle:"ghost.hover"}}},filled:{field:p.variants?.filled},flushed:{field:p.variants?.flushed,root:sr("& > input")},outline:{field:p.variants?.outline},plain:{field:p.variants?.plain}},sizes:{xs:{control:{boxSize:"calc({--height} - {spaces.2})",fontSize:p.sizes?.xs.fontSize},field:p.sizes?.xs,root:q(p.sizes?.xs.minH,"& > input")},sm:{control:{boxSize:"calc({--height} - {spaces.2})",fontSize:p.sizes?.sm.fontSize},field:p.sizes?.sm,root:q(p.sizes?.sm.minH,"& > input")},md:{control:{boxSize:"calc({--height} - {spaces.2})",fontSize:p.sizes?.md.fontSize},field:p.sizes?.md,root:q(p.sizes?.md.minH,"& > input")},lg:{control:{boxSize:"calc({--height} - {spaces.2.5})",fontSize:p.sizes?.lg.fontSize},field:p.sizes?.lg,root:q(p.sizes?.lg.minH,"& > input")},xl:{control:{boxSize:"calc({--height} - {spaces.3})",fontSize:p.sizes?.xl.fontSize},field:p.sizes?.xl,root:q(p.sizes?.xl.minH,"& > input")},"2xl":{control:{boxSize:"calc({--height} - {spaces.3})",fontSize:p.sizes?.["2xl"].fontSize},field:p.sizes?.["2xl"],root:q(p.sizes?.["2xl"]?.minH,"& > input")}},defaultProps:{size:"md",variant:"outline"}}),F=r=>parseFloat(r.toString().replace(/[^\w.-]+/g,"")),Le=(r,n)=>Math.max(Fe(n),Fe(r)),ge=(r,n,t)=>(r=F(r),Number.isNaN(r)?void 0:Te(r,t??Le(r,n))),Cr=({keepWithinRange:r=!0,max:n=Number.MAX_SAFE_INTEGER,min:t=Number.MIN_SAFE_INTEGER,step:a=1,...s}={})=>{const m=Ze(s.onChange),[b,S]=u.useState(()=>s.defaultValue==null?"":ge(s.defaultValue,a,s.precision)??""),g=typeof s.value<"u",f=g?s.value:b,x=Le(F(f),a),i=s.precision??x,h=u.useCallback(d=>{d!==f&&(g||S(d.toString()),m(d.toString(),F(d)))},[m,g,f]),v=u.useCallback(d=>{let c=d;return r&&(c=ir(c,t,n)),Te(c,i)},[i,r,n,t]),R=u.useCallback((d=a)=>{let c;f===""?c=F(d):c=F(f)+d,c=v(c),h(c)},[v,a,h,f]),C=u.useCallback((d=a)=>{let c;f===""?c=F(-d):c=F(f)-d,c=v(c),h(c)},[v,a,h,f]),M=u.useCallback(()=>{let d;s.defaultValue==null?d="":d=ge(s.defaultValue,a,s.precision)??t,h(d)},[s.defaultValue,s.precision,a,h,t]),y=u.useCallback(d=>{const c=ge(d,a,i)??t;h(c)},[i,a,h,t]),I=F(f),N=I<t||n<I;return{cast:y,clamp:v,decrement:C,increment:R,max:I===n,min:I===t,out:N,precision:i,reset:M,setValue:S,step:a,update:h,value:f,valueAsNumber:I}},jr=50,Pe=300,yr=({decrement:r,increment:n})=>{const[t,a]=u.useState(!1),[s,m]=u.useState(null),[b,S]=u.useState(!0),g=u.useRef(null);dr(()=>{s==="increment"&&n(),s==="decrement"&&r()},t?jr:null);const f=u.useCallback(()=>{b&&n(),g.current=setTimeout(()=>{S(!1),a(!0),m("increment")},Pe)},[n,b]),x=u.useCallback(()=>{b&&r(),g.current=setTimeout(()=>{S(!1),a(!0),m("decrement")},Pe)},[r,b]),i=u.useCallback(()=>clearTimeout(g.current),[]),h=u.useCallback(()=>{S(!0),a(!1),i()},[i]);return er(i),{down:x,spinning:t,stop:h,up:f}},Nr=({decrement:r,disabled:n,increment:t,keepWithinRange:a,max:s,min:m,...b})=>{const S=u.useRef(null),g=u.useRef(null),{down:f,spinning:x,stop:i,up:h}=yr({decrement:r,increment:t}),{t:v}=rr("numberInput");ke(S,["disabled"],x,i),ke(g,["disabled"],x,i);const R=u.useCallback((y={})=>({type:"button",disabled:n,tabIndex:-1,...b,...y,onPointerLeave:z(y.onPointerLeave,i),onPointerUp:z(y.onPointerUp,i)}),[b,n,i]),C=u.useCallback(({ref:y,...I}={})=>{const N=n||a&&s;return{ref:Ie(y,S),"aria-label":v("Increase"),...R({disabled:N,...I}),onPointerDown:z(I.onPointerDown,k=>{k.button!==0||N||(k.preventDefault(),h())})}},[R,n,a,s,h,v]);return{getDecrementProps:u.useCallback(({ref:y,...I}={})=>{const N=n||a&&m;return{ref:Ie(y,g),"aria-label":v("Decrease"),...R({disabled:N,...I}),onPointerDown:z(I.onPointerDown,k=>{k.button!==0||N||(k.preventDefault(),f())})}},[R,n,a,m,f,v]),getIncrementProps:C}},Rr=r=>r.toString(),kr=r=>r,Dr=r=>/^[Ee0-9+\-.]$/.test(r),Fr=({key:r,altKey:n,ctrlKey:t,metaKey:a},s)=>{const m=t||n||a;return!(r.length===1)||m?!0:s(r)},Oe=({ctrlKey:r,metaKey:n,shiftKey:t})=>{let a=1;return(n||r)&&(a=.1),t&&(a=10),a},We=(r={})=>{const{props:{allowMouseWheel:n,clampValueOnBlur:t=!0,defaultValue:a,disabled:s,focusInputOnChange:m=!0,format:b=Rr,getAriaValueText:S,isValidCharacter:g=Dr,keepWithinRange:f=!0,max:x=Number.MAX_SAFE_INTEGER,min:i=Number.MIN_SAFE_INTEGER,parse:h=kr,precision:v,readOnly:R,step:C=1,value:M,onChange:y,...I},ariaProps:N,dataProps:k,eventProps:H}=mr(r),d=!(R||s),c=u.useRef(null),{cast:Se,max:Ue,min:$e,out:ve,setValue:be,update:B,value:D,valueAsNumber:E,..._}=Cr({defaultValue:a,keepWithinRange:f,max:x,min:i,precision:v,step:C,value:M,onChange:y}),xe=u.useRef(null),Ce=u.useMemo(()=>{let o=S?.(D);return o??(o=D.toString(),o||void 0)},[D,S]),K=u.useCallback(o=>o.split("").filter(g).join(""),[g]),L=u.useCallback((o=C)=>{d&&(_.increment(o),m&&requestAnimationFrame(()=>{c.current?.focus()}))},[d,_,C,m]),W=u.useCallback((o=C)=>{d&&(_.decrement(o),m&&requestAnimationFrame(()=>{c.current?.focus()}))},[d,_,C,m]),je=u.useCallback(o=>{if(o.nativeEvent.isComposing)return;const{selectionEnd:j,selectionStart:A,value:G}=o.currentTarget;B(K(h(G))),xe.current={end:j,start:A}},[h,K,B]),ye=u.useCallback(o=>{if(!xe.current)return;const{end:j,start:A}=xe.current,{selectionStart:G,value:U}=o.currentTarget;o.currentTarget.selectionStart=A??U.length,o.currentTarget.selectionEnd=j??G},[]),Ne=u.useCallback(()=>{if(!t)return;let o=D;if(D==="")return;/^[eE]/.test(D.toString())?be(""):(E<i&&(o=i),E>x&&(o=x),Se(o))},[Se,t,x,i,be,D,E]),Re=u.useCallback(o=>{if(o.nativeEvent.isComposing)return;Fr(o,g)||o.preventDefault();const j=Oe(o)*C;nr(o,{ArrowDown:()=>W(j),ArrowUp:()=>L(j),End:()=>B(x),Home:()=>B(i)})},[W,L,g,x,i,C,B]),{getDecrementProps:Xe,getIncrementProps:Ye}=Nr({"aria-disabled":De(!d),decrement:W,disabled:s,increment:L,keepWithinRange:f,max:Ue,min:$e,...k});tr(()=>{!c.current||!(c.current.value!=D)||be(K(h(c.current.value)))},[h,K]),cr(c.current,"wheel",o=>{const A=(c.current?.ownerDocument??document).activeElement===c.current;if(!n||!A)return;o.preventDefault();const G=Oe(o)*C,U=Math.sign(o.deltaY);U===-1?L(G):U===1&&W(G)},{passive:!1});const Je=u.useCallback(({ref:o,...j}={})=>({...N,...k,type:"text","aria-invalid":De(N["aria-invalid"]??ve),"aria-valuemax":x,"aria-valuemin":i,"aria-valuenow":Number.isNaN(E)?void 0:E,"aria-valuetext":Ce,autoComplete:"off",autoCorrect:"off",disabled:s,inputMode:"decimal",max:x,min:i,pattern:"[0-9]*(.[0-9]+)?",readOnly:R,role:"spinbutton",step:C,value:b(D),...I,...j,ref:Ie(o,I.ref,c),onBlur:z(H.onBlur,j.onBlur,Ne),onChange:z(j.onChange,je),onFocus:z(H.onFocus,j.onFocus,ye),onKeyDown:z(I.onKeyDown,j.onKeyDown,Re)}),[b,ve,D,Ce,N,k,H,x,i,E,s,R,C,I,Re,Ne,ye,je]);return{getDecrementProps:Xe,getIncrementProps:Ye,getInputProps:Je}},{withContext:he,withProvider:zr}=or("number-input",vr),l=zr(({className:r,css:n,colorScheme:t,controlProps:a,decrementProps:s,elementProps:m,incrementProps:b,rootProps:S,...g})=>{const[f,x]=pr(g),{getDecrementProps:i,getIncrementProps:h,getInputProps:v}=We(x);return e.jsxs(P,{className:r,css:n,colorScheme:t,...f,...S,children:[e.jsx(Pr,{...v()}),e.jsx(pe,{clickable:!0,...m,children:e.jsxs(Or,{...a,children:[e.jsx(Vr,{...h(b)}),e.jsx(wr,{...i(s)})]})})]})},"root")(r=>({...ur(),...r})),Pr=he(Ae,"field")({"data-group-propagate":""}),Or=he("div","control")(),Vr=he("button",["button","increment"])({children:e.jsx(Sr,{})}),wr=he("button",["button","decrement"])({children:e.jsx(fr,{})}),pn={component:l,title:"Components / NumberInput"},$=()=>e.jsx(l,{placeholder:"Basic"}),X=()=>e.jsx(Ge,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(r,n,t)=>e.jsx(l,{size:r,variant:n,placeholder:`Size (${r})`},t)}),Y=()=>e.jsx(Ge,{variant:"stack",columns:["outline","filled","flushed"],rows:ar,children:(r,n,t)=>e.jsx(l,{colorScheme:n,variant:r,placeholder:V(r)},t)}),J=()=>e.jsx(l,{defaultValue:18,placeholder:"Order quantity"}),Q=()=>e.jsx(l,{defaultValue:18,max:31,min:8,placeholder:"Order quantity"}),Z=()=>e.jsx(l,{defaultValue:15,max:30,min:5,placeholder:"Order quantity",step:5}),ee=()=>e.jsx(l,{defaultValue:15,placeholder:"Order quantity",precision:2,step:.2}),re=()=>e.jsx(l,{clampValueOnBlur:!1,defaultValue:15,max:30,placeholder:"Order quantity"}),ne=()=>e.jsx(l,{clampValueOnBlur:!1,defaultValue:15,keepWithinRange:!1,max:30,placeholder:"Order quantity"}),te=()=>e.jsxs(e.Fragment,{children:[e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsx(l,{variant:r,disabled:!0,placeholder:V(r)},n)}),e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsxs(P,{variant:r,disabled:!0,children:[e.jsx(fe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:V(r)})]},n)}),e.jsx(T,{disabled:!0,helperMessage:"Please enter the quantity you wish to order.",label:"Order quantity",children:e.jsx(l,{})})]}),oe=()=>e.jsxs(e.Fragment,{children:[e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsx(l,{variant:r,placeholder:V(r),readOnly:!0},n)}),e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsxs(P,{variant:r,readOnly:!0,children:[e.jsx(fe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:V(r)})]},n)}),e.jsx(T,{helperMessage:"Please enter the quantity you wish to order.",label:"Order quantity",readOnly:!0,children:e.jsx(l,{})})]}),ae=()=>e.jsxs(e.Fragment,{children:[e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsx(l,{variant:r,invalid:!0,placeholder:V(r)},n)}),e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsxs(P,{variant:r,invalid:!0,children:[e.jsx(fe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:V(r)})]},n)}),e.jsx(T,{errorMessage:"Order quantity is required.",invalid:!0,label:"Order quantity",children:e.jsx(l,{})})]}),se=()=>e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsxs(P,{variant:r,children:[e.jsx(fe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:"Order quantity"})]},n)}),ue=()=>e.jsx(O,{each:["outline","filled","flushed"],children:(r,n)=>e.jsxs(P,{variant:r,children:[e.jsx(pe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:"Order quantity"})]},n)}),le=()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{disabled:!0,placeholder:"Default border color"}),e.jsx(l,{focusBorderColor:"green.500",placeholder:"Custom border color"}),e.jsxs(P,{variant:"flushed",focusBorderColor:"green.500",children:[e.jsx(pe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:"Custom border color"})]}),e.jsx(l,{errorBorderColor:"orange.500",invalid:!0,placeholder:"Custom border color"}),e.jsxs(P,{errorBorderColor:"orange.500",invalid:!0,children:[e.jsx(pe,{children:e.jsx(w,{})}),e.jsx(l,{placeholder:"Custom border color"})]})]}),ie=()=>e.jsx(l,{placeholder:"Order quantity",decrementProps:{children:e.jsx(Ke,{})},incrementProps:{children:e.jsx(_e,{})}}),ce=()=>{const{getDecrementProps:r,getIncrementProps:n,getInputProps:t}=We({defaultValue:3.14,max:4,min:3,precision:2,step:.01});return e.jsxs(hr,{gap:"sm",maxW:"xs",children:[e.jsx(ze,{icon:e.jsx(_e,{fontSize:"2xl"}),...n(),"aria-label":"Increment"}),e.jsx(Ae,{...t(),"aria-label":"Number input"}),e.jsx(ze,{icon:e.jsx(Ke,{fontSize:"2xl"}),...r(),"aria-label":"Decrement"})]})},de=()=>{const{control:r,formState:{errors:n},handleSubmit:t,watch:a}=qe(),s=m=>console.log("submit:",m);return console.log("watch:",a()),e.jsxs(Ee,{as:"form",onSubmit:t(s),children:[e.jsx(T,{errorMessage:n.numberInput?.message,invalid:!!n.numberInput,label:"Age",children:e.jsx(Be,{name:"numberInput",control:r,render:({field:m})=>e.jsx(l,{...m}),rules:{max:{message:"The maximum value is 5.",value:5},required:{message:"This is required.",value:!0}}})}),e.jsx(He,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},me=()=>{const r={numberInput:"5"},{control:n,formState:{errors:t},handleSubmit:a,watch:s}=qe({defaultValues:r}),m=b=>console.log("submit:",b);return console.log("watch:",s()),e.jsxs(Ee,{as:"form",onSubmit:a(m),children:[e.jsx(T,{errorMessage:t.numberInput?.message,invalid:!!t.numberInput,label:"Age",children:e.jsx(Be,{name:"numberInput",control:n,render:({field:b})=>e.jsx(l,{...b}),rules:{required:{message:"This is required.",value:!0}}})}),e.jsx(He,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:`() => {
