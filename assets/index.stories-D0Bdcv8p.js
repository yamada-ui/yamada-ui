import{j as r,T as o}from"./iframe-DuTn5VqT.js";import{u}from"./index-DrriO-nc.js";import"./preload-helper-C1FmrZbK.js";import"./index-BAWypcZY.js";const g={title:"Hooks / useAsync"},e=()=>{const{error:s,loading:c,value:i}=u(async()=>new Promise((m,d)=>{setTimeout(()=>{Math.random()>.5?m("✌️"):d(new Error("A pseudo random error occurred"))},3e3)}),[]);return c?r.jsx(o,{children:"Loading..."}):s?r.jsxs(o,{children:["Error: ",s.message]}):r.jsxs(o,{children:["Value: ",i]})};var n,t,a;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  const {
    error,
    loading,
    value
