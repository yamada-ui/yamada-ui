...
| ---------------- | ---------------------------------------- | ----- |
| `Tab`            | Moves focus to the next page button.     | -     |
| `Shift + Tab`    | Moves focus to the previous page button. | -     |
...
| -------------------------------------- | --------------------- | --------------------------------------------------------- |
| `nav.ui-pagination__root`              | `role="navigation"`   | Indicates that this is a navigation region between pages. |
|                                        | `aria-label`          | Sets to `"Pagination"`.                                   |
| `button.ui-pagination__item`           | `aria-label`          | Sets to `"Go to page {value}"` for page number buttons.   |
|                                        | `aria-current="page"` | Sets to the current page number button.                   |
| `button.ui-pagination__item > span`    | `role="presentation"` | Indicates that it is presentational.                      |
| `button.ui-pagination__trigger--prev`  | `aria-label`          | Sets to `"Go to previous page"`.                          |
| `button.ui-pagination__trigger--next`  | `aria-label`          | Sets to `"Go to next page"`.                              |
| `button.ui-pagination__trigger--start` | `aria-label`          | Sets to `"Go to first page"`.                             |
| `button.ui-pagination__trigger--end`   | `aria-label`          | Sets to `"Go to last page"`.                              |
