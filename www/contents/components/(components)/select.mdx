...
:::tip
If you want to display suggested values based on text input, use [Autocomplete](/docs/components/autocomplete).
:::
...
| ------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-select__field`    | `role="combobox"`         | Indicates that this is a combobox.                                                                                                                                  |
|                           | `aria-activedescendant`   | Sets the `id` of the focused item.                                                                                                                                  |
|                           | `aria-controls`           | If the listbox is open, sets the `id` of the related `div.ui-select__content`; when closed, sets `undefined`.                                                       |
...
|                           | `aria-labelledby`         | If `Select.Root` is within a `Field.Root` and `Field.Root` has a `label` or `Field.Label`, sets its `id`.                                                           |
|                           | `aria-readonly`           | Sets to `"true"` if `readOnly` is set.                                                                                                                              |
|                           | `aria-required`           | Sets to `"true"` if `required` is set.                                                                                                                              |
| `div.ui-select__icon`     | `role="button"`           | Indicates that this is a button when `clearable` is set and a value is present.                                                                                     |
...
| `div.ui-select__content`  | `role="listbox"`          | Indicates that this is a listbox.                                                                                                                                   |
| `span.ui-select__label`   | `role="presentation"`     | Indicates that this is a presentation.                                                                                                                              |
| `div.ui-select__group`    | `role="group"`            | Indicates that this is a group.                                                                                                                                     |
|                           | `aria-labelledby`         | Sets the `id` of the associated `span.ui-select__label`.                                                                                                            |
| `div.ui-select__option`   | `role="option"`           | Indicates that this is an option.                                                                                                                                   |
...
| `hr.ui-select__separator` | `role="separator"`        | Indicates that this is a separator.                                                                                                                                 |
