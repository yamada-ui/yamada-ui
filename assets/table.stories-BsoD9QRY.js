import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-kkZeYk3H.js";import{Er as r,kr as i,pt as ee,tr as te}from"./core-Dqwv7d2P.js";import{t as ne}from"./jsx-runtime-BBQGix-2.js";import{nt as re,t as ie}from"./icon-BZhyoaSQ.js";import{a,t as ae}from"./i18n-provider-BX0zbrAf.js";import{Bd as o,Cn as oe,Gt as s,Ld as se,Ti as ce,Wt as le,_u as ue,au as de,bu as fe,lu as pe,qt as me,vu as he,wn as c,wu as ge,yi as _e}from"./iframe-BVukGgB1.js";import{n as l,t as ve}from"./storybook-EwZMifu4.js";import{r as u,t as ye}from"./dist-2vRssqBe.js";var d,f,be,p,m,h,xe,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,Se;t((()=>{ye(),d=e(n(),1),ve(),le(),ae(),ee(),se(),ie(),ue(),_e(),de(),oe(),f=ne(),be={component:s,title:`Components / Table`},p=(e=10)=>Array.from({length:e},(e,t)=>({id:t.toString(),age:u.number.int({max:65,min:18}),createdAt:u.date.past(),email:u.internet.email(),firstName:u.person.firstName(),lastName:u.person.lastName(),phone:u.phone.number(),role:u.helpers.arrayElement([`admin`,`user`]),status:u.helpers.arrayElement([`active`,`inactive`]),updatedAt:u.date.past()})),m=me(),h=[m.accessor(`id`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.accessor(`firstName`,{footer:e=>e.column.id}),m.accessor(`lastName`,{footer:e=>e.column.id}),m.accessor(`age`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.accessor(`email`,{footer:e=>e.column.id,lineClamp:1})],xe=[...h,m.accessor(`phone`,{footer:e=>e.column.id}),m.accessor(`role`,{footer:e=>e.column.id}),m.accessor(`status`,{footer:e=>e.column.id}),m.accessor(`createdAt`,{cell:e=>e.getValue().toLocaleDateString(),footer:e=>e.column.id}),m.accessor(`updatedAt`,{cell:e=>e.getValue().toLocaleDateString(),footer:e=>e.column.id})],g=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[])}),_=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,rows:[`line`,`outline`],children:(t,n,r)=>(0,f.jsx)(s,{variant:n,columns:h,data:e},r)})},v=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,rows:[`sm`,`md`,`lg`],children:(t,n,r)=>(0,f.jsx)(s,{size:n,columns:h,data:e,enableRowSelection:!0},r)})},y=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,rows:[`line`,`outline`],children:(t,n,r)=>(0,f.jsx)(s,{variant:n,columns:h,data:e,striped:!0},r)})},b=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,columns:[`outline`,`striped`],rows:te,children:(t,n,r)=>(0,f.jsx)(s,{colorScheme:n,variant:t===`striped`?void 0:`outline`,columns:h,data:e,striped:t===`striped`},r)})},x=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(s,{columns:h,data:e,withBorder:!0}),(0,f.jsx)(s,{columns:h,data:e,withBorder:!0,withColumnBorders:!0})]})},S=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),withColumnBorders:!0}),C=()=>(0,f.jsx)(s,{columns:xe,data:(0,d.useMemo)(()=>p(),[]),withScrollArea:!0}),w=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,columns:[`outline`,`striped`],rows:te,children:(t,n,r)=>(0,f.jsx)(s,{colorScheme:n,variant:t===`striped`?void 0:`outline`,columns:h,data:e,highlightOnHover:!0,striped:t===`striped`},r)})},T=()=>(0,f.jsx)(s,{columns:(0,d.useMemo)(()=>[m.accessor(`id`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.group({id:`user`,columns:[m.group({id:`name`,columns:[m.accessor(`firstName`,{footer:e=>e.column.id}),m.accessor(`lastName`,{footer:e=>e.column.id})],footer:e=>e.column.id,header:e=>e.column.id}),m.accessor(`age`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.accessor(`email`,{footer:e=>e.column.id})],footer:e=>e.column.id,header:e=>e.column.id})],[]),data:(0,d.useMemo)(()=>p(),[]),withBorder:!0,withColumnBorders:!0}),E=()=>(0,f.jsx)(s,{columns:(0,d.useMemo)(()=>[m.accessor(`id`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.group({id:`user`,columns:[m.group({id:`name`,columns:[m.accessor(`firstName`,{footer:e=>e.column.id}),m.accessor(`lastName`,{footer:e=>e.column.id})],footer:e=>e.column.id,header:e=>e.column.id}),m.accessor(`age`,{footer:e=>e.column.id,cellProps:{numeric:!0}}),m.accessor(`email`,{footer:e=>e.column.id})],footer:e=>e.column.id,header:e=>e.column.id})],[]),data:(0,d.useMemo)(()=>p(),[]),withBorder:!0,withColumnBorders:!0,withFooterGroups:!0}),D=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableKeyboardNavigation:!1}),O=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),initialFocusableCell:{colIndex:1,rowIndex:0}}),k=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,rows:[`onClick`,`onDoubleClick`],children:(t,n,r)=>(0,f.jsx)(s,{columns:h,data:e,onRowClick:e=>{n===`onClick`&&console.log(`row clicked`,e)},onRowDoubleClick:e=>{n===`onDoubleClick`&&console.log(`row double clicked`,e)}},r)})},A=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),defaultSorting:[{id:`age`,desc:!0}]}),j=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableSorting:!1}),M=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableMultiSort:!1}),N=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),maxMultiSortColCount:2}),P=()=>{let e=(0,d.useMemo)(()=>p(),[]),[t,n]=(0,d.useState)(e);return(0,f.jsx)(s,{columns:h,data:t,enableMultiSort:!1,manualSorting:!0,onSortingChange:t=>{if(t.length){let{id:e,desc:ee}=t[0];n(t=>t.toSorted((t,n)=>r(t[e])&&r(n[e])?ee?t[e]-n[e]:n[e]-t[e]:i(t[e])&&i(n[e])?ee?t[e].localeCompare(n[e]):n[e].localeCompare(t[e]):0))}else n(e)}})},F=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),sortDescFirst:!0}),I=()=>{let[e,t]=(0,d.useState)([{id:`age`,desc:!0}]);return(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),sorting:e,onSortingChange:t})},L=()=>{let{t:e}=a(`table`);return(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(100),[]),enablePagination:!0,footer:t=>{let n=t.getState().pagination.pageIndex+1,r=t.getState().pagination.pageSize,i=t.getPageCount();return(0,f.jsxs)(o,{templateColumns:`1fr 1fr 1fr`,w:`full`,children:[(0,f.jsx)(ce,{size:`sm`,gridColumn:`2 / 3`,page:n,total:i,onChange:e=>t.setPageIndex(e-1)}),(0,f.jsx)(pe,{size:`sm`,"aria-label":e(`Page size`),items:[{label:`10`,value:`10`},{label:`20`,value:`20`},{label:`30`,value:`30`},{label:`40`,value:`40`},{label:`50`,value:`50`}],value:r.toString(),rootProps:{justifySelf:`end`,w:`5xs`},onChange:e=>t.setPageSize(Number(e))})]})}})})},R=()=>{let{t:e}=a(`table`);return(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(100),[]),defaultPagination:{pageIndex:2,pageSize:10},enablePagination:!0,footer:t=>{let n=t.getState().pagination.pageIndex+1,r=t.getState().pagination.pageSize,i=t.getPageCount();return(0,f.jsxs)(o,{templateColumns:`1fr 1fr 1fr`,w:`full`,children:[(0,f.jsx)(ce,{size:`sm`,gridColumn:`2 / 3`,page:n,total:i,onChange:e=>t.setPageIndex(e-1)}),(0,f.jsx)(pe,{size:`sm`,"aria-label":e(`Page size`),items:[{label:`10`,value:`10`},{label:`20`,value:`20`},{label:`30`,value:`30`},{label:`40`,value:`40`},{label:`50`,value:`50`}],value:r.toString(),rootProps:{justifySelf:`end`,w:`5xs`},onChange:e=>t.setPageSize(Number(e))})]})}})})},z=()=>{let{t:e}=a(`table`),[t,n]=(0,d.useState)({pageIndex:0,pageSize:20}),r=(0,d.useMemo)(()=>p(100),[]);return(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>r.slice(t.pageIndex*t.pageSize,(t.pageIndex+1)*t.pageSize),[r,t]),enablePagination:!0,footer:t=>{let n=t.getState().pagination.pageIndex+1,r=t.getState().pagination.pageSize,i=t.getPageCount();return(0,f.jsxs)(o,{templateColumns:`1fr 1fr 1fr`,w:`full`,children:[(0,f.jsx)(ce,{size:`sm`,gridColumn:`2 / 3`,page:n,total:i,onChange:e=>t.setPageIndex(e-1)}),(0,f.jsx)(pe,{size:`sm`,"aria-label":e(`Page size`),items:[{label:`10`,value:`10`},{label:`20`,value:`20`},{label:`30`,value:`30`},{label:`40`,value:`40`},{label:`50`,value:`50`}],value:r.toString(),rootProps:{justifySelf:`end`,w:`5xs`},onChange:e=>t.setPageSize(Number(e))})]})},manualPagination:!0,pagination:t,rowCount:100,onPaginationChange:n})})},B=()=>{let[e,t]=(0,d.useState)({pageIndex:0,pageSize:20}),{t:n}=a(`table`);return(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(100),[]),enablePagination:!0,footer:e=>{let t=e.getState().pagination.pageIndex+1,r=e.getState().pagination.pageSize,i=e.getPageCount();return(0,f.jsxs)(o,{templateColumns:`1fr 1fr 1fr`,w:`full`,children:[(0,f.jsx)(ce,{size:`sm`,gridColumn:`2 / 3`,page:t,total:i,onChange:t=>e.setPageIndex(t-1)}),(0,f.jsx)(pe,{size:`sm`,"aria-label":n(`Page size`),items:[{label:`10`,value:`10`},{label:`20`,value:`20`},{label:`30`,value:`30`},{label:`40`,value:`40`},{label:`50`,value:`50`}],value:r.toString(),rootProps:{justifySelf:`end`,w:`5xs`},onChange:t=>e.setPageSize(Number(t))})]})},pagination:e,onPaginationChange:t})})},V=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:!0}),H=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),defaultRowSelection:{0:!0},enableRowSelection:!0}),U=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:!0,withFooterCheckbox:!0,withFooterGroups:!0}),W=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:!0,selectOnClickRow:!0}),G=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:!0,selectOnClickRow:!0,withCheckbox:!1}),K=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:e=>e.id!==`1`}),q=()=>{let[e,t]=(0,d.useState)({});return(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableRowSelection:!0,rowSelection:e,onRowSelectionChange:t})},J=()=>(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),header:e=>{let t=e.getColumn(`email`)?.getFilterValue()??``;return(0,f.jsxs)(he,{children:[(0,f.jsx)(fe,{children:(0,f.jsx)(re,{})}),(0,f.jsx)(ge,{placeholder:`Filter emails`,value:t,onChange:t=>e.getColumn(`email`)?.setFilterValue(t.target.value)})]})}})}),Y=()=>(0,f.jsx)(c,{children:(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),defaultColumnFilters:[{id:`email`,value:`gmail`}],header:e=>{let t=e.getColumn(`email`)?.getFilterValue()??``;return(0,f.jsxs)(he,{children:[(0,f.jsx)(fe,{children:(0,f.jsx)(re,{})}),(0,f.jsx)(ge,{placeholder:`Filter emails`,value:t,onChange:t=>e.getColumn(`email`)?.setFilterValue(t.target.value)})]})}})}),X=()=>{let[e,t]=(0,d.useState)([{id:`email`,value:``}]);return(0,f.jsx)(c,{children:(0,f.jsx)(s,{columnFilters:e,columns:h,data:(0,d.useMemo)(()=>p(),[]),header:e=>{let t=e.getColumn(`email`)?.getFilterValue()??``;return(0,f.jsxs)(he,{children:[(0,f.jsx)(fe,{children:(0,f.jsx)(re,{})}),(0,f.jsx)(ge,{placeholder:`Filter emails`,value:t,onChange:t=>e.getColumn(`email`)?.setFilterValue(t.target.value)})]})},onColumnFiltersChange:t})})},Z=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableColumnResizing:!0,withBorder:!0,withColumnBorders:!0}),Q=()=>(0,f.jsx)(s,{columns:h,data:(0,d.useMemo)(()=>p(),[]),enableAutoResizeTableWidth:!0,enableColumnResizing:!0,withBorder:!0,withColumnBorders:!0,tableProps:{maxW:`full`}}),$=()=>{let e=(0,d.useMemo)(()=>p(),[]);return(0,f.jsx)(l,{variant:`stack`,rows:[`onChange`,`onEnd`],children:(t,n,r)=>(0,f.jsx)(s,{columnResizeMode:n,columns:h,data:e,enableColumnResizing:!0,withBorder:!0,withColumnBorders:!0},r)})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {
  ...
  return <Table columns={columns} data={data} enableMultiSort={false} manualSorting onSortingChange={sorting => {
    if (sorting.length) {
      ...
      setData(prev => prev.toSorted((a, b) => {
        if (isNumber(a[id]) && isNumber(b[id])) return desc ? a[id] - b[id] : b[id] - a[id];else if (isString(a[id]) && isString(b[id])) return desc ? a[id].localeCompare(b[id]) : b[id].localeCompare(a[id]);
        return 0;
      }));
    } else {
      setData(defaultData);
