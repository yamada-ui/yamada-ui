...
:::note
`Motion`は、内部で[Motion](https://motion.dev)を使用しています。さらに詳しくコンポーネントの機能を知りたい場合は、[Motionコンポーネントのドキュメント](https://motion.dev/docs/react-motion-component)をご覧ください。
:::
...
:::note
バリアントのアニメーションをもっと知りたい場合は、[バリアントのドキュメント](https://motion.dev/docs/react-animation#variants)をご覧ください。
:::
...
:::note
ホバーのアニメーションをもっと知りたい場合は、[ホバーのドキュメント](https://motion.dev/docs/react-hover-animation)をご覧ください。
:::
...
:::note
クリック・タップのアニメーションをもっと知りたい場合は、[タップのドキュメント](https://motion.dev/docs/react-gestures#tap)をご覧ください。
:::
...
:::note
フォーカスのアニメーションをもっと知りたい場合は、[フォーカスのドキュメント](https://motion.dev/docs/react-gestures#focus)をご覧ください。
:::
...
:::note
ドラッグのアニメーションをもっと知りたい場合は、[ドラッグのドキュメント](https://motion.dev/docs/react-drag)をご覧ください。
:::
