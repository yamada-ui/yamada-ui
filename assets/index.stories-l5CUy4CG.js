import{i as e}from"./preload-helper-usAeo7Bx.js";import{Y as t,t as n}from"./core-DkLkzQLq.js";import{t as r}from"./jsx-runtime-O9QVJvLM.js";import{n as i}from"./use-breakpoint-DGOEv_TY.js";import{n as a,r as o,t as s}from"./use-value-BGSiTqCz.js";import{Ol as c,kl as l}from"./iframe-DpVGHWSQ.js";var u,d,f,p;e((()=>{s(),c(),n(),o(),u=r(),d={title:`Hooks / useValue`},f=()=>{let{colorMode:e}=t(),n=i();return(0,u.jsxs)(l,{bg:a({base:`red.500`,sm:`purple.500`,md:`yellow.500`,lg:`green.500`,xl:`blue.500`}),color:a([`whiteAlpha.800`,`blackAlpha.800`]),p:`md`,rounded:`l2`,transitionDuration:`moderate`,transitionProperty:`all`,children:[`The current breakpoint is "`,n,`", colorMode is "`,e,`"`]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
