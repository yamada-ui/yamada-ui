...
Next.jsの[Link](https://nextjs.org/docs/app/api-reference/components/link)や[Image](https://nextjs.org/docs/app/api-reference/components/image)などのコンポーネントとYamada UIのコンポーネントを統合することができます。
