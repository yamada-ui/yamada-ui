...
| ------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `input.ui-number-input__field`              | `role="spinbutton"`  | Indicates that this is a spinbutton.                                                                                                                                |
...
| `button.ui-number-input__button--increment` | `aria-label`         | Sets to `"Increase"`.                                                                                                                                               |
| `button.ui-number-input__button--decrement` | `aria-label`         | Sets to `"Decrease"`.                                                                                                                                               |

## Similar Components

<Similar name="number-input" />

## Uses Components & Hooks

<Uses name="number-input" />
