...
:::tip
子要素を垂直方向または水平方向にスタックする場合は、[VStack](/docs/components/v-stack)または[HStack](/docs/components/h-stack)の使用を検討してください。
:::

:::tip
子要素を複数行に折り返す場合は、[Wrap](/docs/components/wrap)の使用を検討してください。
:::
