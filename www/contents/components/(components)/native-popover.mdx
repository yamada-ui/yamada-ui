...
:::note
`NativePopover` uses the HTML Popover API, which provides better performance and accessibility compared to the `Popover` component. However, it requires browser support for the Popover API.
:::
