...
:::tip
If you need to select color transparency, use the [AlphaSlider](/docs/components/alpha-slider).
:::

:::tip
If you need to select hue, use the [HueSlider](/docs/components/hue-slider).
:::
...
| ----------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-slider__thumb`        | `role="slider"`       | Indicates that this is a slider.                                                                                                                           |
...
| `div.ui-slider__mark`         | `aria-hidden`         | Excludes the element from the accessibility tree.                                                                                                          |
|                               | `role="presentation"` | Indicates that this is a presentation.                                                                                                                     |
| `div.ui-slider__root > input` | `aria-hidden`         | Excludes the element from the accessibility tree.                                                                                                          |
|                               | `aria-describedby`    | If this is within a `Field.Root` and `Field.Root` has an `errorMessage`, `helperMessage`, or a `Field.ErrorMessage`, `Field.HelperMessage`, sets its `id`. |
|                               | `aria-readonly`       | Set to `"true"` if `readOnly` is set.                                                                                                                      |
|                               | `aria-disabled`       | Set to `"true"` if `disabled` is set.                                                                                                                      |
|                               | `aria-invalid`        | Set to `"true"` if `invalid` is set.                                                                                                                       |
