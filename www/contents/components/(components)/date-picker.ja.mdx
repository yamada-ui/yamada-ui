...
tags: ["form-control", "date-time", "floating"]
...
:::tip
ページ上にカレンダーを常時表示して日付を閲覧または選択したい場合は、[Calendar](/docs/components/calendar)を使用してください。
:::
...
配置を変更するには、`placement`に`end`や`start-center`などを設定します。デフォルトでは、`end-start`が設定されています。
...
`DatePicker`は、アクセシビリティに関して[WAI-ARIA - Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/)に従います。

`Field.Root`を使用しない場合は、`DatePicker`に`aria-label`または`aria-labelledby`を設定します。
...
| キー                 | 説明                                                                                                                                                                       | 状態                |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| `Enter`              | 入力値が有効な場合は入力値を選択に反映します。カレンダー内である場合はフォーカスされた日付の選択状態を切り替えます。クリアボタンにフォーカスがある場合は値をクリアします。 | -                   |
...
| `Space`              | カレンダー内である場合はフォーカスされた日付の選択状態を切り替えます。クリアボタンにフォーカスがある場合は値をクリアします。                                               | -                   |

### ARIAロールと属性

| 要素                                                                | ロールと属性             | 使い方                                                                                                                                                                                       |
| ------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-date-picker__field`                                         | `role="combobox"`        | コンボボックスであることを示します。                                                                                                                                                         |
|                                                                     | `aria-controls`          | カレンダーが開いている場合は関連した`div.ui-date-picker__content`の`id`を設定し、閉じている場合は`undefined`を設定します。                                                                   |
...
| `div.ui-date-picker__content`                                       | `role="dialog"`          | ダイアログであることを示します。                                                                                                                                                             |
|                                                                     | `aria-hidden`            | カレンダーが開いている場合は`"false"`を設定し、閉じている場合は`"true"`を設定します。                                                                                                        |
| `div.ui-date-picker__icon`                                          | `role="button"`          | `clearable`かつ値がある場合はボタンであることを示します。                                                                                                                                    |
...
| `div.ui-calendar__select--years`                                    | `aria-label`             | `"年を選択する"`を設定します。                                                                                                                                                               |
| `div.ui-calendar__select--months`                                   | `aria-label`             | `"月を選択する"`を設定します。                                                                                                                                                               |
| `div.ui-calendar__control > div[role="status"][aria-live="polite"]` | `role="status"`          | ステータスであることを示します。                                                                                                                                                             |
|                                                                     | `aria-live="polite"`     | フォーカスの外側で更新される可能性があることを示します。                                                                                                                                     |
| `table.ui-calendar__month`                                          | `role="grid"`            | グリッドであることを示します。                                                                                                                                                               |
|                                                                     | `aria-label`             | `"2026年2月"`のように、表示されている年月を設定します。                                                                                                                                      |
|                                                                     | `aria-multiselectable`   | 複数選択または期間選択が可能な場合は`"true"`を設定します。                                                                                                                                   |
| `button.ui-calendar__button--prev`                                  | `aria-label`             | `"前の月に移動する"`を設定します。                                                                                                                                                           |
| `button.ui-calendar__button--next`                                  | `aria-label`             | `"次の月に移動する"`を設定します。                                                                                                                                                           |
| `td.ui-calendar__cell--day`                                         | `aria-label`             | `"2026年2月5日木曜日"`のように、日付を設定します。今日の場合は`"今日, 2026年2月5日木曜日"`を設定します。                                                                                     |
|                                                                     | `aria-disabled`          | 日付が無効の場合は`"true"`を設定します。                                                                                                                                                     |
|                                                                     | `aria-selected`          | 日付が選択されている場合は`"true"`を設定します。                                                                                                                                             |

## 類似のコンポーネント

<Similar name="date-picker" />

## 使用しているコンポーネント・フック

<Uses name="date-picker" />

## 使用されているコンポーネント・フック

<UsedBy name="date-picker" />
