...
::::card-group
:::card{href="/docs/get-started/frameworks/next-app" title="Next.js (App)"}

A guide for installing and using Yamada UI with Next.js app directory.

:::
:::card{href="/docs/get-started/frameworks/next-pages" title="Next.js (Pages)"}

A guide for installing and using Yamada UI with Next.js pages directory.

:::
:::card{href="/docs/get-started/frameworks/vite" title="Vite"}

A guide for installing and using Yamada UI with Vite.js projects.

:::
:::card{href="/docs/get-started/frameworks/react-router" title="React Router"}
