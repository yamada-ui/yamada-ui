...
export const standardStyles: StyleConfigs = {
  ...
  borderBottomLeftRadius: {
    ...
    token: "radii",
    transform: pipe(transforms.token("radii"), transforms.px),
  },
  ...
  bottom: {
    properties: "bottom",
    token: "spaces",
    transform: pipe(transforms.token("spaces"), transforms.px),
  },
  boxAlign: true,
  ...
  fontSize: {
    properties: "fontSize",
    token: "fontSizes",
    transform: pipe(transforms.token("fontSizes"), transforms.px),
  },
  fontSizeAdjust: true,
  fontSmooth: true,
  fontStretch: true,
