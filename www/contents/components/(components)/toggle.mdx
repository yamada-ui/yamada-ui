...
| ---------------------------- | ------------------- | ----------------------------------------------------- |
| `ToggleGroup.Root`           | `role="group"`      | Indicates the collection of related toggles.          |
| `Toggle`, `ToggleGroup.Item` | `aria-pressed`      | `true` when the toggle is on, `false` when it is off. |
