...
:::tip
Yamada UI provides a [`Drawer`](/docs/components/drawer) component for grouping and displaying related information. Please consider using [`Drawer`](/docs/components/drawer) first, and use `Slide` only if you need styling that cannot be achieved with `Drawer`.
:::
