...
}`,...(Yr=(Xr=he.parameters)==null?void 0:Xr.docs)==null?void 0:Yr.source}}};var Qr,Gr,Jr;pe.parameters={...pe.parameters,docs:{...(Qr=pe.parameters)==null?void 0:Qr.docs,source:{originalSource:`() => {
  const [value, onChange] = useState<number>(50);
...
}`,...(Jr=(Gr=pe.parameters)==null?void 0:Gr.docs)==null?void 0:Jr.source}}};var Zr,en,rn;Se.parameters={...Se.parameters,docs:{...(Zr=Se.parameters)==null?void 0:Zr.docs,source:{originalSource:`() => {
  type Data = {
    slider: number;
  };
...
}`,...(rn=(en=Se.parameters)==null?void 0:en.docs)==null?void 0:rn.source}}};const Ut=["basic","withDefaultValue","withSize","withColorScheme","withOrientation","withReversed","withMinMax","withStep","withFocusThumbOnChange","withMark","withTooltip","isDisabled","isReadonly","isInvalid","customColor","customThumb","customMark","customControl","onChangeStart","onChangeEnd","reactHookForm"];export{Ut as __namedExportsOrder,Y as basic,ue as customColor,me as customControl,de as customMark,ce as customThumb,Kt as default,le as isDisabled,ie as isInvalid,se as isReadonly,pe as onChangeEnd,he as onChangeStart,Se as reactHookForm,J as withColorScheme,Q as withDefaultValue,te as withFocusThumbOnChange,ae as withMark,re as withMinMax,Z as withOrientation,ee as withReversed,G as withSize,ne as withStep,oe as withTooltip};
