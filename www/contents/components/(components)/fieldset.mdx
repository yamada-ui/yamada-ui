...
| ---------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `fieldset.ui-fieldset__root`       | `aria-labelledby`    | Labels the `fieldset` group by referencing the `id` shared with `Fieldset.Legend`, combined with the `aria-labelledby` prop. |
| `span.ui-fieldset__helper-message` | `aria-describedby`   | Sets the `id` of the associated `Fieldset.Legend`.                                                                           |
| `span.ui-fieldset__error-message`  | `aria-live="polite"` | Indicates that it may be updated outside of focus if `invalid` is set.                                                       |
