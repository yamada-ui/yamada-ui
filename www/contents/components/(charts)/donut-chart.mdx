...
| ------------ | --------------------------------------------------------- | -------------------- |
| `ArrowRight` | Selects the next data point and displays the tooltip.     | `withTooltip={true}` |
| `ArrowLeft`  | Selects the previous data point and displays the tooltip. | `withTooltip={true}` |
| `Enter`      | Toggles the tooltip display for the selected data point.  | `withTooltip={true}` |

Keyboard focus remains on the chart surface while the active data point changes.

### ARIA Roles and Attributes

| Component | Role and Attribute                | Usage                                                   |
| --------- | --------------------------------- | ------------------------------------------------------- |
| `svg`     | `role="application"` `tabIndex=0` | Makes the chart surface focusable for keyboard control. |
