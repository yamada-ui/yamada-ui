...
:::tip
If you want a calendar that stays visible on the page for viewing or selection, use [Calendar](/docs/components/calendar).
:::
...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| `Enter`              | When the input value is valid, applies it to the selection. Toggles the focused date if focus is in the calendar. Clears the value if focus is on the clear button. | -                   |
...
| `Space`              | Toggles the selection state of the focused date if focus is in the calendar. Clears the value if focus is on the clear button.                                      | -                   |

### ARIA Roles and Attributes

| Element                                                             | Roles and Attributes     | Usage                                                                                                                                                                      |
| ------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-date-picker__field`                                         | `role="combobox"`        | Indicates that it is a combobox.                                                                                                                                           |
|                                                                     | `aria-controls`          | When the calendar is open, sets the `id` of the associated `div.ui-date-picker__content`. When closed, sets `undefined`.                                                   |
...
| `div.ui-date-picker__content`                                       | `role="dialog"`          | Indicates that it is a dialog.                                                                                                                                             |
|                                                                     | `aria-hidden`            | When the calendar is open, sets to `"false"`. When closed, sets to `"true"`.                                                                                               |
| `div.ui-date-picker__icon`                                          | `role="button"`          | Indicates that it is a button when `clearable` and there is a value.                                                                                                       |
...
| `div.ui-calendar__select--years`                                    | `aria-label`             | Sets `"Choose the year"`.                                                                                                                                                  |
| `div.ui-calendar__select--months`                                   | `aria-label`             | Sets `"Choose the month"`.                                                                                                                                                 |
| `div.ui-calendar__control > div[role="status"][aria-live="polite"]` | `role="status"`          | Indicates that it is a status.                                                                                                                                             |
|                                                                     | `aria-live="polite"`     | Indicates that it may be updated outside of focus.                                                                                                                         |
| `table.ui-calendar__month`                                          | `role="grid"`            | Indicates that it is a grid.                                                                                                                                               |
...
| `button.ui-calendar__button--prev`                                  | `aria-label`             | Sets `"Go to the previous month"`.                                                                                                                                         |
| `button.ui-calendar__button--next`                                  | `aria-label`             | Sets `"Go to the next month"`.                                                                                                                                             |
| `td.ui-calendar__cell--day`                                         | `aria-label`             | Sets the date, like `"Thursday, February 5, 2026"`. If today, sets `"Today, Thursday, February 5, 2026"`.                                                                  |
