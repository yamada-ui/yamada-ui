...
<PropsCard
  ...
  name="color"
  type='UIValue<"border" | "link" | "primary" | "secondary" | "info" | "success" | "warning" | "danger" | Color | "current" | "focus" | "whiteAlpha.50" | "whiteAlpha.100" | "whiteAlpha.200" | ... 315 more ... | "link.950">'
