...
| --------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `div.ui-color-swatch__root` | `role="img"`                          | Indicates that this is an image.                                                                                                                       |
|                             | `aria-roledescription="color swatch"` | Sets to `"color swatch"`.                                                                                                                              |
|                             | `aria-label`                          | Sets to the `color` value when `color` is a string; when used by `ColorSwatchGroup`, it uses the localized `colorSwatch` `"Color swatch group"` label. |
