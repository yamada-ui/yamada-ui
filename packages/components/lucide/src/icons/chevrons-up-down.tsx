...
import { ChevronsUpDown as OriginalChevronsUpDown } from "lucide-react"
 ...
 */
export const ChevronsUpDownIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalChevronsUpDown} {...props} />
))
