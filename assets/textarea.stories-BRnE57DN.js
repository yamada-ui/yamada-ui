import{j as e}from"./extends-CwFRzn3r.js";import{r as I}from"./index-BwDkhjyp.js";import{u as je}from"./index.esm-DXPXqkjk.js";import{V as Ve,u as Me,f as _e,e as Oe,b as We,a as Ee,c as qe,h as Pe,a0 as Ae,P as Le}from"./factory-BgMvz7NM.js";import{u as Ne,F as m}from"./form-control-DAXawruh.js";import{a as _}from"./event-wx3HPSqP.js";import{f as Ye}from"./forward-ref-BWI-Phbn.js";import{u as Ge}from"./use-component-style-D3MffxdG.js";import{o as Ue}from"./theme-provider-Bpmh2ODM.js";import{V as B}from"./stack-c0WUIOCC.js";import{B as H}from"./button-knJHP-Ba.js";import"./_commonjsHelpers-BosuxZz1.js";import"./use-ripple-BWg06y-U.js";import"./factory-yZQlYpPU.js";import"./motion-I-9Hg3gW.js";import"./loading-B_aB2PJP.js";import"./icon-CvhI1IwG.js";import"./use-var-Dgk44aKJ.js";const Xe=(o,s,t)=>{const l=I.useRef();return()=>{const a=o.current;if(!a)return;let{value:n,placeholder:d}=a;if(n===l.current)return;l.current=n,n??(n=d??"x");const u=Je(a);if(!u)return;const F=Ke(a,u,n,s,t);a.rows=F}},Ze=["borderBottomWidth","borderLeftWidth","borderRightWidth","borderTopWidth","boxSizing","fontFamily","fontSize","fontStyle","fontWeight","letterSpacing","lineHeight","paddingBottom","paddingLeft","paddingRight","paddingTop","tabSize","textIndent","textRendering","textTransform","width","wordBreak"],Je=o=>{const s=window==null?void 0:window.getComputedStyle(o);if(s==null)return null;const t=Ve(s,Ze),{boxSizing:l}=t;if(l==="")return null;const i=parseFloat(t.paddingBottom)+parseFloat(t.paddingTop),a=parseFloat(t.borderBottomWidth)+parseFloat(t.borderTopWidth),n=parseFloat(t.lineHeight);return{sizingStyle:t,paddingSize:i,borderSize:a,singleRowHeight:n}},Ke=(o,s,t,l,i)=>{const a=o.cloneNode();Object.assign(a.style,s.sizingStyle),Qe(a),a.value=t,document.body.appendChild(a);let n;if(a.scrollHeight){const d=s.singleRowHeight;n=Math.min(l,Math.max(i,Math.floor(a.scrollHeight/d)))}else{const d=(t.match(/\n/g)||[]).length;n=Math.min(l,Math.max(i,d+1))}return document.body.removeChild(a),n},O={"min-height":"0","max-height":"none",height:"0",visibility:"hidden",overflow:"hidden",position:"absolute","z-index":"-1000",top:"0",right:"0"},Qe=o=>{Object.keys(O).forEach(s=>{o.style.setProperty(s,O[s],"important")})},r=Ye((o,s)=>{var M;const[{h:t,height:l,minH:i,minHeight:a,maxH:n,maxHeight:d,...u},F]=Ge("Textarea",o);let{className:Te,rows:V,resize:we="none",autosize:h,maxRows:ke=1/0,minRows:Fe=1,resizeRef:Re,onChange:Ce,...R}=Ue(F);R=Ne(R);const De=Le(),C=I.useRef(null),Ie=((M=C.current)==null?void 0:M.value)??"",c=Xe(C,ke,Fe);let D;return V||h?D=u:D={h:t,height:l,minH:i,minHeight:a,maxH:n,maxHeight:d,...u},Me(()=>{if(!De||!h)return;c();const Be=_(window,"resize",c),He=_(document.fonts,"loadingdone",c);return()=>{Be(),He()}},[]),_e(()=>{h&&c()},[Ie]),Oe(Re,c),e.jsx(We.textarea,{ref:Ee(s,C),className:qe("ui-textarea",Te),__css:D,resize:we,rows:V,onChange:Pe(h?c:Ae,Ce),...R})});r.displayName="Textarea";r.__ui__="Textarea";const gr={title:"Components / Forms / Textarea",component:r},p=()=>e.jsx(r,{placeholder:"basic"}),x=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{placeholder:"extra small size",size:"xs"}),e.jsx(r,{placeholder:"small size",size:"sm"}),e.jsx(r,{placeholder:"medium size",size:"md"}),e.jsx(r,{placeholder:"large size",size:"lg"})]}),f=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{variant:"outline",placeholder:"outline"}),e.jsx(r,{variant:"filled",placeholder:"filled"}),e.jsx(r,{variant:"flushed",placeholder:"flushed"}),e.jsx(r,{variant:"unstyled",placeholder:"unstyled"})]}),g=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{resize:"block",placeholder:"block"}),e.jsx(r,{resize:"horizontal",placeholder:"horizontal"}),e.jsx(r,{resize:"vertical",placeholder:"vertical"}),e.jsx(r,{resize:"none",placeholder:"none"})]}),b=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{autosize:!0,placeholder:"autosize"}),e.jsx(r,{autosize:!0,minRows:4,placeholder:"autosize, min rows 4"}),e.jsx(r,{autosize:!0,maxRows:4,placeholder:"autosize, max rows 4"}),e.jsx(r,{rows:4,placeholder:"rows 4"})]}),z=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{placeholder:"default border color"}),e.jsx(r,{focusBorderColor:"green.500",placeholder:"custom border color"}),e.jsx(r,{isInvalid:!0,errorBorderColor:"orange.500",placeholder:"custom border color"})]}),v=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{isDisabled:!0,variant:"outline",placeholder:"outline"}),e.jsx(r,{isDisabled:!0,variant:"filled",placeholder:"filled"}),e.jsx(r,{isDisabled:!0,variant:"flushed",placeholder:"flushed"}),e.jsx(r,{isDisabled:!0,variant:"unstyled",placeholder:"unstyled"}),e.jsx(m,{isDisabled:!0,label:"Feedback",helperMessage:"We would like to get your feedback.",children:e.jsx(r,{variant:"outline",placeholder:"your feedback"})})]}),S=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{isReadOnly:!0,variant:"outline",placeholder:"outline"}),e.jsx(r,{isReadOnly:!0,variant:"filled",placeholder:"filled"}),e.jsx(r,{isReadOnly:!0,variant:"flushed",placeholder:"flushed"}),e.jsx(r,{isReadOnly:!0,variant:"unstyled",placeholder:"unstyled"}),e.jsx(m,{isReadOnly:!0,label:"Feedback",helperMessage:"We would like to get your feedback.",children:e.jsx(r,{variant:"outline",placeholder:"your feedback"})})]}),y=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{isInvalid:!0,variant:"outline",placeholder:"outline"}),e.jsx(r,{isInvalid:!0,variant:"filled",placeholder:"filled"}),e.jsx(r,{isInvalid:!0,variant:"flushed",placeholder:"flushed"}),e.jsx(r,{isInvalid:!0,variant:"unstyled",placeholder:"unstyled"}),e.jsx(m,{isInvalid:!0,label:"Feedback",errorMessage:"Feedback is required.",children:e.jsx(r,{variant:"outline",placeholder:"your feedback"})})]}),j=()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{placeholder:"default placeholder"}),e.jsx(r,{placeholder:"custom placeholder",_placeholder:{opacity:1,color:"gray.500"}}),e.jsx(r,{color:"green.500",placeholder:"custom placeholder",_placeholder:{color:"inherit"}})]}),T=()=>{const o=I.useRef(null),s=()=>{var t;(t=o.current)==null||t.call(o)};return e.jsx(e.Fragment,{children:e.jsxs(B,{children:[e.jsx(r,{placeholder:"use resize",resizeRef:o}),e.jsx(H,{alignSelf:"flex-end",onClick:s,children:"Resize"})]})})},w=()=>{var a;const{register:o,handleSubmit:s,watch:t,formState:{errors:l}}=je(),i=n=>console.log("submit:",n);return console.log("watch:",t()),e.jsxs(B,{as:"form",onSubmit:s(i),children:[e.jsx(m,{isInvalid:!!l.textarea,label:"Feedback",errorMessage:(a=l.textarea)==null?void 0:a.message,children:e.jsx(r,{placeholder:"your feedback",...o("textarea",{required:{value:!0,message:"This is required."}})})}),e.jsx(H,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},k=()=>{var n;const o={textarea:"孫悟空"},{register:s,handleSubmit:t,watch:l,formState:{errors:i}}=je({defaultValues:o}),a=d=>console.log("submit:",d);return console.log("watch:",l()),e.jsxs(B,{as:"form",onSubmit:t(a),children:[e.jsx(m,{isInvalid:!!i.textarea,label:"Feedback",errorMessage:(n=i.textarea)==null?void 0:n.message,children:e.jsx(r,{placeholder:"your feedback",...s("textarea",{required:{value:!0,message:"This is required."}})})}),e.jsx(H,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var W,E,q;p.parameters={...p.parameters,docs:{...(W=p.parameters)==null?void 0:W.docs,source:{originalSource:`() => {
  return <Textarea placeholder="basic"></Textarea>;
}`,...(q=(E=p.parameters)==null?void 0:E.docs)==null?void 0:q.source}}};var P,A,L;x.parameters={...x.parameters,docs:{...(P=x.parameters)==null?void 0:P.docs,source:{originalSource:`() => {
  return <>
...
}`,...(L=(A=x.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var N,Y,G;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`() => {
  return <>
...
}`,...(ye=(Se=k.parameters)==null?void 0:Se.docs)==null?void 0:ye.source}}};const br=["basic","withSize","withVariant","withResize","withAutosize","withBorderColor","isDisabled","isReadonly","isInvalid","stylingPlaceholder","useResize","reactHookForm","reactHookFormWithDefaultValue"];export{br as __namedExportsOrder,p as basic,gr as default,v as isDisabled,y as isInvalid,S as isReadonly,w as reactHookForm,k as reactHookFormWithDefaultValue,j as stylingPlaceholder,T as useResize,b as withAutosize,z as withBorderColor,g as withResize,x as withSize,f as withVariant};
