export const CORE_MEMBERS = [
  ...
  {
    id: "KenyaMasuko",
    name: { en: "Kenya Masuko", ja: "Kenya Masuko" },
    icon: "https://avatars.githubusercontent.com/u/85816730?v=4",
    github: "https://github.com/KenyaMasuko",
    twitter: "https://twitter.com/kenchan_dayoooo",
    description: {
      en: "A development team member at Yamada Components, working as a software engineer.",
      ja: "Yamada Componentsの開発メンバー。ソフトウェアエンジニア。",
    },
  },
  {
    id: "setodeve",
