...
:::note status=warning
Many pages, such as [Learn the Basics](/getting-started/installation/basic) and [Learn the Advanced](/getting-started/installation/advanced), assume that you have installed everything from [All](/getting-started/installation).
:::
