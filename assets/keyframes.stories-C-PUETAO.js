import{j as n,V as o,Y as r,T as a,ct as s}from"./iframe-CJki5Sg_.js";import{H as m}from"./heading-C0WJmmU4.js";import{F as l}from"./for-fZsdBYfN.js";import{B as d}from"./box-Bo23cHRp.js";import{C as p,b as g}from"./container-k0HWDU-2.js";import"./preload-helper-PPVm8Dsz.js";const C={title:"Theme / Tokens"},i=()=>n.jsxs(n.Fragment,{children:[n.jsx(m,{children:"Keyframes"}),n.jsx(p,{children:n.jsx(g,{alignItems:"center",display:"grid",gap:"lg",gridTemplateColumns:"repeat(auto-fill, minmax({sizes.4xs}, 1fr))",children:n.jsx(l,{each:Object.entries(s),children:([e],t)=>n.jsxs(o,{alignItems:"center",gap:"sm",children:[n.jsx(r,{aspectRatio:1,bg:"bg",borderColor:"border.subtle",borderWidth:"1px",boxSize:"full",flexDirection:"column",overflow:"hidden",position:"relative",rounded:"l2",children:n.jsx(d,{css:{"--animation-from-x":"25%","--animation-from-y":"25%","--animation-height":"{sizes.12}","--animation-to-x":"50%","--animation-to-y":"50%","--animation-width":"{sizes.12}","--stripe-color":["rgba(255, 255, 255, 0.3)","rgba(0, 0, 0, 0.3)"]},animationDirection:e==="bg-position"?"normal":"alternate",animationDuration:"1s",animationIterationCount:"infinite",animationName:e,animationTimingFunction:e==="bg-position"?"linear":"ease-in-out",bg:"green",bgImage:e==="bg-position"?`linear-gradient(
                      45deg,
                      {stripe-color} 25%,
                      transparent 25%,
                      transparent 50%,
                      ...
                      transparent 75%,
                      transparent
                    )`:void 0,bgSize:"1rem 1rem",boxSize:"12",position:"absolute",rounded:"l2"})}),n.jsx(a,{lineClamp:1,children:e})]},t)})})})]});i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => {
  return <>
