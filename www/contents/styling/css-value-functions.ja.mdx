...
また、[テーマ](/docs/theming)の[spaces](/docs/theming/tokens/spaces)のトークンのように数値がトークン名の場合は、`{}`([インターポレーション](/docs/styling/interpolation))を使用して参照します。
...
[色のトークン](/docs/theming/tokens/colors)や[CSSの色の値](https://developer.mozilla.org/ja/Web/CSS/color)の両方を使用できます。
...
:::warning
[デフォルトのテーマ](/docs/theming/tokens/gradients)には、グラデーションのトークンは定義されていません。グラデーションのトークンを使用する場合は、テーマの[カスタマイズ](/docs/theming/customization)をご覧ください。
:::
...
:::note
レスポンシブスタイルをもっと学びたい場合は、[こちら](/docs/styling/responsive-design)をご覧ください。
:::
