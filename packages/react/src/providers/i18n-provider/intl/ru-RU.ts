...
const data: IntlData = {
  actionBar: {
    "Close action bar": "Закрыть панель действий",
    "Open action bar": "Открыть панель действий",
  },
  autocomplete: {
  ...
  calendar: {
    "Choose the month": "Выберите месяц",
    "Choose the year": "Выберите год",
    "Go to the next month": "Перейти к следующему месяцу",
    "Go to the previous month": "Перейти к предыдущему месяцу",
    Today: "Сегодня",
  },
  carousel: {
    "Go to next slide": "Перейти к следующему слайду",
    "Go to previous slide": "Перейти к предыдущему слайду",
    "Go to {page} slide": "Перейти к слайду {page}",
    Slides: "Слайды",
    "{page} of {total}": "{page} из {total}",
  },
  closeButton: {
    Close: "Закрыть",
  },
  ...
  colorSwatch: {
    "Color swatch group": "Группа образцов цветов",
  },
  datePicker: {
    "Clear value": "Очистить значение",
  },
  ...
  modal: {
    ...
    "Open modal": "Открыть модальное окно",
  },
  numberInput: {
    Decrease: "Уменьшить",
    Increase: "Увеличить",
  ...
  pagination: {
    ...
    "Go to page {value}": "Перейти на страницу {value}",
    "Go to previous page": "Перейти на предыдущую страницу",
    Pagination: "Пагинация",
    "{value} / {total}": "{value} / {total}",
    "{value} of {total}": "{value} из {total}",
  },
  passwordInput: {
    "Password strength meter": "Индикатор силы пароля",
    "Toggle password visibility": "Переключить видимость пароля",
  },
  progress: {
    "Loading...": "Загрузка...",
    "{value} percent": "{value} процентов",
  },
  saturationSlider: {
    "Saturation and brightness thumb": "Слайдер насыщенности и яркости",
  ...
  stat: {
    "Decreased by": "Уменьшено на",
    "Increased by": "Увеличено на",
  },
  table: {
