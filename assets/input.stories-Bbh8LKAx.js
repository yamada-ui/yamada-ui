...
}`,...(Ie=(ge=F.parameters)==null?void 0:ge.docs)==null?void 0:Ie.source}}};var xe,je,fe;C.parameters={...C.parameters,docs:{...(xe=C.parameters)==null?void 0:xe.docs,source:{originalSource:`() => {
  interface Data {
    name: string;
    cellphone: string;
    email: string;
...
}`,...(fe=(je=C.parameters)==null?void 0:je.docs)==null?void 0:fe.source}}};const Ze=["basic","withSize","withVariant","withHTMLSize","withBorderColor","isDisabled","isReadonly","isInvalid","useAddon","useElement","stylingPlaceholder","customType","reactHookForm","reactHookFormWithDefaultValue"];export{Ze as __namedExportsOrder,c as basic,S as customType,Ye as default,x as isDisabled,f as isInvalid,j as isReadonly,F as reactHookForm,C as reactHookFormWithDefaultValue,v as stylingPlaceholder,y as useAddon,b as useElement,I as withBorderColor,g as withHTMLSize,m as withSize,h as withVariant};
