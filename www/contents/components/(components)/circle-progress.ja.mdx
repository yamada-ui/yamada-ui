...
`CircleProgress`は、アクセシビリティに関して[WAI-ARIA - Meter Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/meter/)に従います。

`CircleProgress.Root`に`aria-label`または`aria-labelledby`を設定すると、スクリーンリーダーによって読み上げられます。
