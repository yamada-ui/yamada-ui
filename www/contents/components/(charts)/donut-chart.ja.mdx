...
| キー         | 説明                                                           | 状態                 |
| ------------ | -------------------------------------------------------------- | -------------------- |
| `ArrowRight` | 次のデータポイントを選択し、ツールチップを表示します。         | `withTooltip={true}` |
| `ArrowLeft`  | 前のデータポイントを選択し、ツールチップを表示します。         | `withTooltip={true}` |
| `Enter`      | 選択しているデータポイントのツールチップの表示を切り替えます。 | `withTooltip={true}` |

キーボードフォーカスはチャート面に留まり、アクティブなデータポイントが変わります。

### ARIAロールと属性

| コンポーネント | ロールと属性                      | 使い方                                                     |
| -------------- | --------------------------------- | ---------------------------------------------------------- |
| `svg`          | `role="application"` `tabIndex=0` | キーボード操作のためにチャート面をフォーカス可能にします。 |
