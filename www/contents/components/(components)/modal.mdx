...
| `Modal.OpenTrigger`  | `aria-haspopup`            | Sets to `"dialog"`.                                                   |
...
|                      | `aria-label="Open modal"`  | Sets to `"Open modal"`.                                               |
| `Modal.CloseButton`  | `aria-label="Close modal"` | Sets to `"Close modal"`.                                              |
| `Modal.CloseTrigger` | `aria-label="Close modal"` | Sets to `"Close modal"`.                                              |
