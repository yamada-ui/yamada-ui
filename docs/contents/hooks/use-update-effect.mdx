...
description: '`useUpdateEffect` is a custom hook that skips side effects on the initial render, and only runs side effects when the dependency array changes.'
