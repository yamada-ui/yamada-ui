...
}`,...(De=(Le=V.parameters)==null?void 0:Le.docs)==null?void 0:De.source}}};var _e,Fe,Be;W.parameters={...W.parameters,docs:{...(_e=W.parameters)==null?void 0:_e.docs,source:{originalSource:`() => {
  const Panel: FC = () => {
    const [state, setState] = useState<number>(1);
    useInterval(() => setState(prev => prev + 1), 1000);
    return <>Panel {state}</>;
...
}`,...(Be=(Fe=W.parameters)==null?void 0:Fe.docs)==null?void 0:Be.source}}};var Ae,He,Ke;$.parameters={...$.parameters,docs:{...(Ae=$.parameters)==null?void 0:Ae.docs,source:{originalSource:`() => {
...
}`,...(Ke=(He=$.parameters)==null?void 0:He.docs)==null?void 0:Ke.source}}};var Ve,We,$e;N.parameters={...N.parameters,docs:{...(Ve=N.parameters)==null?void 0:Ve.docs,source:{originalSource:`() => {
  const [index, setIndex] = useState(0);
  const items = useMemo<Tabs.Item[]>(() => [{
    panel: "クリリンのことか……クリリンのことかーーーっ！！！！！",
    tab: "孫悟空"
...
}`,...($e=(We=N.parameters)==null?void 0:We.docs)==null?void 0:$e.source}}};const $n=["Basic","Items","Variant","Size","DefaultIndex","Orientation","Align","Fitted","Disabled","Manual","Link","Lazy","LazyBehavior","Dynamic","CustomControl"];export{F as Align,M as Basic,N as CustomControl,D as DefaultIndex,A as Disabled,$ as Dynamic,B as Fitted,S as Items,V as Lazy,W as LazyBehavior,K as Link,H as Manual,_ as Orientation,L as Size,w as Variant,$n as __namedExportsOrder,Wn as default};
