import{aB as c,j as p}from"./iframe-B_LcDk8j.js";import{u as e}from"./index-B3LE8AFU.js";import{B as u}from"./box-cPDQ3xhy.js";import{u as d}from"./use-breakpoint-DLQz16Te.js";import"./preload-helper-C1FmrZbK.js";import"./use-breakpoint-value-BN7biuR1.js";import"./use-color-mode-value-D9RYeCtv.js";const M={title:"Hooks / useValue"},o=()=>{const{colorMode:s}=c(),a=d(),l=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),i=e(["whiteAlpha.800","blackAlpha.800"]);return p.jsxs(u,{bg:l,color:i,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',a,'", colorMode is "',s,'"']})};var r,t,n;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
