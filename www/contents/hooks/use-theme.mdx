...
:::note
For more information, see the [theming documentation](/docs/theming).
:::
...
:::warning
In order to switch themes, you need to prepare multiple themes. For more details, see the [switching themes documentation](/docs/theming/switching-themes).
:::
