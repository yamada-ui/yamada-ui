...
| --------------------------- | -------------------- | ---------------------------------------------------------------------------------------------- |
| `div.ui-resizable__item`    | `id`                 | Used to associate with `div.ui-resizable__trigger`.                                            |
| `div.ui-resizable__trigger` | `role="separator"`   | Indicates that this is a separator.                                                            |
|                             | `aria-controls`      | Sets the `id` of the associated `div.ui-resizable__item`.                                      |
|                             | `aria-orientation`   | Sets the same value as `orientation`.                                                          |
...
|                             | `aria-disabled`      | Sets to `"true"` when `disabled` is enabled on either `Resizable.Root` or `Resizable.Trigger`. |
