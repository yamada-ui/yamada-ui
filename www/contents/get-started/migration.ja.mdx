...
:::note
ソースコードをダウンロードしてカスタマイズしても、[CLI](/docs/components/cli)の[差分を確認する](/docs/components/cli#check-differences)や[コンポーネントを更新する](/docs/components/cli#update-components)を行うことで、ソースコードを簡単に更新することができます。もし、あなたの修正と競合しても[Git](https://git-scm.com)の[競合の提示方法](https://git-scm.com/docs/git-merge#_how_conflicts_are_presented)と同じように表示され、簡単に解決することができます。
:::
...
- [コンフィグ](/docs/theming/configuration/overview)を定義する場合は、`defineConfig`を使用してください。
...
[Format.Datetime](/docs/components/format#dates)を追加しました。
...
[Dialog](https://v1.yamada-ui.com/ja/components/overlay/dialog)を削除しました。代わりに、[Modal](/docs/components/modal#use-props)を使用してください。

### ContextMenu

[ContextMenu](https://v1.yamada-ui.com/ja/components/navigation/context-menu)を削除しました。代わりに、[Menu.ContextTrigger](/docs/components/menu#use-context-menu)を使用してください。
...
[MultiAutocomplete](https://v1.yamada-ui.com/ja/components/forms/multi-autocomplete)を削除しました。代わりに、[Autocomplete](/docs/components/autocomplete#enable-multiple-selection)の`multiple`を使用してください。

### MultiDatePicker

[MultiDatePicker](https://v1.yamada-ui.com/ja/components/forms/multi-date-picker)を削除しました。代わりに、[DatePicker](/docs/components/date-picker#enable-multiple-selection)の`multiple`を使用してください。

### RangeDatePicker

[RangeDatePicker](https://v1.yamada-ui.com/ja/components/forms/range-date-picker)を削除しました。代わりに、[DatePicker](/docs/components/date-picker#enable-range-selection)の`range`を使用してください。

### MultiSelect

[MultiSelect](https://v1.yamada-ui.com/ja/components/forms/multi-select)を削除しました。代わりに、[Select](/docs/components/select#enable-multiple-selection)の`multiple`を使用してください。
...
[RangeSlider](https://v1.yamada-ui.com/ja/components/forms/range-slider)を削除しました。代わりに、[Slider](/docs/components/slider#enable-range-selection)の`value`または`defaultValue`に配列を設定してください。
...
[PagingTable](https://v1.yamada-ui.com/ja/components/data-display/paging-table)を削除しました。代わりに、[Table](/docs/components/table#enable-pagination)の`enablePagination`を使用してください。
