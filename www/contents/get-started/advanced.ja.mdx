...
:::note
詳しくは[テーマ](/docs/theming)を参照してください。
:::
...
:::note
詳しくは[レイヤースタイル](/docs/styling/layer-styles)を参照してください。
:::
...
:::note
詳しくは[テキストスタイル](/docs/styling/text-styles)を参照してください。
:::
...
:::note
詳しくは[アニメーション](/docs/styling/animation)を参照してください。
:::
...
:::note
詳しくは[Motion](/docs/components/motion)を参照してください。
:::
