import{g as U,r as f,a1 as V,n as W,v as _,s as Z,L as J,O as K,ce as Q,a3 as X,b8 as ee,j as e,V as A,B as M,t as P,C as re}from"./iframe-Gd2wA5UH.js";import{u as q}from"./index.esm-DjpKUs6E.js";import{i as c,c as oe,a as ae,u as ne}from"./input-Br3BRLxR.js";import{a as D}from"./event-DnNdx6hE.js";import{u as te,F as g}from"./use-field-props-D4qWu9wV.js";import{u as se}from"./use-input-border-pIvjYctk.js";import{F as u}from"./for-C62laByO.js";import{M as L}from"./mail-icon-BUyE-g46.js";import{P as Y}from"./props-table-hQP5Z1dz.js";import{I as m,b as x,a as N}from"./input-group-Bit_JPDh.js";import"./preload-helper-PPVm8Dsz.js";import"./grid-CakiebxH.js";import"./grid-item-Dj5TeVSg.js";import"./flex-mFnSfPNF.js";import"./heading-CalVy3eO.js";import"./group-C7J6mywu.js";import"./index-B69f71zK.js";import"./use-breakpoint-_TvgYbTn.js";import"./use-breakpoint-value-M3SNOELf.js";import"./use-color-mode-value-BkyTpO3Y.js";const le=U({base:{...c.base,resize:"vertical"},variants:{filled:c.variants?.filled,flushed:c.variants?.flushed,outline:c.variants?.outline,plain:c.variants?.plain},sizes:{xs:{...c.sizes?.xs,py:"{--space-y}"},sm:{...c.sizes?.sm,py:"{--space-y}"},md:{...c.sizes?.md,py:"{--space-y}"},lg:{...c.sizes?.lg,py:"{--space-y}"},xl:{...c.sizes?.xl,py:"{--space-y}"},"2xl":{...c.sizes?.["2xl"],py:"{--space-y}"}},compounds:[{css:{...ae(),...oe()},variant:"flushed",layer:"variant"}],defaultProps:{size:"md",variant:"outline"}}),ie=["borderBottomWidth","borderLeftWidth","borderRightWidth","borderTopWidth","boxSizing","fontFamily","fontSize","fontStyle","fontWeight","letterSpacing","lineHeight","paddingBottom","paddingLeft","paddingRight","paddingTop","tabSize","textIndent","textRendering","textTransform","width","wordBreak"],H={height:"0","max-height":"none","min-height":"0",overflow:"hidden",position:"absolute",right:"0",top:"0",visibility:"hidden","z-index":"-1000"},de=r=>{const o=window.getComputedStyle(r);if(o==null)return null;const n=Q(o,ie);if(n.boxSizing==="")return null;const t=parseFloat(n.paddingBottom)+parseFloat(n.paddingTop),s=parseFloat(n.borderBottomWidth)+parseFloat(n.borderTopWidth),l=parseFloat(n.lineHeight);return{style:n,border:s,padding:t,rowHeight:l}},ce=r=>{Object.keys(H).forEach(o=>{r.style.setProperty(o,H[o],"important")})},ue=(r,o,n,t,s)=>{const l=r.cloneNode();Object.assign(l.style,o.style),ce(l),l.value=n,document.body.appendChild(l);let i;if(l.scrollHeight){const p=o.rowHeight;i=Math.min(t,Math.max(s,Math.floor(l.scrollHeight/p)))}else{const p=(n.match(/\n/g)||[]).length;i=Math.min(t,Math.max(s,p+1))}return document.body.removeChild(l),i},pe=({disabled:r=!1,maxRows:o=1/0,minRows:n=2}={})=>{const t=f.useRef(null),s=f.useRef(null),l=t.current?.value??"",i=f.useCallback(()=>{const d=t.current;if(!d)return;let{placeholder:h,value:b}=d;if(b===s.current)return;s.current=b,b||=h||"x";const O=de(d);if(!O)return;const $=ue(d,O,b,o,n);d.rows=$},[t,o,n]),p=f.useCallback((d={})=>({...d,ref:_(d.ref,t),style:{resize:r?void 0:"none",...d.style},onChange:V(d.onChange,r?W:i)}),[t,i,r]);return Z(()=>{if(!J()||r)return;i();const d=D(window,"resize",i),h=D(document.fonts,"loadingdone",i);return()=>{d(),h()}},[]),K(()=>{r||i()},[l]),{ref:t,getTextareaProps:p,onResizeTextarea:i}},me=({autosize:r,maxRows:o,minRows:n,resizeRef:t,...s}={})=>{const{ref:l,onResizeTextarea:i}=pe({disabled:!r,maxRows:o,minRows:n});return X(t,i),{getTextareaProps:f.useCallback(({style:d,...h}={})=>({...s,...h,ref:_(h.ref,s.ref,l),style:{resize:r?"none":void 0,...s.style,...d},onChange:V(h.onChange,s.onChange,r?i:W)}),[r,i,s,l]),onResizeTextarea:i}},{withContext:he}=ee("textarea",le),a=he("textarea")(r=>({rows:2,...ne(),...r}),r=>{const{props:{errorBorderColor:o,focusBorderColor:n,...t},ariaProps:s,dataProps:l,eventProps:i}=te(r),{getTextareaProps:p}=me({...s,...l,...i,...t});return{...se({errorBorderColor:o,focusBorderColor:n}),...p()}}),Ae={component:a,title:"Components / Textarea"},S=()=>e.jsx(a,{placeholder:"basic"}),v=()=>e.jsx(Y,{variant:"stack",columns:["outline","filled","flushed"],rows:re,children:(r,o,n)=>e.jsx(a,{colorScheme:o,variant:r,placeholder:P(r)},n)}),j=()=>e.jsx(Y,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(r,o,n)=>e.jsx(a,{size:r,variant:o,placeholder:`Size (${r})`},n)}),y=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(a,{variant:r,disabled:!0,placeholder:r},o)}),e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(m,{variant:r,disabled:!0,children:[e.jsx(x,{children:"Email"}),e.jsx(a,{placeholder:P(r)})]},o)}),e.jsx(g,{disabled:!0,helperMessage:"We would like to get your feedback.",label:"Feedback",children:e.jsx(a,{variant:"outline",placeholder:"your feedback"})})]}),k=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(a,{variant:r,placeholder:r,readOnly:!0},o)}),e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(m,{variant:r,readOnly:!0,children:[e.jsx(x,{children:"Email"}),e.jsx(a,{placeholder:P(r)})]},o)}),e.jsx(g,{helperMessage:"We would like to get your feedback.",label:"Feedback",readOnly:!0,children:e.jsx(a,{variant:"outline",placeholder:"your feedback"})})]}),R=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(a,{variant:r,invalid:!0,placeholder:r},o)}),e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(m,{variant:r,invalid:!0,children:[e.jsx(x,{children:"Email"}),e.jsx(a,{placeholder:P(r)})]},o)}),e.jsx(g,{errorMessage:"Feedback is required.",invalid:!0,label:"Feedback",children:e.jsx(a,{variant:"outline",placeholder:"your feedback"})})]}),F=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(m,{variant:r,children:[e.jsx(x,{children:"Email"}),e.jsx(a,{placeholder:"Your email address"})]},o)}),e.jsxs(m,{children:[e.jsx(x,{children:"https://"}),e.jsx(a,{placeholder:"Your site address"}),e.jsx(x,{children:".com"})]})]}),z=()=>e.jsx(u,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(m,{variant:r,children:[e.jsx(N,{children:e.jsx(L,{fontSize:"xl"})}),e.jsx(a,{placeholder:"Your email address"})]},o)}),T=()=>e.jsxs(e.Fragment,{children:[e.jsx(a,{placeholder:"Default border color"}),e.jsx(a,{focusBorderColor:"green.500",placeholder:"Custom border color"}),e.jsxs(m,{variant:"flushed",focusBorderColor:"green.500",children:[e.jsx(N,{children:e.jsx(L,{fontSize:"xl"})}),e.jsx(a,{placeholder:"Custom border color"})]}),e.jsx(a,{errorBorderColor:"orange.500",invalid:!0,placeholder:"Custom border color"}),e.jsxs(m,{errorBorderColor:"orange.500",invalid:!0,children:[e.jsx(x,{children:"Email"}),e.jsx(a,{placeholder:"Custom border color"})]})]}),I=()=>e.jsxs(e.Fragment,{children:[e.jsx(a,{placeholder:"default placeholder"}),e.jsx(a,{placeholder:"custom placeholder",_placeholder:{color:"gray.500",opacity:1}}),e.jsx(a,{color:"green.500",placeholder:"custom placeholder",_placeholder:{color:"inherit"}})]}),C=()=>e.jsx(u,{each:["block","horizontal","vertical","none"],children:(r,o)=>e.jsx(a,{placeholder:r,resize:r},o)}),w=()=>e.jsxs(e.Fragment,{children:[e.jsx(a,{autosize:!0,placeholder:"autosize"}),e.jsx(a,{autosize:!0,minRows:4,placeholder:"autosize, min rows 4"}),e.jsx(a,{autosize:!0,maxRows:4,placeholder:"autosize, max rows 4"}),e.jsx(a,{placeholder:"rows 4",rows:4})]}),G=()=>{const r=f.useRef(null),o=()=>{r.current?.()};return e.jsxs(A,{children:[e.jsx(a,{placeholder:"use resize",resizeRef:r}),e.jsx(M,{alignSelf:"flex-end",onClick:o,children:"Resize"})]})},E=()=>{const{formState:{errors:r},handleSubmit:o,register:n}=q(),t=s=>console.log("submit:",s);return e.jsxs(A,{as:"form",onSubmit:o(t),children:[e.jsx(g,{errorMessage:r.textarea?.message,invalid:!!r.textarea,label:"Feedback",children:e.jsx(a,{placeholder:"your feedback",...n("textarea",{required:{message:"This is required.",value:!0}})})}),e.jsx(M,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},B=()=>{const r={textarea:"孫悟空"},{formState:{errors:o},handleSubmit:n,register:t}=q({defaultValues:r}),s=l=>console.log("submit:",l);return e.jsxs(A,{as:"form",onSubmit:n(s),children:[e.jsx(g,{errorMessage:o.textarea?.message,invalid:!!o.textarea,label:"Feedback",children:e.jsx(a,{placeholder:"your feedback",...t("textarea",{required:{message:"This is required.",value:!0}})})}),e.jsx(M,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`() => {
