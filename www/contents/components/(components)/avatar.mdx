...
| ---------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `AvatarImage`    | `alt`                | Alternative text for the avatar image. Sets the value of `name` if provided. Otherwise, sets the value of `alt`.      |
| `AvatarFallback` | `role="img"`         | Indicates that this is an image.                                                                                      |
|                  | `aria-label`         | Sets when `fallback` is not provided. Sets the value of `name` or `alt` if provided. Otherwise, sets `"Avatar Icon"`. |
