...
:::note
ブレイクポイントを変更したい場合は、[こちら](/docs/docs/styled-system/responsive-styles#ブレイクポイントをカスタマイズする)をご覧ください。
:::
...
:::note
カラーモードは、`localStorage`や`cookies`を用いて実装されています。カラーモードを学びたい場合は、[こちら](/docs/styled-system/color-mode)をご覧ください。
:::
