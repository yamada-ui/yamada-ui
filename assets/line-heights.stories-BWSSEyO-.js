import{j as e,V as s,T as t,ck as a}from"./iframe-5QspZtQ-.js";import{H as c}from"./heading-DabtuQYj.js";import{F as d}from"./for-DDltKb5N.js";import{H as l}from"./h-stack-Bk9FTdd3.js";import{C as x,b as m}from"./container-iAGLOHR0.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"Theme / Tokens"},n=()=>e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Line Heights"}),e.jsx(x,{children:e.jsx(m,{gap:"lg",children:e.jsx(d,{each:Object.entries(a),children:([r,i],o)=>e.jsxs(s,{children:[e.jsxs(l,{children:[e.jsx(t,{children:r}),e.jsx(t,{color:"fg.muted",children:i})]}),e.jsx(t,{fontSize:"2xl",lineHeight:r,children:"『ドラゴンボール』（DRAGON BALL）は、鳥山明による日本の漫画作品。『週刊少年ジャンプ』（集英社）にて1984年51号から1995年25号まで連載された。世界中に散らばった七つの球をすべて集めると、どんな願いも一つだけ叶えられるという秘宝・ドラゴンボールと、主人公・孫悟空（そん・ごくう）を中心に展開する、「冒険」「夢」「バトル」「友情」などを描いた長編漫画。"})]},o)})})})]});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  return <>
...
}`,...n.parameters?.docs?.source}}};const f=["LineHeights"];export{n as LineHeights,f as __namedExportsOrder,u as default};
