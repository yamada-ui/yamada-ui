...
tags: ["overlay", "selection", "floating", "list"]
...
:::tip
`Menu`は、トリガーから開くコンパクトなアクションやコマンドの一覧に使用します。ユーザーがフォームフィールドの値を選択する場合は、[Select](/docs/components/select)を使用します。
:::
...
配置を変更する場合は、`placement`に`"start"`や`"end-end"`などを設定します。デフォルトでは、`"end-start"`が設定されています。
...
| 要素                           | ロールと属性            | 使い方                                                                                                                                                     |
| ------------------------------ | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `button.ui-menu__trigger`      | `role="button"`         | ボタンであることを示します。                                                                                                                               |
|                                | `aria-controls`         | メニューが開いている場合は関連した`div.ui-menu__content`の`id`を設定し、閉じている場合は`undefined`を設定します。                                          |
...
| `div.ui-menu__context-trigger` | `role="application"`    | アプリケーションであることを示します。                                                                                                                     |
|                                | `aria-controls`         | メニューが開いている場合は関連した`div.ui-menu__content`の`id`を設定し、閉じている場合は`undefined`を設定します。                                          |
|                                | `aria-disabled`         | `disabled`が設定されている場合は`"true"`を設定します。                                                                                                     |
|                                | `aria-expanded`         | メニューが開いている場合は`"true"`を設定し、閉じている場合は、`"false"`を設定します。                                                                      |
|                                | `aria-haspopup="menu"`  | メニューが存在することを示します。                                                                                                                         |
| `div.ui-menu__content`         | `role="menu"`           | メニューであることを示します。                                                                                                                             |
|                                | `aria-activedescendant` | フォーカスされた項目の`id`を設定します。                                                                                                                   |
|                                | `aria-hidden`           | メニューが開いている場合は`"false"`を設定し、閉じている場合は`"true"`を設定します。                                                                        |
|                                | `aria-labelledby`       | 関連した`button.ui-menu__trigger`または`div.ui-menu__context-trigger`の`id`を設定します。                                                                  |
| `span.ui-menu__label`          | `role="presentation"`   | プレゼンテーションであることを示します。                                                                                                                   |
| `div.ui-menu__group`           | `role="group"`          | グループであることを示します。                                                                                                                             |
|                                | `aria-labelledby`       | 関連した`span.ui-menu__label`の`id`を設定します。                                                                                                          |
| `div.ui-menu__item`            | `role="menuitem"`       | メニュー項目であることを示します。                                                                                                                         |
|                                | `aria-disabled`         | `disabled`が設定されている場合は`"true"`を設定します。                                                                                                     |
| `div.ui-menu__item--option`    | `role`                  | `Menu.OptionGroup`の`type`が`"radio"`に設定されている場合は`"menuitemradio"`を設定し、`"checkbox"`に設定されている場合は`"menuitemcheckbox"`を設定します。 |
| `hr.ui-menu__separator`        | `role="separator"`      | セパレーターであることを示します。                                                                                                                         |
