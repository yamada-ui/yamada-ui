...
<PropsCard
  ...
  type='(string & {}) | "link" | "blue" | "cyan" | "fuchsia" | "gray" | "green" | "indigo" | "lime" | "orange" | "pink" | "purple" | "red" | "teal" | "violet" | "yellow" | "primary" | "secondary" | ... 11 more ... | "sky"'
...
<PropsCard
  ...
  name="contentProps"
  type='Omit<MotionProps<"div">, "children">'
  description={"Props for date picker container element."}
/>
