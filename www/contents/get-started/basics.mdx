...
:::note
If you want to know more about the components, please check the [components documentation](/docs/components).
:::
...
:::note
If you want to know more about the styling, please check the [styling documentation](/docs/styling).
:::
...
:::note
If you want to know more about the color schemes, please check the [color scheme documentation](/docs/styling/color-scheme).
:::
...
:::note
If you want to know more about the responsive design, please check the [responsive design documentation](/docs/styling/responsive-design).
:::
...
:::note
If you want to know more about the color mode, please check the [color mode documentation](/docs/styling/color-mode).
:::
