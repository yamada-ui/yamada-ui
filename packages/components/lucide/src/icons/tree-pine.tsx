...
import { TreePine as OriginalTreePine } from "lucide-react"
 ...
 */
export const TreePineIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalTreePine} {...props} />
))
