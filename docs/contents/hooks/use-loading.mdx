---
title: useLoading
description: '`useLoading` is a custom hook that controls the loading of the application.'
...
`useLoading` returns instances of `screen`, `page`, `background`, and `custom`. These instances include several methods.
...
:::note
If you want to learn more about loading, please see [here](/styled-system/loading).
:::
