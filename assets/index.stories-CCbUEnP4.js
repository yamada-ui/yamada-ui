import{aB as c,j as p}from"./iframe-CDtyXoOO.js";import{u as e}from"./index-NxiGf30M.js";import{B as u}from"./box-CAU2ZP73.js";import{u as d}from"./use-breakpoint-CUp0c_yw.js";import"./preload-helper-C1FmrZbK.js";import"./use-breakpoint-value-pGt3jT6r.js";import"./use-color-mode-value-tz3i41v8.js";const M={title:"Hooks / useValue"},o=()=>{const{colorMode:s}=c(),a=d(),l=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),i=e(["whiteAlpha.800","blackAlpha.800"]);return p.jsxs(u,{bg:l,color:i,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',a,'", colorMode is "',s,'"']})};var r,t,n;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
