...
- コンポーネントの[バリアントスタイル](/docs/components/styled#variant-style)または[サイズスタイル](/docs/components/styled#size-style)をカスタマイズする。
...
:::note
Yamada UIがコンポーネントを更新した場合は、[CLI](/docs/components/cli)の[差分を確認する](/docs/components/cli#check-differences)や[コンポーネントを更新する](/docs/components/cli#update-components)を行うことで、コンポーネントを簡単に更新することができます。もし、あなたの修正と競合しても[Git](https://git-scm.com)の[競合の提示方法](https://git-scm.com/docs/git-merge#_how_conflicts_are_presented)と同じように表示され、簡単に解決することができます。
:::
...
:::note
コンポーネントをもっと知りたい場合は、[コンポーネントのドキュメント](/docs/components)をご覧ください。
:::
...
:::note
スタイリングをもっと知りたい場合は、[スタイリングのドキュメント](/docs/styling)をご覧ください。
:::
...
:::note
カラースキームをもっと知りたい場合は、[カラースキームのドキュメント](/docs/styling/color-scheme)をご覧ください。
:::
...
:::note
レスポンシブデザインをもっと知りたい場合は、[レスポンシブデザインのドキュメント](/docs/styling/responsive-design)をご覧ください。
:::
...
:::note
カラーモードをもっと知りたい場合は、[カラーモードのドキュメント](/docs/styling/color-mode)をご覧ください。
:::
