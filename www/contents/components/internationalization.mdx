...
:::warning
Before running the following commands, you need to install `@yamada-ui/cli` and run the `init` command. Please refer to the [CLI](/docs/get-started/cli) for more details.
:::
