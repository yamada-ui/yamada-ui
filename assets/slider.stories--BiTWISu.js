...
}`,...(Xr=(Wr=he.parameters)==null?void 0:Wr.docs)==null?void 0:Xr.source}}};var Yr,Qr,Gr;pe.parameters={...pe.parameters,docs:{...(Yr=pe.parameters)==null?void 0:Yr.docs,source:{originalSource:`() => {
  const [value, onChange] = useState<number>(50);
...
}`,...(Gr=(Qr=pe.parameters)==null?void 0:Qr.docs)==null?void 0:Gr.source}}};var Jr,Zr,en;Se.parameters={...Se.parameters,docs:{...(Jr=Se.parameters)==null?void 0:Jr.docs,source:{originalSource:`() => {
  type Data = {
    slider: number;
  };
...
}`,...(en=(Zr=Se.parameters)==null?void 0:Zr.docs)==null?void 0:en.source}}};const Ht=["basic","withDefaultValue","withSize","withColorScheme","withOrientation","withReversed","withMinMax","withStep","withFocusThumbOnChange","withMark","withTooltip","isDisabled","isReadonly","isInvalid","customColor","customThumb","customMark","customControl","onChangeStart","onChangeEnd","reactHookForm"];export{Ht as __namedExportsOrder,Y as basic,ue as customColor,me as customControl,de as customMark,ce as customThumb,jt as default,le as isDisabled,ie as isInvalid,se as isReadonly,pe as onChangeEnd,he as onChangeStart,Se as reactHookForm,J as withColorScheme,Q as withDefaultValue,te as withFocusThumbOnChange,ae as withMark,re as withMinMax,Z as withOrientation,ee as withReversed,G as withSize,ne as withStep,oe as withTooltip};
