...
| ---------------------------------- | ------------------------ | -------------------------------------------------------------------------------- |
| `div.ui-drawer__content`           | `role="dialog"`          | Indicates that it is a dialog.                                                   |
...
| `button.ui-drawer__trigger--open`  | `aria-expanded`          | Sets to `"true"` when modal is opened, and `"false"` when it is closed.          |
|                                    | `aria-controls`          | Sets the `id` of `div.ui-drawer__content` when open, and is not set when closed. |
...
| `button.ui-drawer__trigger--close` | `aria-label`             | Sets to `"Close modal"`.                                                         |
