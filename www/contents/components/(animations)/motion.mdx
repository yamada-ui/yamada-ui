...
:::note
`Motion` uses [Motion](https://motion.dev) internally. If you want to know more about the component's features, please refer to the [Motion component](https://motion.dev/docs/react-motion-component).
:::
...
:::note
Hover's animation to know more about the animation of hover, please refer to the [Hover animation](https://motion.dev/docs/react-hover-animation).
:::
...
:::note
Drag's animation to know more about the animation of drag, please refer to the [Drag](https://motion.dev/docs/react-drag).
:::
