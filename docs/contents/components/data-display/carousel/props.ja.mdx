...
<PropsCard
  id="carousel-align"
  name="align"
  type='AlignmentOptionType | Partial<Record<(string & {}) | "base" | "sm" | "md" | "lg" | "xl" | "2xl", AlignmentOptionType | undefined>> | ColorModeArray<...>'
...
<PropsCard
  ...
  name="containScroll"
  type='ScrollContainOptionType | Partial<Record<(string & {}) | "base" | "sm" | "md" | "lg" | "xl" | "2xl", ScrollContainOptionType | undefined>> | ColorModeArray<...>'
  description={
...
<PropsCard
  ...
  | number
  | number[]
  | Partial<Record<(string & {}) | "base" | "sm" | "md" | "lg" | "xl" | "2xl",
