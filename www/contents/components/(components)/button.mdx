...
:::tip
To make it function as a link, set `as="a"`. If your framework provides a link component, set `as={FrameworkLink}`. For integration with each framework's link component, see the documentation for your framework [here](/docs/get-started#pick-your-framework).
:::

:::tip
If the only child of `Button` is an icon, use [IconButton](/docs/components/icon-button).
:::
...
:::tip
If you want to create a button for closing, consider using [CloseButton](/docs/components/close-button).
:::

:::tip
If you want to create a button for selecting files, consider using [FileButton](/docs/components/file-button).
:::
