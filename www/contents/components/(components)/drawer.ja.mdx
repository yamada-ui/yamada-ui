...
:::tip
`Drawer`は、現在のページの文脈を保ちながら、画面端から補助的な操作や設定を表示する場合に使用します。ユーザーが続行する前に短い操作や判断へ集中する必要がある場合は、[Modal](/docs/components/modal)を使用します。
:::
...
配置を変更する場合は、`placement`に`"block-start"`や`"inline-start"`などを設定します。デフォルトでは、`"inline-end"`が設定されています。
...
| 要素                             | ロールと属性             | 使い方                                                                                               |
| -------------------------------- | ------------------------ | ---------------------------------------------------------------------------------------------------- |
| `section.ui-drawer__content`     | `role="dialog"`          | ダイアログであることを示します。                                                                     |
...
| `.ui-drawer__trigger--open`      | `aria-expanded`          | モーダルが開いている場合は`"true"`を設定し、閉じている場合は`"false"`を設定します。                  |
|                                  | `aria-controls`          | モーダルが開いている場合は`section.ui-drawer__content`の`id`を設定し、閉じている場合は設定しません。 |
|                                  | `aria-haspopup="dialog"` | ダイアログが存在することを示します。                                                                 |
|                                  | `aria-label`             | `"モーダルを開く"`を設定します。                                                                     |
| `button.ui-drawer__close-button` | `aria-label`             | `"モーダルを閉じる"`を設定します。                                                                   |
| `.ui-drawer__trigger--close`     | `aria-label`             | `"モーダルを閉じる"`を設定します。                                                                   |
| `div.ui-drawer__overlay`         | `aria-hidden`            | 要素をアクセシビリティツリーから除外します。                                                         |
