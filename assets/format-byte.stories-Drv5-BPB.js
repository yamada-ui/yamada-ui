import{p as D,q as k,j as e,s as L,V as F,bf as V,T as b}from"./iframe-D2_3f4k8.js";import{G as E}from"./grid-Cxhjtbk0.js";import{F as G}from"./for-0q0QsVyW.js";import{u as T}from"./use-format-byte-CMcXxejG.js";import"./preload-helper-C1FmrZbK.js";import"./use-format-number-CveRjaex.js";import"./i18n-cache-2nrF3WCd.js";const w=D({}),{withContext:O}=k("format-byte",w),t=O(({locale:r,unit:g,unitDisplay:f,value:S,...h})=>{const C=T(S,{locale:r,unit:g,unitDisplay:f});return e.jsx(L.span,{...h,children:C})})(),H={component:t,title:"Components / Format / Byte"},a=()=>e.jsxs(F,{gap:"0",children:[e.jsx(t,{value:50}),e.jsx(t,{value:5e3}),e.jsx(t,{value:5e6}),e.jsx(t,{value:5e9})]}),s=()=>e.jsx(t,{unit:"bit",value:1450}),o=()=>e.jsx(E,{gapX:"sm",templateColumns:"auto 1fr",children:e.jsx(G,{each:V,children:r=>e.jsxs(e.Fragment,{children:[e.jsx(b,{color:"fg.muted",children:r}),e.jsx(t,{locale:r,value:1450},r)]})})}),n=()=>e.jsxs(F,{gap:"0",children:[e.jsx(t,{unitDisplay:"short",value:50300}),e.jsx(t,{unitDisplay:"long",value:50300}),e.jsx(t,{unitDisplay:"narrow",value:50300})]});var c,l,m;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
  return <VStack gap="0">
