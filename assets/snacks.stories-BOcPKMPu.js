import{d as $,g as P,r,P as X,j as n,a8 as G,t as Y,Y as O,b as N,bS as nn,bT as en,E as sn,A as tn,h as V,B as cn,x as an,y as on,z as rn,D as ln,aB as dn,S as c,R as z}from"./iframe-BynoZ0Oq.js";import{c as J}from"./transition-ZjIwupCc.js";import{W as k}from"./wrap-DNTaTEw_.js";import{b as m}from"./input-igikG93z.js";import{F as _}from"./for-BimcTw3e.js";import"./preload-helper-PPVm8Dsz.js";import"./flex-zG46G6gY.js";import"./use-input-border-D8Osi-F8.js";import"./use-field-props-DSGZpnoT.js";const un=$({base:{closeButton:{"&:is([data-variant='plain'], [data-variant='island'])":{colorScheme:"mono!"},"&:is([data-variant='solid'])":{color:"colorScheme.contrast!",_hover:{bg:"colorScheme.solid!"}},fontSize:"md!",minBoxSize:"6!",position:"absolute",right:"3",top:"2.5"},content:{"&[data-close-button]":{pe:"6"},display:"flex",flex:"1",flexDirection:"column",gap:"1"},item:{insetX:"0",maxW:"full",position:"absolute",top:"calc({gap} * {index})",w:"100%",zIndex:"{z-index}"},list:{position:"relative",w:"full"},root:{"&[data-negative]":{m:"calc({top} * -1) 0 calc({bottom} * -1)"},"--gap":"spaces.md",w:"full"}}}),{ComponentContext:pn,useComponentContext:kn,withContext:H,withProvider:mn}=P("snacks",un),h=mn(({snacks:{direction:e="start",items:t,startIndex:s=0},listProps:l,...x})=>{const o=t.length,C=r.useRef(new Map),[g,f]=r.useState(0),[B,A]=r.useState(!!o),v=!!o||B,u=r.useMemo(()=>({direction:e,elMapRef:C,setExist:A,startIndex:s}),[e,s]),i=r.useCallback(()=>{o||A(!1)},[o]);return r.useEffect(()=>{let a=0;if(!o)return;const d=[...C.current.values()].slice(0,o);for(const p of d){if(!p)continue;let{offsetHeight:I,offsetTop:j}=p;I+=j,I>a&&(a=I)}f(a)},[o,e]),X(()=>{o&&A(!0)},[o]),n.jsx(pn,{value:u,children:n.jsx(G,{initial:!1,children:v?n.jsx(Y.div,{...x,children:n.jsx(hn,{custom:{height:g},...l,children:n.jsx(G,{onExitComplete:i,children:t.map((a,d)=>n.jsx(Sn,{index:d,lastIndex:o-d-1,...a},a.id))})})}):null})})},"root")({animate:"animate",exit:"exit",initial:"initial",variants:{animate:{padding:"var(--top) 0 var(--bottom)",transition:{duration:.4}},exit:{padding:0},initial:{padding:0}}},({gap:e,gutter:t=[0,"lg"],negativeMargins:s=!0,...l})=>({"data-negative":N(s),"--bottom":O(t[1],"spaces","0px"),"--gap":O(e,"spaces"),"--top":O(t[0],"spaces","0px"),...l})),hn=H(Y.div,"list")({animate:"animate",exit:"exit",initial:"initial",role:"list",variants:{animate:({height:e})=>({height:e,opacity:1,transition:{duration:.4}}),exit:{height:0,opacity:0},initial:{height:0,opacity:1}}}),Sn=H(({variant:e="plain",closable:t=!0,description:s,duration:l=null,loadingScheme:x,status:o,title:C,withIcon:g=!0,closeButtonProps:f,contentProps:B,descriptionProps:A,iconProps:v,loadingProps:u,titleProps:i,onClose:a,onCloseComplete:d,...p})=>{const[I,j]=r.useState(l),W=nn(),q=W?a:sn,Q=r.useCallback(()=>{j(null)},[]),Z=r.useCallback(()=>{j(l)},[l]);return X(()=>{W||d?.()},[W]),X(()=>{j(l)},[l]),en(q,I),n.jsxs(tn,{as:Y.div,variant:e,status:o,...p,onMouseEnter:V(p.onMouseEnter,Q),onMouseLeave:V(p.onMouseLeave,Z),children:[g?x?n.jsx(cn,{loadingScheme:x,...u}):n.jsx(an,{...v}):null,n.jsxs(xn,{"data-close-button":N(t),...B,children:[C?n.jsx(on,{me:"0",...i,children:C}):null,s?n.jsx(rn,{...A,children:s}):null]}),t?n.jsx(Cn,{"data-variant":e,...f,onClick:V(f?.onClick,q)}):null]})},"item")({animate:"animate",exit:"exit",initial:"initial",layout:!0,role:"listitem",variants:{animate:({index:e})=>({opacity:1,transition:J.enter()(e?0:.2,.4),y:0}),exit:{opacity:0,transition:J.exit()(void 0,.2)},initial:({direction:e,index:t})=>({opacity:0,...t?{y:(e==="start"?-1:1)*16}:{}})}},({index:e,lastIndex:t,...s})=>{const l=r.useRef(null),{direction:x,elMapRef:o,startIndex:C}=kn();return r.useEffect(()=>{const g=o.current;return g.set(e,l.current),()=>{g.delete(e)}},[o,e]),{ref:l,"--index":x==="start"?t:e,"--z-index":C+e,custom:{direction:x,index:e},...s}}),xn=H("div","content")(),Cn=H(ln,"closeButton")();let K=0;const S=(e={})=>{const[t,s]=r.useState([]),{config:l}=dn(),x=r.useMemo(()=>l.snacks??{},[l]),o=r.useMemo(()=>({...x,...e}),[e,x]),{direction:C,limit:g=3,startIndex:f}=o,B=r.useCallback(u=>({...o,...u}),[o]),A=r.useMemo(()=>{const u=(i={})=>{i=B(i),K+=1;const{id:a=K.toString(),...d}=i,I={id:a,onClose:()=>s(j=>j.filter(W=>W.id!==a)),...d};return s(j=>[...j.splice(-1*((g??1/0)-1)),I]),a};return u.update=(i,a)=>{a=B(a),s(d=>d.map(p=>p.id===i?{...p,...a}:p))},u.closeAll=()=>{s([])},u.close=i=>{s(a=>a.filter(d=>d.id!==i))},u.isActive=i=>!!t.find(a=>a.id===i),u},[t,g,B]),v=r.useMemo(()=>({direction:C,items:t,startIndex:f}),[C,f,t]);return{snack:A,snacks:v}},yn={title:"Components / Snacks"},b=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{onClick:()=>{e({description:"こいつ、動くぞ！",title:"アムロ・レイ"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},y=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(_,{each:["plain","solid","subtle","surface","island"],children:s=>n.jsxs(c,{onClick:()=>{e({variant:s,description:"美しいものが、嫌いな人がいるのかしら？",title:"ララァ・スン",withIcon:s!=="island"})},children:['Add "',z(s),'" Snack']},s)}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},F=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(_,{each:["info","success","warning","error"],children:s=>n.jsxs(c,{onClick:()=>{e({description:"アムロ、行きまーす！",status:s,title:"アムロ・レイ"})},children:['Add "',z(s),'" Snack']},s)}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},w=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(_,{each:["info","success","warning","error"],children:s=>n.jsxs(c,{onClick:()=>{e({colorScheme:s,description:"見せて貰おうか。連邦軍のモビルスーツの性能とやらを！",title:"シャア・アズナブル"})},children:['Add "',z(s),'" Snack']},s)}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},M=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(_,{each:["oval","grid","puff","dots"],children:s=>n.jsxs(c,{onClick:()=>{e({description:"大丈夫、あなたなら出来るわ。",loadingScheme:s,title:"セイラ・マス"})},children:['Add "',z(s),'" Snack']},s)}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},E=()=>{const{snack:e,snacks:t}=S({direction:"end"});return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{onClick:()=>{e({description:"認めたくないものだな。自分自身の、若さゆえの過ちというものを。",title:"シャア・アズナブル"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},R=()=>{const{snack:e,snacks:t}=S({limit:5});return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{onClick:()=>{e({description:"殴られもせずに一人前になった奴がどこにいるものか！",title:"ブライト・ノア"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},D=()=>{const{snack:e,snacks:t}=S();return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{colorScheme:"primary",onClick:()=>{e({description:"それでも男ですか！軟弱者！",duration:3e4,title:"セイラ・マス"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},T=()=>{const{snack:e,snacks:t}=S({closable:!1});return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{colorScheme:"primary",onClick:()=>{e({description:"ザクとは違うのだよ、ザクとは！",title:"ランバ・ラル"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},L=()=>{const{snack:e,snacks:t}=S(),s=r.useRef(void 0);return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{onClick:()=>{s.current=e({description:"オレは、生きる！生きて、アイナと添い遂げる！",title:"シロー・アマダ"})},children:"Add Snack"}),n.jsx(c,{colorScheme:"warning",onClick:()=>{s.current&&e.close(s.current)},children:"Close last Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})},U=()=>{const{snack:e,snacks:t}=S(),s=r.useRef(void 0);return n.jsxs(n.Fragment,{children:[n.jsxs(k,{gap:"md",children:[n.jsx(c,{onClick:()=>{s.current=e({description:"今の私は、クワトロ・バジーナ大尉だ。それ以上でも、それ以下でもない。",title:"クワトロ・バジーナ"})},children:"Add Snack"}),n.jsx(c,{onClick:()=>{s.current&&e.update(s.current,{colorScheme:"purple",description:"そんな大人、修正してやる！",title:"カミーユ・ビダン"})},children:"Update last Snack"}),n.jsx(c,{colorScheme:"danger",onClick:e.closeAll,children:"Close all Snack"})]}),n.jsx(h,{snacks:t}),n.jsx(m,{placeholder:"Input"})]})};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
  const {
    snack,
    snacks
  } = useSnacks();
...
}`,...U.parameters?.docs?.source}}};const Fn=["Basic","Variant","Status","ColorScheme","Loading","Direction","Limit","Duration","DisabledClosable","UseClose","UseUpdate"];export{b as Basic,w as ColorScheme,E as Direction,T as DisabledClosable,D as Duration,R as Limit,M as Loading,F as Status,L as UseClose,U as UseUpdate,y as Variant,Fn as __namedExportsOrder,yn as default};
