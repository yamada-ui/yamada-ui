import{j as e}from"./jsx-runtime-CfatFE5O.js";import{u as ln}from"./index-D4SEQqYY.js";import{r as x}from"./index-ClcD9ViR.js";import{C as o,S as mn,a as Mn}from"./square-pen-HexEMLiy.js";import{M as sn}from"./menu-B1N9qsLD.js";import{a as dn,f as d,b as t,c as r,d as n}from"./menu-list-Dht2ORFT.js";import{f as In}from"./forward-ref-D13m8o2p.js";import{b as H,c as J,P as Y,A as xn}from"./factory-Dfrbb1EY.js";import{u as pn}from"./index-De_nPH_B.js";import{M as s,a as Z}from"./menu-button-DBm1pCAS.js";import{B as u}from"./button-3gvEA_m9.js";import{I as on}from"./icon-button-jGL_DP59.js";import{P as hn}from"./plus-BwpCkT_S.js";import{M as K}from"./menu-separator-BfdcsION.js";import{P as jn}from"./portal-BMWh88P0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-DDeGQYl6.js";import"./use-component-style-fOirb5M1.js";import"./theme-provider-DSx3k1bh.js";import"./use-var-BQS3JFPa.js";import"./createLucideIcon-DHJHrKis.js";import"./popover-trigger-cRImiVAI.js";import"./close-button-DENBYMYY.js";import"./use-ripple-59xURXHY.js";import"./index-r0TXmcNt.js";import"./proxy-Bq47Fk52.js";import"./factory-DeSWW4o7.js";import"./slide-fade-CQuVyWIS.js";import"./index-D_3Ilmao.js";import"./index-CKnINgQh.js";import"./forward-ref-2BKBy0Yi.js";import"./utils-Crg7yCn-.js";import"./scale-fade-DtFg8nlV.js";import"./index-DYgLfGUQ.js";import"./index-gGKStiao.js";import"./index-DqeO0dAp.js";import"./index-BVP762bF.js";import"./index-CFtnIMNb.js";import"./index-CgNA1xsw.js";import"./index-O1jdRUiZ.js";import"./loading-C7VoLX3j.js";import"./index-ZuzByk-F.js";const p=In(({className:a,children:I,label:M,labelProps:m,...R},k)=>{const{styles:h}=dn(),A=x.useId(),l=(m==null?void 0:m.id)??A,c={...h.group};return e.jsxs(H.section,{ref:k,className:J("ui-menu__item","ui-menu__item--group",a),"aria-labelledby":l,role:"group",__css:c,...R,children:[M?e.jsx(H.header,{className:J("ui-menu__item--group-label"),role:"presentation",__css:h.groupLabel,...m,id:l,children:M}):null,e.jsx(H.div,{className:"ui-menu__item__group",children:I})]})});p.displayName="MenuGroup";p.__ui__="MenuGroup";const F=x.forwardRef(({type:a,className:I,children:M,defaultValue:m,value:R,onChange:k,...h},A)=>{const l=a==="radio";m??(m=l?"":[]);const[c,q]=pn({defaultValue:m,value:R,onChange:k}),un=x.useCallback(i=>{if(l&&typeof c=="string"&&q(i),!l&&Y(c)){const U=c.includes(i)?c.filter(W=>W!==i):c.concat(i);q(U)}},[l,c,q]),cn=xn(M).map(i=>{if(i.type!==d)return i;const U=an=>{var Q,X;un(i.props.value),(X=(Q=i.props).onClick)==null||X.call(Q,an)},W=!l&&Y(c)?c.includes(i.props.value):i.props.value===c;return x.cloneElement(i,{type:a,isChecked:W,onClick:U})});return e.jsx(p,{ref:A,className:J("ui-menu__item--group--option",I),...h,children:cn})});F.displayName="MenuOptionGroup";F.__ui__="MenuOptionGroup";const ct={component:t,title:"Components / Overlay / Menu"},j=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),f=()=>e.jsxs(t,{children:[e.jsx(s,{as:on,variant:"outline","aria-label":"Menu",icon:e.jsx(sn,{fontSize:"2xl"})}),e.jsxs(r,{children:[e.jsx(n,{command:"⌘T",children:"New Tab"}),e.jsx(n,{command:"⌘N",children:"New Window"}),e.jsx(n,{command:"⌘O",children:"Open File"})]})]}),S=()=>e.jsxs(t,{children:[e.jsx(s,{as:on,variant:"outline","aria-label":"Menu",icon:e.jsx(sn,{fontSize:"2xl"})}),e.jsxs(r,{children:[e.jsx(n,{command:"⌘T",icon:e.jsx(hn,{fontSize:"lg"}),children:"New Tab"}),e.jsx(n,{command:"⌘N",icon:e.jsx(mn,{fontSize:"lg"}),children:"New Window"}),e.jsx(n,{command:"⌘O",icon:e.jsx(Mn,{fontSize:"lg"}),children:"Open File"})]})]}),P=()=>{const a=x.useRef(null);return e.jsxs(t,{initialFocusRef:a,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{ref:a,children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]})},B=()=>e.jsxs(t,{placement:"right-start",children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),w=()=>e.jsxs(t,{animation:"top",children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),g=()=>e.jsxs(t,{offset:[16,16],children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),L=()=>e.jsxs(t,{gutter:32,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),z=()=>e.jsxs(t,{duration:.4,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),O=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"}),e.jsx(K,{}),e.jsx(n,{children:"Sign out"})]})]}),C=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsxs(p,{label:"account",children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]}),e.jsx(K,{}),e.jsx(p,{label:"action",children:e.jsx(n,{children:"Sign out"})})]})]}),v=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsxs(F,{type:"radio",label:"order",children:[e.jsx(d,{value:"asc",children:"Ascending"}),e.jsx(d,{value:"desc",children:"Descending"})]}),e.jsx(K,{}),e.jsxs(F,{type:"checkbox",label:"display",children:[e.jsx(d,{value:"gender",children:"gender"}),e.jsx(d,{value:"email",children:"email"}),e.jsx(d,{value:"phone",children:"phone"})]})]})]}),E=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsx(jn,{children:e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})})]}),b=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:e.jsxs(t,{children:[e.jsx(Z,{children:"Settings"}),e.jsxs(r,{children:[e.jsx(n,{children:"Extensions"}),e.jsx(n,{children:e.jsxs(t,{children:[e.jsx(Z,{children:"Theme"}),e.jsxs(r,{children:[e.jsx(n,{children:"Color Theme"}),e.jsx(n,{children:"File Icon Theme"}),e.jsx(n,{children:"Product Icon Theme"})]})]})}),e.jsx(n,{children:"User Tasks"})]})]})}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),D=()=>e.jsxs(t,{closeOnSelect:!1,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{closeOnSelect:!0,children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),_=()=>e.jsxs(t,{closeOnBlur:!1,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),G=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{isDisabled:!0,children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),T=()=>e.jsxs(t,{children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{isDisabled:!0,isFocusable:!0,children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),N=()=>e.jsxs(t,{isLazy:!0,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]}),y=()=>{const{isOpen:a,onClose:I,onOpen:M}=ln();return e.jsxs(t,{isOpen:a,onClose:I,onOpen:M,children:[e.jsx(s,{as:u,endIcon:e.jsx(o,{fontSize:"xl"}),children:"Menu"}),e.jsxs(r,{children:[e.jsx(n,{children:"Set status"}),e.jsx(n,{children:"Edit Profile"}),e.jsx(n,{children:"Preferences"})]})]})};var $,V,ee;j.parameters={...j.parameters,docs:{...($=j.parameters)==null?void 0:$.docs,source:{originalSource:`() => {
  return <Menu>
...
}`,...(Me=(me=B.parameters)==null?void 0:me.docs)==null?void 0:Me.source}}};var de,Ie,xe;w.parameters={...w.parameters,docs:{...(de=w.parameters)==null?void 0:de.docs,source:{originalSource:`() => {
...
}`,...(Pe=(Se=L.parameters)==null?void 0:Se.docs)==null?void 0:Pe.source}}};var Be,we,ge;z.parameters={...z.parameters,docs:{...(Be=z.parameters)==null?void 0:Be.docs,source:{originalSource:`() => {
...
}`,...(ge=(we=z.parameters)==null?void 0:we.docs)==null?void 0:ge.source}}};var Le,ze,Oe;O.parameters={...O.parameters,docs:{...(Le=O.parameters)==null?void 0:Le.docs,source:{originalSource:`() => {
  return <Menu>
      <MenuButton as={Button} endIcon={<ChevronDownIcon fontSize="xl" />}>
        Menu
      </MenuButton>
