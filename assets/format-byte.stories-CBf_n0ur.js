import{p as D,j as e,s as k,w as L,V as F,b5 as V,T as b}from"./iframe-Bh9OJiMa.js";import{G as w}from"./grid-DEBT4jh_.js";import{F as E}from"./for-Drx2NpVa.js";import{u as G}from"./use-format-byte-BGq9FnEU.js";import"./preload-helper-C1FmrZbK.js";import"./use-format-number-ClvX1fLe.js";import"./i18n-cache-2nrF3WCd.js";const T=D({}),{withContext:O}=L("format-byte",T),t=O(({locale:r,unit:g,unitDisplay:S,value:f,...h})=>{const C=G(f,{locale:r,unit:g,unitDisplay:S});return e.jsx(k.span,{...h,children:C})})(),H={component:t,title:"Components / Format / Byte"},a=()=>e.jsxs(F,{gap:"0",children:[e.jsx(t,{value:50}),e.jsx(t,{value:5e3}),e.jsx(t,{value:5e6}),e.jsx(t,{value:5e9})]}),s=()=>e.jsx(t,{unit:"bit",value:1450}),o=()=>e.jsx(w,{gapX:"sm",templateColumns:"auto 1fr",children:e.jsx(E,{each:V,children:r=>e.jsxs(e.Fragment,{children:[e.jsx(b,{color:"fg.muted",children:r}),e.jsx(t,{locale:r,value:1450},r)]})})}),n=()=>e.jsxs(F,{gap:"0",children:[e.jsx(t,{unitDisplay:"short",value:50300}),e.jsx(t,{unitDisplay:"long",value:50300}),e.jsx(t,{unitDisplay:"narrow",value:50300})]});var c,l,m;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
  return <VStack gap="0">
