...
| `div.ui-avatar__fallback` | `role="img"`         | When `fallbackMessage` is not set, indicates that this is an image.                                                                                                              |
|                           | `aria-label`         | When `fallbackMessage` is not set, sets the value of `name` or `alt` if provided. Otherwise, sets `"Avatar Icon"`.                                                               |
