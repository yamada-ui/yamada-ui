import{j as r,T as o}from"./iframe-DkaXVr_9.js";import{u as i}from"./index-BLhwsZUN.js";import"./preload-helper-D9Z9MdNV.js";import"./index-DdKYt1Ds.js";const x={title:"Hooks / useAsync"},e=()=>{const{error:s,loading:n,value:t}=i(async()=>new Promise((a,c)=>{setTimeout(()=>{Math.random()>.5?a("✌️"):c(new Error("A pseudo random error occurred"))},3e3)}),[]);return n?r.jsx(o,{children:"Loading..."}):s?r.jsxs(o,{children:["Error: ",s.message]}):r.jsxs(o,{children:["Value: ",t]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  const {
    error,
    loading,
    value
