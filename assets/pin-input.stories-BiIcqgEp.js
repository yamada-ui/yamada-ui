import{j as e}from"./jsx-runtime-CKrituN3.js";import{r as p}from"./index-CBqU2yxZ.js";import{u as fn,C as xn}from"./index.esm-CiJ9mLzm.js";import{u as qn}from"./index-DOHT0qqe.js";import{c as On}from"./index-Bknf-GSb.js";import{u as jn,g as Bn,F as S}from"./form-control-Dbo-pJGm.js";import{p as Tn,Q as En,w as _n,h as M,t as An,u as Pn,c as bn,v as zn}from"./factory-D1MzC1Q2.js";import{f as Fn}from"./forward-ref-DuAegr0M.js";import{a as Ln}from"./use-component-style-i7T2CPTB.js";import{o as Nn}from"./theme-provider-LCtE2tbw.js";import{u as Sn}from"./loading-provider-CSi-RcGW.js";import{V as Cn}from"./stack-Co-fUSRT.js";import{B as yn}from"./button-BkvW6mjw.js";import"./_commonjsHelpers-BosuxZz1.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-BPGUNDjC.js";import"./index-CKo3gv6y.js";import"./Combination-DlzjZhkT.js";import"./loading-BxQYss10.js";import"./index-CYT3-ShY.js";import"./index-BY3Kv4Lb.js";import"./index-D62GHI4F.js";import"./icon-B3uV5IZ5.js";import"./motion-C1gM6QUe.js";import"./motion-JgkBPv6g.js";import"./index-_tcQm2Fk.js";import"./container-portal-CAcQI922.js";import"./index-BtM5VmRH.js";import"./use-ripple-K38Z2Edq.js";const de=t=>t==null?void 0:t.split(""),me=(t,a)=>(a==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(t),[Hn,Jn]=Tn({strict:!1,name:"PinInputContext"}),{DescendantsContextProvider:Un,useDescendants:Gn,useDescendant:Xn}=On(),n=Fn(({focusBorderColor:t,errorBorderColor:a,...c},l)=>{const[d,g]=Ln("PinInput",{focusBorderColor:t,errorBorderColor:a,...c});let{id:u,className:f,type:b="number",placeholder:ee="○",value:wn,defaultValue:vn,autoFocus:ne,manageFocus:C=!0,otp:se=!1,mask:re,onChange:W,onComplete:I,items:Dn=4,children:Vn,...y}=jn(Nn(g));u??(u=p.useId());const i=Gn(),[te,Q]=p.useState(!0),[oe,ae]=p.useState(-1);p.useEffect(()=>{if(!ne)return;const s=i.firstValue();s&&requestAnimationFrame(()=>s.node.focus())},[ne,i]);const[F,w]=qn({value:de(wn),defaultValue:de(vn)||[],onChange:s=>W==null?void 0:W(s.join(""))}),ie=p.useCallback(s=>{if(!te||!C)return;const r=i.nextValue(s,void 0,!1);r&&requestAnimationFrame(()=>r.node.focus())},[i,te,C]),v=p.useCallback((s,r,h=!0)=>{var D;let m=[...F];m[r]=s,w(m),m=m.filter(Boolean),s!==""&&m.length===i.count()&&m.every(x=>x!=null&&x!=="")?(I==null||I(m.join("")),(D=i.value(r))==null||D.node.blur()):h&&ie(r)},[F,w,i,I,ie]),ue=p.useCallback((s,r)=>{let h=r;return s!=null&&s.length&&(s[0]===r.charAt(0)?h=r.charAt(1):s[0]===r.charAt(1)&&(h=r.charAt(0))),h},[]),Mn=p.useCallback(({index:s,...r})=>{const h=({target:x})=>{var ce;const j=x.value,V=F[s],P=ue(V,j);if(P===""){v("",s);return}if(j.length>2){if(!me(j,b))return;const Y=j.split("").filter(($n,kn)=>kn<i.count());w(Y),Y.length===i.count()&&(I==null||I(Y.join("")),(ce=i.value(s))==null||ce.node.blur())}else me(P,b)&&v(P,s),Q(!0)},m=({key:x,target:j})=>{var V;if(!(x!=="Backspace"||!C))if(j.value===""){const P=i.prevValue(s,void 0,!1);if(!P)return;v("",s-1,!1),(V=P.node)==null||V.focus(),Q(!0)}else Q(!1)},le=()=>ae(s),D=()=>ae(-1);return{inputMode:b==="number"?"numeric":"text",type:re?"password":b==="number"?"tel":"text",...En(y,Bn({omit:["aria-readonly"]})),..._n(r),id:`${u}-${s}`,value:F[s]||"",onChange:M(r.onChange,h),onKeyDown:M(r.onKeyDown,m),onFocus:M(r.onFocus,le),onBlur:M(r.onBlur,D),autoComplete:se?"one-time-code":"off",placeholder:oe===s&&!y.readOnly&&!r.readOnly?"":ee}},[i,oe,ue,u,C,re,I,se,ee,y,v,w,b,F]),Rn={display:"flex",alignItems:"center",...d.container};let Z=An(Vn);if(!Z.length)for(let s=0;s<Dn;s++)Z.push(e.jsx(o,{},s));return e.jsx(Un,{value:i,children:e.jsx(Hn,{value:{getInputProps:Mn,styles:d},children:e.jsx(Pn.div,{ref:l,className:bn("ui-pin-input",f),...y,__css:Rn,children:Z})})})}),o=Fn(({className:t,...a},c)=>{const{getInputProps:l,styles:d}=Jn(),{index:g,register:u}=Xn();a=jn(a);const f={...d.field};return e.jsx(Pn.input,{className:bn("ui-pin-input__field",t),...l({...a,ref:zn(u,c),index:g}),__css:f})}),Ss={title:"Components / Forms / PinInput",component:n},R=()=>e.jsx(n,{}),k=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{size:"xs"}),e.jsx(n,{size:"sm"}),e.jsx(n,{size:"md"}),e.jsx(n,{size:"lg"})]}),q=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{variant:"outline"}),e.jsx(n,{variant:"filled"}),e.jsx(n,{variant:"flushed"}),e.jsx(n,{variant:"unstyled"})]}),O=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{items:3}),e.jsx(n,{items:4}),e.jsx(n,{items:5}),e.jsx(n,{items:6})]}),B=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{type:"alphanumeric"})]}),T=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{defaultValue:"1234"}),e.jsx(n,{defaultValue:"123"})]}),E=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{focusBorderColor:"green.500"}),e.jsx(n,{isInvalid:!0,errorBorderColor:"orange.500"})]}),_=()=>{const{page:t}=Sn();return e.jsx(n,{onComplete:()=>t.start({duration:5e3})})},A=()=>e.jsx(n,{otp:!0}),z=()=>e.jsx(n,{mask:!0}),L=()=>e.jsxs(n,{children:[e.jsx(o,{}),e.jsx(o,{}),e.jsx(o,{}),e.jsx(o,{})]}),N=()=>e.jsx(n,{placeholder:"💩"}),H=()=>{const{page:t}=Sn(),[a,c]=p.useState(""),l=()=>t.start({duration:5e3});return e.jsx(n,{value:a,onChange:c,onComplete:l})},J=()=>e.jsx(n,{manageFocus:!1}),U=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isDisabled:!0}),e.jsxs(n,{children:[e.jsx(o,{isDisabled:!0}),e.jsx(o,{isDisabled:!0}),e.jsx(o,{isDisabled:!0}),e.jsx(o,{isDisabled:!0})]}),e.jsx(S,{isDisabled:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e.jsx(n,{})})]}),G=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isReadOnly:!0}),e.jsxs(n,{children:[e.jsx(o,{isReadOnly:!0}),e.jsx(o,{isReadOnly:!0}),e.jsx(o,{isReadOnly:!0}),e.jsx(o,{isReadOnly:!0})]}),e.jsx(S,{isReadOnly:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e.jsx(n,{})})]}),X=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isInvalid:!0}),e.jsxs(n,{children:[e.jsx(o,{isInvalid:!0}),e.jsx(o,{isInvalid:!0}),e.jsx(o,{isInvalid:!0}),e.jsx(o,{isInvalid:!0})]}),e.jsx(S,{isInvalid:!0,label:"Please one-time password",helperMessage:"Just sent you a one-time password to your e-mail address.",errorMessage:"one-time password is required.",children:e.jsx(n,{})})]}),$=()=>{var g;const{control:t,handleSubmit:a,watch:c,formState:{errors:l}}=fn(),d=u=>console.log("submit:",u);return console.log("watch:",c()),e.jsxs(Cn,{as:"form",onSubmit:a(d),children:[e.jsx(S,{isInvalid:!!l.pinInput,label:"Token",errorMessage:(g=l.pinInput)==null?void 0:g.message,children:e.jsx(xn,{name:"pinInput",control:t,rules:{required:{value:!0,message:"This is required."},minLength:{value:4,message:"This is required."}},render:({field:u})=>e.jsx(n,{...u})})}),e.jsx(yn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},K=()=>{var u;const t={pinInput:"5"},{control:a,handleSubmit:c,watch:l,formState:{errors:d}}=fn({defaultValues:t}),g=f=>console.log("submit:",f);return console.log("watch:",l()),e.jsxs(Cn,{as:"form",onSubmit:c(g),children:[e.jsx(S,{isInvalid:!!d.pinInput,label:"Token",errorMessage:(u=d.pinInput)==null?void 0:u.message,children:e.jsx(xn,{name:"pinInput",control:a,rules:{required:{value:!0,message:"This is required."},minLength:{value:4,message:"This is required."}},render:({field:f})=>e.jsx(n,{...f})})}),e.jsx(yn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var pe,ge,Ie;R.parameters={...R.parameters,docs:{...(pe=R.parameters)==null?void 0:pe.docs,source:{originalSource:`() => {
  return <PinInput />;
}`,...(Ie=(ge=R.parameters)==null?void 0:ge.docs)==null?void 0:Ie.source}}};var he,fe,xe;k.parameters={...k.parameters,docs:{...(he=k.parameters)==null?void 0:he.docs,source:{originalSource:`() => {
  return <>
      <PinInput size="xs" />
...
}`,...(xe=(fe=k.parameters)==null?void 0:fe.docs)==null?void 0:xe.source}}};var je,Pe,be;q.parameters={...q.parameters,docs:{...(je=q.parameters)==null?void 0:je.docs,source:{originalSource:`() => {
  return <>
...
}`,...(ve=(we=B.parameters)==null?void 0:we.docs)==null?void 0:ve.source}}};var De,Ve,Me;T.parameters={...T.parameters,docs:{...(De=T.parameters)==null?void 0:De.docs,source:{originalSource:`() => {
  return <>
      <PinInput defaultValue="1234" />

      <PinInput defaultValue="123" />
    </>;
}`,...(Me=(Ve=T.parameters)==null?void 0:Ve.docs)==null?void 0:Me.source}}};var Re,ke,qe;E.parameters={...E.parameters,docs:{...(Re=E.parameters)==null?void 0:Re.docs,source:{originalSource:`() => {
  return <>
      <PinInput />
...
}`,...(qe=(ke=E.parameters)==null?void 0:ke.docs)==null?void 0:qe.source}}};var Oe,Be,Te;_.parameters={..._.parameters,docs:{...(Oe=_.parameters)==null?void 0:Oe.docs,source:{originalSource:`() => {
  const {
    page
  } = useLoading();
...
}`,...($e=(Xe=N.parameters)==null?void 0:Xe.docs)==null?void 0:$e.source}}};var Ke,We,Qe;H.parameters={...H.parameters,docs:{...(Ke=H.parameters)==null?void 0:Ke.docs,source:{originalSource:`() => {
  const {
    page
  } = useLoading();
...
}`,...(Qe=(We=H.parameters)==null?void 0:We.docs)==null?void 0:Qe.source}}};var Ze,Ye,en;J.parameters={...J.parameters,docs:{...(Ze=J.parameters)==null?void 0:Ze.docs,source:{originalSource:`() => {
...
}`,...(hn=(In=K.parameters)==null?void 0:In.docs)==null?void 0:hn.source}}};const Cs=["basic","withSize","withVariant","withFields","withType","withDefaultValue","withBorderColor","withOnComplete","useOneTimePassword","maskingValue","customFields","customPlaceholder","customControl","disabledFocusManagement","isDisabled","isReadonly","isInvalid","reactHookForm","reactHookFormWithDefaultValue"];export{Cs as __namedExportsOrder,R as basic,H as customControl,L as customFields,N as customPlaceholder,Ss as default,J as disabledFocusManagement,U as isDisabled,X as isInvalid,G as isReadonly,z as maskingValue,$ as reactHookForm,K as reactHookFormWithDefaultValue,A as useOneTimePassword,E as withBorderColor,T as withDefaultValue,O as withFields,_ as withOnComplete,k as withSize,B as withType,q as withVariant};
