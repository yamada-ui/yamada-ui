...
The `RadioCard` is a [multi part component](/styled-system/theming/component-styles#multi-part-components).

:::note
`RadioCard` inherits the style from [Radio](/components/forms/radio).
:::
