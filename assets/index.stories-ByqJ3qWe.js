import{aD as a,j as l}from"./iframe-CJki5Sg_.js";import{u as e}from"./index-BITPRnsw.js";import{B as i}from"./box-Bo23cHRp.js";import{u as c}from"./use-breakpoint-BILLjcdf.js";import"./preload-helper-PPVm8Dsz.js";import"./use-breakpoint-value-DZPGX7JQ.js";import"./use-color-mode-value-B1jiSb0l.js";const g={title:"Hooks / useValue"},o=()=>{const{colorMode:r}=a(),t=c(),n=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),s=e(["whiteAlpha.800","blackAlpha.800"]);return l.jsxs(i,{bg:n,color:s,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',t,'", colorMode is "',r,'"']})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
