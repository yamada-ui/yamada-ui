...
::::tip
If you want to center content inside a container instead of pinning it to an edge, consider using [Center](/docs/components/center).
::::

::::tip
If you want to extend content beyond a container's bounds instead, consider using [Bleed](/docs/components/bleed).
::::
