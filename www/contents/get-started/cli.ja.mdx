...
| プロパティ                | 説明                                                                                             | デフォルト     |
| ------------------------- | ------------------------------------------------------------------------------------------------ | -------------- |
| `path`                    | 生成されるディレクトリのパス。                                                                   | `./ui`         |
| `monorepo`                | モノレポで生成します。                                                                           | `false`        |
| `jsx`                     | JSXファイルで生成します。                                                                        | `false`        |
| `theme.path`              | テーマが生成されるディレクトリのパス。                                                           | `./theme`      |
| `components.path`         | コンポーネントが生成されるディレクトリのパス。                                                   | `./components` |
| `components.overwrite`    | コンポーネントなどが追加されたときにローカルの既存のコンポーネントの参照先を更新します。         | `false`        |
| `components.dependents`   | コンポーネントを追加するときに依存されているコンポーネントも追加します。                         | `true`         |
| `components.dependencies` | コンポーネントを追加するときに依存しているコンポーネントも追加します。                           | `false`        |
| `hooks.path`              | フックが生成されるディレクトリのパス。                                                           | `./hooks`      |
| `hooks.overwrite`         | コンポーネントなどが追加されたときにローカルの既存のフックの参照先を更新します。                 | `false`        |
| `hooks.dependents`        | フックを追加するときに依存されているフックも追加します。                                         | `true`         |
| `hooks.dependencies`      | フックを追加するときに依存しているフックも追加します。                                           | `false`        |
| `providers.path`          | プロバイダーが生成されるディレクトリのパス。                                                     | `./providers`  |
| `providers.overwrite`     | コンポーネントなどが追加されたときにローカルの既存のプロバイダーの参照先を更新します。           | `false`        |
| `providers.dependents`    | プロバイダーを追加するときに依存されているプロバイダーも追加します。                             | `true`         |
| `providers.dependencies`  | プロバイダーを追加するときに依存しているプロバイダーも追加します。                               | `false`        |
| `format.configPath`       | [Prettier](https://prettier.io)が参照するコンフィグのパス。                                      | -              |
| `format.enabled`          | コンポーネントなどを追加・更新するときに[Prettier](https://prettier.io)の`--write`を実行します。 | `false`        |
| `lint.enabled`            | コンポーネントなどを追加・更新するときに[ESLint](https://eslint.org)の`--fix`を実行します。      | `false`        |
