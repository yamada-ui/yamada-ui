...
| ------------ | ---------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Moves the active data point to the next one while focus remains on the chart surface, and displays the tooltip.     | `withTooltip={true}` |
| `ArrowLeft`  | Moves the active data point to the previous one while focus remains on the chart surface, and displays the tooltip. | `withTooltip={true}` |
| `Enter`      | Toggles the tooltip display for the active data point.                                                    | `withTooltip={true}` |
...
| `svg`     | `tabIndex={0}`                     | Makes the chart surface focusable by keyboard users. |
