...
:::tip
Yamada UIでは、引き出し型のオーバーレイ向けに[Drawer](/docs/components/drawer)を提供しています。用途が[Drawer](/docs/components/drawer)に合う場合はそちらを検討してください。よりカスタムなスライド表現が必要な場合は`Slide`を使用できます。
:::
