...
1. Extract all entries from the [PR Review Anti-Patterns](/.agents/references/pr-review-anti-patterns/index.md) index into a list.
...
2. Delete the selected entry files from `.agents/references/pr-review-anti-patterns`, and remove them from the list in `.agents/references/pr-review-anti-patterns/index.md` as well.
