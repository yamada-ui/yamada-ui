...
import { MonitorDown as OriginalMonitorDown } from "lucide-react"
 ...
 */
export const MonitorDownIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalMonitorDown} {...props} />
))
