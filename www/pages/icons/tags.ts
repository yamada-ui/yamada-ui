export const TAGS: { [key: string]: string[] } = {
  ...
  BadgeQuestionMark: ["verified", "unverified", "help"],
  BadgeRussianRuble: [
    "discount",
    "offer",
    "sale",
  ...
  BowArrow: ["archer", "archery", "game", "war", "weapon"],
  Box: [
    "cube",
    "package",
    "container",
  ...
  FileSearch2: ["lost", "document", "find", "browser", "lens"],
  FileSliders: [
    "cogged",
    "gear",
    "mechanical",
  ...
  FlagTriangleLeft: ["report", "timeline", "marker", "pin"],
  FlagTriangleRight: ["report", "timeline", "marker", "pin"],
  Flame: [
    "fire",
    "lit",
    "burning",
  ...
  FunnelPlus: ["filter", "hopper", "add", "create", "new"],
  FunnelX: ["filter", "hopper", "remove", "delete"],
  GalleryHorizontal: [
    "carousel",
    "pictures",
    "images",
  ...
  GeorgianLari: ["currency", "money", "payment"],
  ...
  HeartMinus: ["unlike", "unfavorite", "remove", "damage", "ui & ux"],
  HeartOff: ["unlike", "dislike", "hate", "emotion"],
  HeartPlus: ["plus", "like", "favorite", "add", "health", "support"],
  HeartPulse: [
    "heartbeat",
    "pulse",
    "health",
  ...
  MailQuestionMark: ["email", "message", "letter", "delivery", "undelivered"],
  Mails: [
    "emails",
    "messages",
    "letters",
  ...
  MailSearch: ["email", "message", "letter", "search", "lens"],
  MailWarning: [
    "email",
    "message",
    "letter",
  ...
  MapPinPen: ["location", "waypoint", "marker", "drop", "edit"],
  MapPinPlus: [
    "location",
    "waypoint",
    "marker",
  ...
  PackageSearch: ["find", "product process", "lens"],
  ...
  RectangleCircle: ["compose", "keyboard", "key", "button"],
  RectangleEllipsis: [
    "login",
    "password",
    "authenticate",
  ...
  SaudiRiyal: ["currency", "money", "payment"],
  Save: ["floppy disk"],
  ...
  ToolCase: ["tools", "maintenance", "repair"],
  ...
  TurkishLira: ["currency", "money", "payment"],
  Turntable: [
    "record player",
    "gramophone",
    "stereo",
  ...
  WifiOff: ["disabled"],
  WifiPen: ["edit", "wifi", "pen", "change", "network"],
  WifiSync: [
    "connection",
    "signal",
    "wireless",
