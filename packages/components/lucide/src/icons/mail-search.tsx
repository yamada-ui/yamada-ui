...
import { MailSearch as OriginalMailSearch } from "lucide-react"
 ...
 */
export const MailSearchIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalMailSearch} {...props} />
))
