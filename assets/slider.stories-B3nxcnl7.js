...
}`,...(Lr=(Hr=de.parameters)==null?void 0:Hr.docs)==null?void 0:Lr.source}}};var qr,Ur,Wr;me.parameters={...me.parameters,docs:{...(qr=me.parameters)==null?void 0:qr.docs,source:{originalSource:`() => {
  const [value, onChange] = useState<number>(50);
  return <>
      <Text>Value: {value}</Text>
      <Slider value={value} onChange={onChange} />
    </>;
}`,...(Wr=(Ur=me.parameters)==null?void 0:Ur.docs)==null?void 0:Wr.source}}};var Kr,Xr,Yr;he.parameters={...he.parameters,docs:{...(Kr=he.parameters)==null?void 0:Kr.docs,source:{originalSource:`() => {
  const [value, onChange] = useState<number>(50);
...
}`,...(rn=(en=Se.parameters)==null?void 0:en.docs)==null?void 0:rn.source}}};const Wt=["basic","withDefaultValue","withSize","withColorScheme","withOrientation","withReversed","withMinMax","withStep","withFocusThumbOnChange","withMark","withTooltip","isDisabled","isReadonly","isInvalid","customColor","customThumb","customMark","customControl","onChangeStart","onChangeEnd","reactHookForm"];export{Wt as __namedExportsOrder,Y as basic,ue as customColor,me as customControl,de as customMark,ce as customThumb,Ut as default,le as isDisabled,ie as isInvalid,se as isReadonly,pe as onChangeEnd,he as onChangeStart,Se as reactHookForm,Q as withColorScheme,G as withDefaultValue,te as withFocusThumbOnChange,ae as withMark,re as withMinMax,Z as withOrientation,ee as withReversed,J as withSize,ne as withStep,oe as withTooltip};
