...
| `PaginationItem` <Tag>Internal</Tag> | `aria-label`        | `"Go to first page"`, `"Go to previous page"`, `"Go to next page"`, `"Go to last page"` is set. If `page` is set to page, `"Go to page ${page}"` is set. |
