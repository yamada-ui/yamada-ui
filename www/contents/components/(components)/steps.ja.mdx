...
| `Enter`, `Space` | フォーカスされたトリガーをアクティブにし、ステップを移動します。 | -    |

### ARIAロールと属性

| コンポーネントと要素      | ロールと属性          | 使い方                                              |
| ------------------------- | --------------------- | --------------------------------------------------- |
| `li.ui-steps__item`       | `aria-current="step"` | 現在のステップを示します。                          |
|                           | `aria-labelledby`     | 関連する`div.ui-steps__content`の`id`を設定します。 |
| `div.ui-steps__separator` | `role="separator"`    | セパレーターであることを示します。                  |
