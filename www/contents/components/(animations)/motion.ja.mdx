...
:::note
`Motion`は、内部で[Motion](https://motion.dev)を使用しています。さらに詳しくコンポーネントの機能を知りたい場合は、[React motion component](https://motion.dev/docs/react-motion-component)をご覧ください。
:::
...
:::note
バリアントのアニメーションをもっと知りたい場合は、[Variants](https://motion.dev/docs/react-animation#variants)をご覧ください。
:::
...
[ホバー](#hover)・[クリック・タップ](#clicktap)・[フォーカス](#focus)を検出し、アニメーションを実行することができます。
...
:::note
ホバーのアニメーションをもっと知りたい場合は、[React hover animation guide](https://motion.dev/docs/react-hover-animation)をご覧ください。
:::
...
:::note
クリック・タップのアニメーションをもっと知りたい場合は、[Tap](https://motion.dev/docs/react-gestures#tap)をご覧ください。
:::
...
:::note
フォーカスのアニメーションをもっと知りたい場合は、[Focus](https://motion.dev/docs/react-gestures#focus)をご覧ください。
:::
...
:::note
ドラッグのアニメーションをもっと知りたい場合は、[React drag animation guide](https://motion.dev/docs/react-drag)をご覧ください。
:::
