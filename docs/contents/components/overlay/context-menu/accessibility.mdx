...
| -------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `ContextMenuTrigger` | `id`                    | `id` used to associate with `MenuList`.                                                                                 |
...
|                      | `id`                    | `id` used to associate with `ContextMenuTrigger` or `MenuItemButton`.                                                   |
|                      | `tabindex`              | Set to `"-1"`.                                                                                                          |
|                      | `aria-activedescendant` | Set to the `id` of the focused item.                                                                                    |
|                      | `aria-labelledby`       | Set to the `id` of the related `ContextMenuTrigger` or `MenuItemButton`.                                                |
