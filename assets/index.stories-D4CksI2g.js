import{j as e,T as f,Q as d}from"./iframe-CFB1XGwV.js";import{u as g}from"./index-BgM76Gqp.js";import"./preload-helper-C1FmrZbK.js";const h={title:"Hooks / useBoolean"},o=()=>{const[t,{toggle:s}]=g();return e.jsxs(e.Fragment,{children:[e.jsxs(f,{children:["state: ",String(t)]}),e.jsx(d,{onClick:s,children:"Click me to toggle the boolean value"})]})},n=()=>{const[t,{off:s,on:i}]=g();return e.jsx(f,{w:"full",onMouseEnter:i,onMouseLeave:s,children:t?"I am hovered":"Put mouse over me please"})};var r,a,l;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const [flg, {
    toggle
  }] = useBoolean();
  return <>
