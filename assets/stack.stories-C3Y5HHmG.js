import{p as Z,r as c,aN as M,ag as $,m as D,j as e,s as L,t as T,v as _,w as N,aZ as O,V as E,Y as w}from"./iframe-CDgLy_ZK.js";import{H as R}from"./h-stack-D_HrVrPH.js";import{B as l}from"./box-CyxLdSlX.js";import{S as z}from"./separator-BB18HEzg.js";import{F as k}from"./for-C8t6YAB3.js";import"./preload-helper-PPVm8Dsz.js";const Y=Z({base:{gap:"lg",overflow:"hidden",position:"relative"}}),{withContext:q}=N("stack--depth",Y),A=q(({css:t,children:n,direction:r="end",fit:x=!0,reverse:o=!1,startIndex:H=0,...v})=>{r==="start-center"&&(r="start"),r==="end-center"&&(r="end");const V=c.useRef(new Map),[W,I]=c.useState({height:0,width:0}),F=c.useCallback(s=>r.startsWith("start")?{[o?"top":"bottom"]:s}:r.startsWith("end")?{[o?"bottom":"top"]:s}:{[o?"bottom":"top"]:0},[r,o]),y=c.useCallback(s=>r.endsWith("-start")?{[o?"left":"right"]:s}:r.endsWith("-end")?{[o?"right":"left"]:s}:{[o?"right":"left"]:0},[r,o]),P=c.useMemo(()=>M(n).map((a,d)=>{const p=c.createRef();V.current.set(d,p);const i=a.key??d,f=H+d,h=`calc({space} * ${d})`,m={position:"absolute",zIndex:f,...F(h),...y(h)},u={...a.props,ref:D(a.props.ref,p),css:$(a.props.css,m)},j=c.cloneElement(a,u);return e.jsx(c.Fragment,{children:j},i)}),[n,H,F,y]);return c.useEffect(()=>{if(!x)return;let s=r.endsWith("-start"),g=r.startsWith("start"),a=0,d=0;o&&(s=!s,g=!g);for(const p of V.current.values()){if(!p.current)continue;let{offsetHeight:i,offsetLeft:f,offsetParent:h,offsetTop:m,offsetWidth:u}=p.current;h&&(s&&(f=(h?.offsetWidth??0)-f-u),g&&(m=(h?.offsetHeight??0)-m-i),u+=f,i+=m,u>a&&(a=u),i>d&&(d=i))}I({height:d,width:a})},[P,r,o,x]),e.jsx(L.div,{css:t,minHeight:x?`${W.height}px`:void 0,minWidth:x?`${W.width}px`:void 0,...v,children:P})})(void 0,t=>{const n=T(t.css,{gap:"space"});return{..._(t,{gap:"space"}),css:n}}),ee={component:O,title:"Components / Stack"},b=()=>e.jsx(E,{children:e.jsx(k,{each:["info","success","warning","error"],children:(t,n)=>e.jsx(l,{bg:t,color:"white",p:"md",rounded:"l2",children:"Box"},n)})}),B=()=>e.jsx(R,{children:e.jsx(k,{each:["info","success","warning","error"],children:(t,n)=>e.jsx(l,{bg:t,color:"white",p:"md",rounded:"l2",children:"Box"},n)})}),C=()=>e.jsx(k,{each:["end","start","center-end","center-start","end-start","end-end","start-start","start-end"],children:t=>e.jsx(A,{direction:t,children:["info","success","warning","error"].map((n,r)=>e.jsx(l,{bg:n,color:"white",p:"md",rounded:"l2",children:"Box"},r))},t)}),S=()=>e.jsxs(e.Fragment,{children:[e.jsxs(E,{separator:e.jsx(z,{}),children:[e.jsx(l,{bg:"info",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"success",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"warning",color:"white",p:"md",rounded:"l2",children:"Box"}),e.jsx(l,{bg:"error",color:"white",p:"md",rounded:"l2",children:"Box"})]}),e.jsxs(R,{h:"2xs",separator:e.jsx(z,{}),children:[e.jsx(w,{bg:"info",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"success",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"warning",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"}),e.jsx(w,{bg:"error",color:"white",h:"full",p:"md",rounded:"l2",children:"Center"})]})]});b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
  return <VStack>
