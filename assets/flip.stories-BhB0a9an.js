import{j as e}from"./jsx-runtime-CfatFE5O.js";import{r as w}from"./index-ClcD9ViR.js";import{u as ze}from"./index-CUCM51Cx.js";import{m as Oe}from"./forward-ref-2BKBy0Yi.js";import{a as be}from"./use-component-style-B--WxH8d.js";import{o as _e}from"./theme-provider-r-UN7Xzc.js";import{u as Ie,c as _,d as H}from"./factory-D0ba2aB7.js";import{m as I}from"./factory-COvmBIaQ.js";import{A as x,C as f}from"./cherry-CPrHlRb-.js";import{C as t}from"./center-B5IQJJLi.js";import{T as ke}from"./text-BB5_0k3k.js";import{A as Re}from"./avatar-DnlWzTKy.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./proxy-DYgA1A03.js";import"./icon-47ftZrjE.js";import"./use-var-CTLjK8Sl.js";import"./forward-ref-D13m8o2p.js";import"./createLucideIcon-C_T9K6g-.js";import"./use-image-DasZRklz.js";const Ae={enter:({ident:s,orientation:n,visible:i})=>({[n==="horizontal"?"rotateY":"rotateX"]:s==="from"?i?180:0:i?0:180}),exit:({ident:s,orientation:n})=>({[n==="horizontal"?"rotateY":"rotateX"]:s==="from"?0:180})},P={animate:"enter",initial:"exit",variants:Ae},r=Oe((s,n)=>{const[i,ce]=w.useState({}),y=w.useRef(null),S=w.useRef(null),[l,pe]=be("Flip",s),{className:F,defaultValue:xe="from",delay:fe=0,isDisabled:me,disabled:k=me,duration:de=.4,from:ue,isReadOnly:he,orientation:c="horizontal",readOnly:R=he,to:ge,transition:je={},value:Ce,onChange:ve,...we}=_e(pe),[A,ye]=ze({defaultValue:xe,value:Ce,onChange:ve}),B=A==="to",Se={h:i.height?`${i.height}px`:"auto",w:i.width?`${i.width}px`:"auto",...l.container},D={delay:fe,duration:de,...je},Fe=()=>{R||ye(p=>p==="from"?"to":"from")};return Ie(()=>{const p=y.current,z=S.current;if(!p||!z)return;const O=p.offsetWidth,b=p.offsetHeight,$=z.offsetWidth,W=z.offsetHeight;(O!==$||b!==W)&&console.warn(`Dimensions do not match:
