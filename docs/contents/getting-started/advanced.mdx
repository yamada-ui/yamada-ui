...
In this guide, we will explain the applications of the concepts and features described in [Learning the Basics](/getting-started/basics).

## Applying Themes

Yamada UI has more theme utilities than other UI libraries.

In [Learning the Basics](/getting-started/basics#about-themes), you learned to use `extendTheme` for theme inheritance. Here, you will learn how to change the `colorScheme` set in each component and how to get the value of tokens defined in the theme.
...
This is suitable for setting the style of components of libraries other than Yamada UI.
...
In [Learning the Basics](/getting-started/basics#about-styles), you learned about `Style props` and shorthand. Here, you will learn about how to change the rendering of elements and the importance of the Yamada UI style system.

### About `as`

All components of Yamada UI can `assert`.

`Assertion` is a feature that allows you to pass HTML tags or other components to a component, rendering it as a different element or component while retaining the original component's style and behavior.

For example, suppose you need to change the `Button` to the HTML tag `a` while retaining its style and behavior.

```tsx
<Button as='a' href='https://github.com/hirotomoyamada/yamada-ui' target='_blank'>
  GitHub
</Button>
```
...
:::note status=warning
There are hardly any cases where `sx` and `css` are necessary. As long as you understand the existence of `sx` and `css` in the [Order](/getting-started/advanced#order) explained in the next section, there is no problem.
:::
...
The components of Yamada UI accept several `CSS` objects and have a set order.
...
:::note
If you want to learn more about `Style props` or shortcodes, please see [here](/styled-system/style-props).
:::

## Application of Responsiveness

In [Learning the Basics](/getting-started/basics#about-responsiveness), you learned how to set up responsive styles. Here, you will learn how to get the current breakpoint and useful utilities.
...
In [Learning the Basics](/getting-started/basics#about-color-mode), you learned how to set the style of color mode. Here, you will learn how to get the current color mode and useful utilities.
...
:::note
If you want to learn more about color modes, please see [here](/styled-system/color-mode).
:::

## Application of Animation

In [Learning the Basics](/getting-started/basics#about-animation), you learned about the `useAnimation` and `Motion` components. Here, you will learn about setting multiple animations with `useAnimation` and setting new dynamic animations with `useDynamicAnimation`.

### Using Multiple Animations with `useAnimation`

`useAnimation` can also accept an array.
...
Why not learn more about Yamada UI by studying its themes and components? 😎
