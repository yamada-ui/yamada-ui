...
:::tip
For an overview, see the [responsive design documentation](/docs/styling/responsive-design).
:::
...
The breakpoints defined in the theme are in the [breakpoints.ts](https://github.com/yamada-ui/yamada-ui/blob/main/packages/react/src/theme/tokens/breakpoints.ts).
...
:::warning
Before running the following commands, you need to install `@yamada-ui/cli` and execute the `init` command. For more details, please see the [CLI documentation](/docs/get-started/cli).
:::
