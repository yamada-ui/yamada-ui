import{j as e}from"./jsx-runtime-CfatFE5O.js";import{r as l}from"./index-ClcD9ViR.js";import{u as xn,C as Pn}from"./index.esm-CEdvtQ_U.js";import{u as Tn}from"./index-Hr0uPYc7.js";import{c as En}from"./index-CzwbnnDs.js";import{c as jn,f as zn,d as F}from"./form-control-DiJsSBY_.js";import{p as Ln,Z as Nn,A as Hn,h as y,q as Jn,b as bn,c as Fn,a as Un}from"./factory-Db31n_eg.js";import{f as Cn}from"./forward-ref-D13m8o2p.js";import{a as Gn}from"./use-component-style-5HWcAXul.js";import{o as Wn}from"./theme-provider-C-TvIt_J.js";import{u as Sn}from"./loading-provider-CQ__EqHq.js";import{V as yn}from"./stack-CE6YRnd8.js";import{B as wn}from"./button-BDTEGqqa.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-olb3wru2.js";import"./Combination-CkmEMpJG.js";import"./loading-BptEEwSR.js";import"./icon-BfxegGWg.js";import"./use-var-BbJRqi2C.js";import"./memo-CTsy6qLS.js";import"./index-r0TXmcNt.js";import"./proxy-Bq47Fk52.js";import"./portal-C11kezrD.js";import"./index-ZuzByk-F.js";import"./factory-BRZ9AYsk.js";import"./use-ripple-shOr3g-0.js";const me=o=>o==null?void 0:o.split(""),pe=(o,u)=>(u==="alphanumeric"?/^[a-zA-Z0-9]+$/i:/^[0-9]+$/).test(o),[Xn,$n]=Ln({name:"PinInputContext",errorMessage:`PinInputContext returned is 'undefined'. Seems you forgot to wrap the components in "<PinInput />"`}),{DescendantsContextProvider:Kn,useDescendant:Zn,useDescendants:Qn}=En(),n=Cn(({errorBorderColor:o,focusBorderColor:u,...p},g)=>{const[I,f]=Gn("PinInput",{errorBorderColor:o,focusBorderColor:u,...p});let{id:d,type:m="number",className:vn,autoFocus:Q,children:Vn,defaultValue:Dn,items:kn=4,manageFocus:C=!0,mask:Y,otp:ee=!1,placeholder:ne="○",value:Rn,onChange:U,onComplete:h,...Mn}=jn(Wn(f));const[{"aria-readonly":Yn,disabled:se,readOnly:G,...W},_n]=Nn(Mn,zn),qn=l.useId();d??(d=qn);const a=Qn(),[re,X]=l.useState(!0),[te,oe]=l.useState(-1);l.useEffect(()=>{if(!Q)return;const s=a.firstValue();s&&requestAnimationFrame(()=>s.node.focus())},[Q,a]);const[P,S]=Tn({defaultValue:me(Dn)||[],value:me(Rn),onChange:s=>U==null?void 0:U(s.join(""))}),ae=l.useCallback(s=>{if(!re||!C)return;const r=a.nextValue(s,void 0,!1);r&&requestAnimationFrame(()=>r.node.focus())},[a,re,C]),$=l.useCallback((s,r)=>{const i=s==="next"?a.nextValue(r,void 0,!1):a.prevValue(r,void 0,!1);if(!i)return;const c=i.node.value.length;requestAnimationFrame(()=>{i.node.focus(),i.node.setSelectionRange(0,c)})},[a]),j=l.useCallback((s,r,i=!0)=>{var b;let c=[...P];c[r]=s,S(c),c=c.filter(Boolean),s!==""&&c.length===a.count()?(h==null||h(c.join("")),(b=a.value(r))==null||b.node.blur()):i&&ae(r)},[P,S,a,h,ae]),ie=l.useCallback((s,r)=>{let i=r;return s!=null&&s.length&&(s.startsWith(r.charAt(0))?i=r.charAt(1):s.startsWith(r.charAt(1))&&(i=r.charAt(0))),i},[]),ue=l.useCallback(s=>({target:r})=>{var b;const i=r.value,c=P[s],x=ie(c,i);if(x===""){j("",s);return}if(i.length>2){if(!pe(i,m))return;const Z=i.split("").filter((es,Bn)=>Bn<a.count());S(Z),Z.length===a.count()&&(h==null||h(Z.join("")),(b=a.value(s))==null||b.node.blur())}else pe(x,m)&&j(x,s),X(!0)},[a,ie,h,j,S,m,P]),le=l.useCallback(s=>r=>{if(!C)return;const c={ArrowLeft:()=>{r.preventDefault(),$("prev",s)},ArrowRight:()=>{r.preventDefault(),$("next",s)},Backspace:()=>{if(r.target.value===""){const x=a.prevValue(s,void 0,!1);if(!x)return;j("",s-1,!1),x.node.focus(),X(!0)}else X(!1)}}[r.key];c&&c()},[a,$,C,j]),ce=l.useCallback(s=>()=>oe(s),[]),de=l.useCallback(()=>oe(-1),[]),On=l.useCallback(({index:s,...r})=>({type:Y?"password":m==="number"?"tel":"text",disabled:se,inputMode:m==="number"?"numeric":"text",readOnly:G,...W,...Hn(r),id:`${d}-${s}`,autoComplete:ee?"one-time-code":"off",placeholder:te===s&&!G&&!r.readOnly?"":ne,value:P[s]||"",onBlur:y(r.onBlur,de),onChange:y(r.onChange,ue(s)),onFocus:y(r.onFocus,ce(s)),onKeyDown:y(r.onKeyDown,le(s))}),[m,Y,W,d,P,ue,le,ce,de,ee,te,se,G,ne]),An={alignItems:"center",display:"flex",...I.container};let K=Jn(Vn);if(!K.length)for(let s=0;s<kn;s++)K.push(e.jsx(t,{},s));return e.jsx(Kn,{value:a,children:e.jsx(Xn,{value:{styles:I,getInputProps:On},children:e.jsx(bn.div,{ref:g,className:Fn("ui-pin-input",vn),role:"group",__css:An,...W,..._n,children:K})})})});n.displayName="PinInput";n.__ui__="PinInput";const t=Cn(({className:o,...u},p)=>{const{styles:g,getInputProps:I}=$n(),{index:f,register:d}=Zn();u=jn(u);const m={...g.field};return e.jsx(bn.input,{className:Fn("ui-pin-input__field",o),...I({...u,ref:Un(d,p),index:f}),__css:m})});t.displayName="PinInputField";t.__ui__="PinInputField";const vs={component:n,title:"Components / Forms / PinInput"},w=()=>e.jsx(n,{}),v=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{size:"xs"}),e.jsx(n,{size:"sm"}),e.jsx(n,{size:"md"}),e.jsx(n,{size:"lg"})]}),V=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{variant:"outline"}),e.jsx(n,{variant:"filled"}),e.jsx(n,{variant:"flushed"}),e.jsx(n,{variant:"unstyled"})]}),D=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{items:3}),e.jsx(n,{items:4}),e.jsx(n,{items:5}),e.jsx(n,{items:6})]}),k=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{type:"alphanumeric"})]}),R=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{defaultValue:"1234"}),e.jsx(n,{defaultValue:"123"})]}),M=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{}),e.jsx(n,{focusBorderColor:"green.500"}),e.jsx(n,{errorBorderColor:"orange.500",isInvalid:!0})]}),_=()=>{const{page:o}=Sn();return e.jsx(n,{onComplete:()=>o.start({duration:5e3})})},q=()=>e.jsx(n,{otp:!0}),O=()=>e.jsx(n,{mask:!0}),A=()=>e.jsxs(n,{children:[e.jsx(t,{}),e.jsx(t,{}),e.jsx(t,{}),e.jsx(t,{})]}),B=()=>e.jsx(n,{placeholder:"💩"}),T=()=>{const{page:o}=Sn(),[u,p]=l.useState(""),g=()=>o.start({duration:5e3});return e.jsx(n,{value:u,onChange:p,onComplete:g})},E=()=>e.jsx(n,{manageFocus:!1}),z=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isDisabled:!0}),e.jsxs(n,{children:[e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0}),e.jsx(t,{isDisabled:!0})]}),e.jsx(F,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isDisabled:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isReadOnly:!0}),e.jsxs(n,{children:[e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0}),e.jsx(t,{isReadOnly:!0})]}),e.jsx(F,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isReadOnly:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),N=()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{isInvalid:!0}),e.jsxs(n,{children:[e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0}),e.jsx(t,{isInvalid:!0})]}),e.jsx(F,{errorMessage:"one-time password is required.",helperMessage:"Just sent you a one-time password to your e-mail address.",isInvalid:!0,label:"Please one-time password",children:e.jsx(n,{})})]}),H=()=>{var f;const{control:o,formState:{errors:u},handleSubmit:p,watch:g}=xn(),I=d=>console.log("submit:",d);return console.log("watch:",g()),e.jsxs(yn,{as:"form",onSubmit:p(I),children:[e.jsx(F,{errorMessage:(f=u.pinInput)==null?void 0:f.message,isInvalid:!!u.pinInput,label:"Token",children:e.jsx(Pn,{name:"pinInput",control:o,render:({field:d})=>e.jsx(n,{...d}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(wn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},J=()=>{var d;const o={pinInput:"5"},{control:u,formState:{errors:p},handleSubmit:g,watch:I}=xn({defaultValues:o}),f=m=>console.log("submit:",m);return console.log("watch:",I()),e.jsxs(yn,{as:"form",onSubmit:g(f),children:[e.jsx(F,{errorMessage:(d=p.pinInput)==null?void 0:d.message,isInvalid:!!p.pinInput,label:"Token",children:e.jsx(Pn,{name:"pinInput",control:u,render:({field:m})=>e.jsx(n,{...m}),rules:{minLength:{message:"This is required.",value:4},required:{message:"This is required.",value:!0}}})}),e.jsx(wn,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var ge,Ie,fe;w.parameters={...w.parameters,docs:{...(ge=w.parameters)==null?void 0:ge.docs,source:{originalSource:`() => {
  return <PinInput />;
