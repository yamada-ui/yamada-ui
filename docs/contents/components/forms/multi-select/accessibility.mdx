...
The `MultiSelect` follows the [WAI-ARIA - Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/) for accessibility.

If you are not using `FormControl`, set `aria-label` or `aria-labelledby` to `MultiSelect`.
...
| -------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------ |
| `MultiSelectField` <Tag>Internal</Tag> | `role="combobox"`         | Indicates that this is a combobox.                                                   |
...
| `SelectClearIcon` <Tag>Internal</Tag>  | `role="button"`           | Indicates that this is a button.                                                     |
|                                        | `aria-label`              | `"Clear value"` is set.                                                              |
| `MultiSelectList` <Tag>Internal</Tag>  | `role="listbox"`          | Indicates that this is a listbox.                                                    |
