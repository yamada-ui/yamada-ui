...
| ----------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `AccordionButton` | `role="heading"`       | Indicates that it is a heading.                                                                                                                                                                                                |
...
|                   | `id`                   | Used to associate with `AccordionButton`.                                                                                                                                                                                      |
|                   | `aria-labelledby`      | Sets the `id` of the associated `AccordionButton`.                                                                                                                                                                             |
