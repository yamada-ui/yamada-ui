...
This has changed the margins throughout the application.
...
:::note
If you want to learn more about themes, please check [Customize the Theme](/styled-system/theming/customize-theme) and [Component Style](/styled-system/theming/component-style).
:::
...
:::note status=warning
`custom` is not set in the [default config](/styled-system/configure/default-config). If you want to set up custom loading, please check [here](/styled-system/loading).
:::
...
"I'll be waiting in [Learn in Application](/getting-started/advanced) next///"😘
