...
<VStack gap='md'>
  <Text fontSize='2xl' noOfLines={3}>
    ...
    "Weekly Shonen Jump" (Shueisha) from issue 51 in 1984 to issue 25 in 1995. The story revolves
    around the treasure "Dragon Ball", which grants any one wish if all seven scattered balls around
    the world are collected, and the protagonist Goku (Son Goku), depicting "adventure", "dream",
    "battle", "friendship", and so on in a long manga.
  </Text>
...
<Text
  ...
  bgClip='text'
>
  Not bad, Satan! You might really be the savior of the world!
</Text>
```
