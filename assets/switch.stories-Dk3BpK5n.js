import{d as re,aK as ne,r as s,a as f,h as w,m as oe,aF as ae,f as se,j as e,s as W,al as ce,C as G,G as k,T as ie,V as X}from"./iframe-BbB59fLB.js";import{P as V}from"./props-table-CLQ6uJWO.js";import{u as J,C as N}from"./index.esm-CXfDgdRt.js";import{u as le}from"./index-T2y2OLC7.js";import{u as ue}from"./index-vFGel0G-.js";import{u as de}from"./use-field-props-vL0R9j3R.js";import{F as Q}from"./for-JwY7aMwm.js";import{H as he}from"./h-stack-DSY2l8Q8.js";import{B as U}from"./button-C7yiHaiH.js";import{S as me,M as Se}from"./sun-icon-Dt11yGnz.js";import"./grid-W1UnxTpU.js";import"./grid-item-Dq6QrI7D.js";import"./flex-mIT1fSUh.js";import"./heading-DTYqldnT.js";import"./use-ripple-DxxJnXZN.js";import"./rings-YRmwo_R-.js";import"./createLucideIcon-BfIMf7K-.js";const pe=re({base:{label:{userSelect:"none"},root:{alignItems:"center",cursor:"pointer",display:"inline-flex",gap:"2",_readOnly:{layerStyle:"readOnly",pointerEvents:"none"},_disabled:{layerStyle:"disabled"}},thumb:{alignItems:"center",bg:"white",display:"inline-flex",justifyContent:"center",position:"absolute",rounded:"inherit",transitionDuration:"fast",transitionProperty:"background, transform",_checked:{transform:"translateX(100%)"}},track:{"--focus-ring-color":"{colorScheme.outline}",alignItems:"center",bg:"bg.muted",boxSizing:"content-box",display:"inline-flex",flexShrink:0,position:"relative",rounded:"full",transitionDuration:"fast",transitionProperty:"background",_peerFocusVisible:{...ne.outline}}},variants:{thin:{thumb:{boxShadow:"2xl",_checked:{bg:"colorScheme.solid"}},track:{"--focus-ring-offset":"4px",_checked:{bg:["colorScheme.muted","colorScheme.subtle"]}}},thick:{thumb:{_checked:{bg:"colorScheme.contrast"}},track:{p:"1",_checked:{bg:"colorScheme.solid"}}}},sizes:{sm:{label:{fontSize:"sm"},thumb:{boxSize:"3"},track:{w:"6"}},md:{label:{fontSize:"md"},thumb:{boxSize:"4"},track:{w:"8"}},lg:{label:{fontSize:"lg"},thumb:{boxSize:"5"},track:{w:"10"}}},props:{reverse:{false:{root:{flexDirection:"row"}},true:{root:{flexDirection:"row-reverse"}}},shape:{circle:{track:{rounded:"full"}},rounded:{thumb:{rounded:"l1"},track:{rounded:"l2"}},square:{track:{rounded:"0"}}}},compounds:[{css:{track:{h:"3"}},size:"sm",variant:"thick"},{css:{track:{h:"4"}},size:"md",variant:"thick"},{css:{track:{h:"5"}},size:"lg",variant:"thick"},{css:{track:{h:"2"}},size:"sm",variant:"thin"},{css:{track:{h:"3"}},size:"md",variant:"thin"},{css:{track:{h:"4"}},size:"lg",variant:"thin"}],defaultProps:{size:"md",variant:"thick",shape:"circle"}}),ke=(t={})=>{const r=s.useId(),{props:{id:o=r,ref:d,name:i,checked:u,checkOnEnter:h=!0,defaultChecked:O=!1,disabled:S,readOnly:p,required:b,value:H,onChange:B,...E},ariaProps:L,dataProps:l,eventProps:I}=de(t),m=!(p||S),M=s.useRef(null),[c,q]=ue({defaultValue:O,value:u}),K=s.useCallback(n=>{if(!m)return n.preventDefault();q(n.target.checked),B?.(n)},[B,q,m]),A=s.useCallback(n=>{m&&h&&n.key==="Enter"&&M.current?.click()},[m,h]),Y=s.useCallback((n={})=>({...l,htmlFor:o,"data-checked":f(c),...E,...n}),[c,E,o,l]),Z=s.useCallback((n={})=>({"data-checked":f(c),...l,...n}),[c,l]),$=s.useCallback((n={})=>({"data-checked":f(c),...l,...n}),[c,l]),ee=s.useCallback((n={})=>({...L,...l,id:o,type:"checkbox",name:i,style:ae.style,checked:c,disabled:S,readOnly:p,required:b,role:"switch",tabIndex:m?0:-1,value:H,...n,ref:oe(M,n.ref,d),onBlur:w(I.onBlur,n.onBlur),onChange:w(n.onChange,K),onFocus:w(I.onFocus,n.onFocus),onKeyDown:w(n.onKeyDown,A)}),[L,l,o,i,c,S,p,b,m,H,d,I,K,A]),te=s.useCallback((n={})=>({...l,"data-checked":f(c),...n}),[l,c]);return{checked:c,getInputProps:ee,getLabelProps:te,getRootProps:Y,getThumbProps:$,getTrackProps:Z}},{withContext:_,withProvider:be}=se("switch",pe),a=be(({children:t,icon:r,inputProps:o,labelProps:d,...i})=>{const{checked:u,getInputProps:h,getLabelProps:O,getRootProps:S,getThumbProps:p,getTrackProps:b}=ke(i);return e.jsxs(W.label,{...S(),children:[e.jsx(W.input,{"data-peer":!0,...h(o)}),e.jsx(we,{...b(),children:e.jsx(fe,{...p(),children:r&&ce(r)&&"on"in r?u?r.on:r.off:r})}),t?e.jsx(ge,{...O(d),children:t}):null]})},"root")(),fe=_("div","thumb")(),we=_("div","track")(),ge=_("span","label")(),Ee={component:a,title:"Components / Switch"},g=()=>e.jsx(a,{children:"Switch"}),x=()=>e.jsx(V,{columns:["thick","thin"],rows:G,children:(t,r,o)=>e.jsx(a,{colorScheme:r,variant:t,defaultChecked:!0,children:"Switch"},o)}),C=()=>e.jsx(V,{columns:["sm","md","lg"],rows:G,children:(t,r,o)=>e.jsx(a,{colorScheme:r,size:t,defaultChecked:!0,children:"Switch"},o)}),y=()=>e.jsx(Q,{each:["thick","thin"],children:(t,r)=>e.jsxs(s.Fragment,{children:[e.jsx(a,{variant:t,disabled:!0,children:k(t)}),e.jsx(a,{variant:t,defaultChecked:!0,disabled:!0,children:k(t)})]},r)}),j=()=>e.jsx(Q,{each:["thick","thin"],children:(t,r)=>e.jsxs(s.Fragment,{children:[e.jsx(a,{variant:t,readOnly:!0,children:k(t)}),e.jsx(a,{variant:t,defaultChecked:!0,readOnly:!0,children:k(t)})]},r)}),v=()=>e.jsx(V,{variant:"stack",rows:["square","rounded","circle"],children:(t,r,o)=>e.jsx(s.Fragment,{children:e.jsx(a,{defaultChecked:!0,shape:r,children:k(r)})},o)}),F=()=>e.jsx(a,{reverse:!0,children:"Switch"}),P=()=>e.jsx(a,{size:"lg",icon:{off:e.jsx(Se,{fontSize:"sm"}),on:e.jsx(me,{fontSize:"sm"})},children:"Switch"}),z=()=>{const t=s.useId();return e.jsxs(he,{gap:"sm",children:[e.jsx(ie,{as:"label",htmlFor:t,userSelect:"none",children:"Please Click"}),e.jsx(a,{id:t})]})},D=()=>{const[t,{toggle:r}]=le(!1);return e.jsx(a,{checked:t,onChange:r,children:"Custom control"})},T=()=>{const{control:t,handleSubmit:r,watch:o}=J(),d=i=>console.log("submit:",i);return console.log("watch:",o()),e.jsxs(X,{as:"form",onSubmit:r(d),children:[e.jsx(N,{name:"switch",control:t,render:({field:{value:i,...u}})=>e.jsx(a,{checked:i,...u,children:"Dark mode"})}),e.jsx(U,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},R=()=>{const t={switch:!0},{control:r,handleSubmit:o,watch:d}=J({defaultValues:t}),i=u=>console.log("submit:",u);return console.log("watch:",d()),e.jsxs(X,{as:"form",onSubmit:o(i),children:[e.jsx(N,{name:"switch",control:r,render:({field:{value:u,...h}})=>e.jsx(a,{checked:u,...h,children:"Dark mode"})}),e.jsx(U,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {
