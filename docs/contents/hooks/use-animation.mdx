---
title: useAnimation
description: '`useAnimation` is a custom hook that implements animations similar to CSS's `keyframes`.'
...
- `direction`: Set whether to animate in the reverse direction when the animation sequence is completed and repeat, or reset to the initial state and repeat the animation.
...
:::note
The animation settings are based on [@keyframes](https://developer.mozilla.org/ja/Web/CSS/@keyframes) and [Use CSS animations](https://developer.mozilla.org/ja/Web/CSS/CSS_animations/Using_CSS_animations#アニメーションの設定).
:::
...
:::note
If you want to learn more about animation, please see [here](/styled-system/animation).
:::
...
(Note: The text was already in English, so no translation was needed.)
...
:::note
If you want to learn more about color modes, please visit [here](/styled-system/color-mode).
:::
