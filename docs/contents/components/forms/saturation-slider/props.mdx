...
<PropsCard
  ...
  name="thumbColor"
  type='UIValue<"border" | "link" | "primary" | "secondary" | "info" | "success" | "warning" | "danger" | "current" | "focus" | "whiteAlpha.50" | "whiteAlpha.100" | "whiteAlpha.200" | "whiteAlpha.300" | ... 315 more ... | Background<...>>'
  description={
