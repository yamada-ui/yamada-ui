...
| ------------------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-radio__group`          | `role="radiogroup"`  | Indicates that this is a radio group.                                                                                                                                              |
...
| `label.ui-radio__root > input` | `aria-checked`       | Sets to `"true"` if the radio button is checked, and `"false"` if it is not checked.                                                                                               |
...
| `div.ui-radio__indicator`      | `aria-hidden`        | Excludes the element from the accessibility tree.                                                                                                                                  |
