...
:::tip
Yamada UI provides a [Drawer](/docs/components/drawer) component for drawer-like overlays. If your use case matches a drawer pattern, consider using [Drawer](/docs/components/drawer). Use `Slide` when you need more custom sliding behavior.
:::
