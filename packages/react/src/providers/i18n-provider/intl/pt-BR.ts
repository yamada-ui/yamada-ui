...
const data: IntlData = {
  actionBar: {
    "Close action bar": "Fechar barra de ações",
    "Open action bar": "Abrir barra de ações",
  },
  autocomplete: {
  ...
  colorSwatch: {
    "Color swatch group": "Grupo de amostras de cores",
  },
  datePicker: {
    "Clear value": "Limpar valor",
  },
  ...
  slider: {
    "Slider thumb": "Polegar do controle deslizante",
  },
  stat: {
