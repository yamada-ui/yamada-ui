...
:::tip
テキスト入力に応じて候補となる値を表示したい場合、[Autocomplete](/docs/components/autocomplete)を使用します。
:::
...
| 要素                      | ロールと属性              | 使い方                                                                                                                                                                                        |
| ------------------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `div.ui-select__field`    | `role="combobox"`         | コンボボックスであることを示します。                                                                                                                                                          |
|                           | `aria-activedescendant`   | フォーカスされた項目の`id`を設定します。                                                                                                                                                      |
|                           | `aria-controls`           | リストボックスが開いている場合は関連した`div.ui-select__content`の`id`を設定し、閉じている場合は`undefined`を設定します。                                                                     |
...
| `div.ui-select__icon`     | `role="button"`           | `clearable`かつ値がある場合はボタンであることを示します。                                                                                                                                     |
...
| `div.ui-select__content`  | `role="listbox"`          | リストボックスであることを示します。                                                                                                                                                          |
| `span.ui-select__label`   | `role="presentation"`     | プレゼンテーションであることを示します。                                                                                                                                                      |
| `div.ui-select__group`    | `role="group"`            | グループであることを示します。                                                                                                                                                                |
|                           | `aria-labelledby`         | 関連した`span.ui-select__label`の`id`を設定します。                                                                                                                                           |
| `div.ui-select__option`   | `role="option"`           | オプションであることを示します。                                                                                                                                                              |
|                           | `aria-disabled`           | オプションが無効な場合は`"true"`を設定します。                                                                                                                                                |
|                           | `aria-selected`           | オプションが選択されている場合は`"true"`を設定し、選択されていない場合は`"false"`を設定します。                                                                                               |
| `hr.ui-select__separator` | `role="separator"`        | セパレーターであることを示します。                                                                                                                                                            |
