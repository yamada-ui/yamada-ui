...
<PropsCard
  ...
  type='"blue" | "cyan" | "fuchsia" | "gray" | "green" | "indigo" | "lime" | "orange" | "pink" | "purple" | "red" | "teal" | "violet" | "yellow" | (string & {}) | "primary" | "secondary" | ... 12 more ... | "sky"'
...
<PropsCard
  ...
  description={"Props for color picker element."}
/>
