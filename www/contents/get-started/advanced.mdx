...
:::note
If you want to know more about the loading animation, please check the [useLoading](/docs/hooks/use-loading).
:::
...
:::note
If you want to know more about the notice, please check the [useNotice](/docs/hooks/use-notice).
:::
