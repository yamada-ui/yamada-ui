...
:::note status=warning
Many pages, such as [Learn the Basics](/getting-started/installation/basic) and [Learn Advanced](/getting-started/installation/advanced), assume that you have installed everything at [All](/getting-started/installation).
:::
