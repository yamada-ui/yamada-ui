...
<ContextMenu>
  ...
  <MenuList>
    <MenuItem icon={<Plus size="lg" />} command="⌘T">
      New Tab
    </MenuItem>
    <MenuItem icon={<ExternalLink size="lg" />} command="⌘N">
      New Window
    </MenuItem>
    <MenuItem icon={<FilePenLine size="lg" />} command="⌘O">
      Open File
    </MenuItem>
  </MenuList>
</ContextMenu>
...
`MenuItem`の間に`MenuDivider`を設定することで、区切り線を追加できます。
