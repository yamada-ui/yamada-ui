...
In [Learning the Basics](/getting-started/basics#about-themes), you learned how to use `extendTheme` for theme inheritance. Here, you will learn how to change the `colorScheme` set in each component and how to get the value of tokens defined in the theme.
...
:::note
If you want to learn more about themes, please check [Customizing Themes](/styled-system/theming/customize-theme) and [Component Styles](/styled-system/theming/component-style).
:::
...
:::note status=warning
There are hardly any cases where `sx` and `css` are necessary. As long as you understand the existence of `sx` and `css` in the [Order](/getting-started/advanced#Order) section explained in the next section, there will be no problem.
:::
...
In [Learning the Basics](/getting-started/basics#about-responsive), you learned how to set up responsive styles. Here, you will learn how to get the current breakpoint and useful utilities.
...
In [Learning the Basics](/getting-started/basics#About-Animation), you learned about the `useAnimation` and `Motion` components. Here, you will learn about setting multiple animations with `useAnimation` and setting new dynamic animations with `useDynamicAnimation`. Please check [here](/getting-started/basics#About-Animation).
