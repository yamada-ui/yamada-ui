...
:::note
If you want to know more about the theme, please check the [theming documentation](/docs/theming).
:::
...
:::note
If you want to know more about the layer styles, please check the [layer styles documentation](/docs/styling/layer-styles).
:::
...
:::note
If you want to know more about the text styles, please check the [text styles documentation](/docs/styling/text-styles).
:::
...
:::note
If you want to know more about the loading animation, please check the [useLoading documentation](/docs/hooks/use-loading).
:::
...
:::note
If you want to know more about the notice, please check the [useNotice documentation](/docs/hooks/use-notice).
:::
...
:::note
If you want to know more about the animation, please check the [animation documentation](/docs/styling/animation).
:::
...
:::note
If you want to know more about the `Motion` component, please check the [Motion component documentation](/docs/components/motion).
:::
