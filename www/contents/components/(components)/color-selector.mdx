...
:::tip
If you want to support color code input, please use [ColorPicker](/docs/components/color-picker).
:::

:::tip
If you want to adjust only a single color property such as hue or alpha, please use [HueSlider](/docs/components/hue-slider), [AlphaSlider](/docs/components/alpha-slider), or [SaturationSlider](/docs/components/saturation-slider).
:::
