...
:::note
`Motion` uses [Motion](https://motion.dev) internally. If you want to know more about the component's features, please refer to the [Motion component documentation](https://motion.dev/docs/react-motion-component).
:::
...
:::note
Variants' animation to know more about the animation of variants, please refer to the [variants animation documentation](https://motion.dev/docs/react-animation#variants).
:::
...
:::note
Hover's animation to know more about the animation of hover, please refer to the [hover animation documentation](https://motion.dev/docs/react-hover-animation).
:::
...
:::note
Click/Tap's animation to know more about the animation of click/tap, please refer to the [tap gesture documentation](https://motion.dev/docs/react-gestures#tap).
:::
...
:::note
Focus's animation to know more about the animation of focus, please refer to the [focus gesture documentation](https://motion.dev/docs/react-gestures#focus).
:::
...
:::note
Drag's animation to know more about the animation of drag, please refer to the [drag documentation](https://motion.dev/docs/react-drag).
:::
