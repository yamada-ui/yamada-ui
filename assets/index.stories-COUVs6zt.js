import{j as r,T as s}from"./iframe-BHpF9Anv.js";import{u as i}from"./index-B2G6l9Y9.js";import"./index-BHByaWSg.js";const l={title:"Hooks / useAsync"},e=()=>{const{error:o,loading:n,value:a}=i(async()=>new Promise((t,c)=>{setTimeout(()=>{Math.random()>.5?t("✌️"):c(new Error("A pseudo random error occurred"))},3e3)}),[]);return n?r.jsx(s,{children:"Loading..."}):o?r.jsxs(s,{children:["Error: ",o.message]}):r.jsxs(s,{children:["Value: ",a]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
  const {
    error,
    loading,
    value
