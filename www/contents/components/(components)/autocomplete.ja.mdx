...
| `Enter`     | フォーカスしている項目を選択します。フォーカスしている項目がなく入力テキストがある場合は、最初に一致する項目を選択します。 | -                   |
...
| コンポーネント        | ロールと属性                | 使い方                                                                                                                            |
| --------------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `Autocomplete.Root`   | `role="combobox"`           | コンボボックスであることを示します。                                                                                              |
|                       | `aria-expanded`             | リストボックスが開いている場合は`"true"`を設定し、閉じている場合は`"false"`を設定します。                                         |
|                       | `aria-haspopup="listbox"`   | リストボックスがあることを示します。                                                                                              |
...
| `AutocompleteContent` | `role="listbox"`            | リストボックスであることを示します。                                                                                              |
...
| `Autocomplete.Group`  | `role="group"`              | オプションのグループであることを示します。                                                                                        |
|                       | `aria-labelledby`           | グループラベルの`id`を設定します。                                                                                                |
| `Autocomplete.Label`  | `role="presentation"`       | プレゼンテーションであることを示します。                                                                                          |
| `AutocompleteIcon`    | `role="button"`             | `clearable`かつ値がある場合、ボタンであることを示します。                                                                         |
|                       | `aria-label="値を消去する"` | `"値を消去する"`を設定します。                                                                                                    |
|                       | `aria-disabled`             | `disabled`または`readOnly`が設定されている場合は`"true"`を設定します。                                                            |
