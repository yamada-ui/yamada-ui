...
### Do Not Block Scrolling When Dialog Opens
...
If you want to customize `DialogCloseButton` with `props`, etc., set it without omitting.
...
If you want to pass `props` to `DialogOverlay` to customize it, set it without omitting.
