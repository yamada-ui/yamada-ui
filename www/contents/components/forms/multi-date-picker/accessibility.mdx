...
The `MultiDatePicker` follows the [WAI-ARIA - Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/) for accessibility.

If you are not using `FormControl`, set `aria-label` or `aria-labelledby` to `MultiDatePicker`.

```tsx live=false
<MultiDatePicker placeholder="YYYY/MM/DD" aria-label="Date to reserve" />
```
...
<VStack gap="sm">
  ...
  <MultiDatePicker placeholder="YYYY/MM/DD" aria-labelledby="label" />
</VStack>
```
...
| ------------------------------------------ | ------------------------ | -------------------------------------------------------------------------------------------- |
| `MultiDatePickerField` <Tag>Internal</Tag> | `role="combobox"`        | Indicates that this is a combobox.                                                           |
...
|                                            | `id`                     | The `id` used to associate with `MultiDatePickerField`.                                      |
