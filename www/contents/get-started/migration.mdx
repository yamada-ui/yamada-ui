...
- [Tokens](/docs/theming/tokens) can now be defined using `defineTokens`.
- [Semantic Tokens](/docs/theming/tokens/semantic-tokens) can now be defined using `defineSemanticTokens`.
- [Styles](/docs/theming/styles) can now be defined using `defineStyles`.
...
- `semanticTokens` has been removed. Use `semantics` instead.
...
v2.0 does not have all components migrated. These will be migrated in v2.x.
