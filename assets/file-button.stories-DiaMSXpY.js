import{p as V,ag as p,r as R,e as _,q as E,j as e,av as q,s as D,R as C,_ as i,C as I,Q as P,V as W,T as A}from"./iframe-BToZTpox.js";import{P as z}from"./props-table-Cwu3xVD6.js";import{u as L,C as Q}from"./index.esm-DkzZiBaN.js";import{u as G}from"./use-file-input-Bw_6NPgZ.js";import{u as J}from"./use-input-border-DrgszVel.js";import{W as s}from"./wrap-BjBqFdh4.js";import{F as l}from"./for-uUJ5eupy.js";import{H as O}from"./h-stack-B0RuZYZf.js";import{P as u}from"./plus-icon-DLZ350zM.js";import{F as U}from"./use-field-props-BdW9O_rE.js";import"./preload-helper-D9Z9MdNV.js";import"./grid-DdBbvjDG.js";import"./grid-item-DRUP5dOl.js";import"./flex-BLADGVni.js";import"./heading-D64Y19KZ.js";import"./index-Dr0ZMVHJ.js";import"./index-joiQ4XZ6.js";import"./index-OFdnihQg.js";const K=V({base:{"--error-border-color":"colors.border.error"},variants:{ghost:{...p.variants?.ghost,_invalid:{borderColor:"{error-border-color}",borderWidth:"1px"}},outline:{...p.variants?.outline,_invalid:{borderColor:"{error-border-color}"}},solid:{...p.variants?.solid,_invalid:{borderColor:"{error-border-color}",borderWidth:"1px"}},subtle:{...p.variants?.subtle,_invalid:{borderColor:"{error-border-color}",borderWidth:"1px"}},surface:{...p.variants?.surface,_invalid:{borderColor:"{error-border-color}"}}},defaultProps:{variant:"solid"}}),N=(n={})=>{const{interactive:r,clickableProps:o,getInputProps:a}=G(n),c=R.useCallback(d=>({...o,"aria-disabled":_(!r),tabIndex:r?o.tabIndex:-1,...d}),[o,r]);return{clickableProps:o,getButtonProps:c,getInputProps:a}},{withContext:X}=E("file-button",K),t=X(({as:n=C,children:r,errorBorderColor:o,...a})=>{const{getButtonProps:c,getInputProps:d}=N(a),y=J({errorBorderColor:o});return e.jsxs(e.Fragment,{children:[e.jsx(q,{children:e.jsx(D.input,{...d()})}),e.jsx(n,{...y,...c(),children:r})]})})(),xe={component:t,title:"Components / FileButton"},m=()=>e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Upload"}),e.jsx(t,{as:i,"aria-label":"Upload file",icon:e.jsx(u,{fontSize:"2xl"})})]}),f=()=>e.jsx(z,{columns:["solid","subtle","surface","outline","ghost"],rows:I,children:(n,r,o)=>e.jsx(t,{colorScheme:r,variant:n,children:"FileButton"},o)}),x=()=>e.jsx(z,{columns:["xs","sm","md","lg","xl"],rows:I,children:(n,r,o)=>e.jsx(t,{colorScheme:r,size:n,children:"FileButton"},o)}),h=()=>e.jsxs(e.Fragment,{children:[e.jsx(t,{multiple:!0,children:"Upload"}),e.jsx(t,{as:i,"aria-label":"Upload file",icon:e.jsx(u,{fontSize:"2xl"}),multiple:!0})]}),g=()=>e.jsxs(e.Fragment,{children:[e.jsx(t,{accept:"image/png,image/jpeg",children:"Upload"}),e.jsx(t,{as:i,"aria-label":"Upload file",accept:"image/png,image/jpeg",icon:e.jsx(u,{fontSize:"2xl"})})]}),b=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{variant:n,disabled:!0,children:P(n)},r)})}),e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{as:i,variant:n,"aria-label":"Upload file",disabled:!0,icon:e.jsx(u,{fontSize:"2xl"})},r)})}),e.jsx(U,{disabled:!0,helperMessage:"Please select a file to upload.",label:"Upload file",children:e.jsx(t,{justifySelf:"flex-start",children:"Upload"})})]}),F=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{variant:n,readOnly:!0,children:P(n)},r)})}),e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{as:i,variant:n,"aria-label":"Upload file",icon:e.jsx(u,{fontSize:"2xl"}),readOnly:!0},r)})}),e.jsx(U,{helperMessage:"Please select a file to upload.",label:"Upload file",readOnly:!0,children:e.jsx(t,{justifySelf:"flex-start",children:"Upload"})})]}),B=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{variant:n,invalid:!0,children:P(n)},r)})}),e.jsx(s,{gap:"md",children:e.jsx(l,{each:["solid","subtle","surface","outline","ghost"],children:(n,r)=>e.jsx(t,{as:i,variant:n,"aria-label":"Upload file",icon:e.jsx(u,{fontSize:"2xl"}),invalid:!0},r)})}),e.jsx(U,{errorMessage:"File is required.",invalid:!0,label:"Upload file",children:e.jsx(t,{justifySelf:"flex-start",children:"Upload"})})]}),j=()=>e.jsx(t,{errorBorderColor:"orange.500",invalid:!0,children:"Upload"}),S=()=>{const[n,r]=R.useState(void 0),o=R.useRef(null),a=()=>{r(void 0),o.current?.()};return e.jsxs(W,{children:[e.jsxs(A,{children:["files: ",n?.length??0]}),e.jsxs(O,{children:[e.jsx(t,{multiple:!0,resetRef:o,onChange:r,children:"Upload"}),e.jsx(C,{onClick:a,children:"Reset"})]})]})},v=()=>{const n=R.useRef(null),{control:r,formState:{errors:o},handleSubmit:a,setValue:c,watch:d}=L(),y=()=>{c("fileButton",null),n.current?.()},T=k=>console.log("submit:",k);return console.log("watch:",d()),e.jsxs(W,{as:"form",onSubmit:a(T),children:[e.jsx(U,{errorMessage:o.fileButton?.message,invalid:!!o.fileButton,label:"Files",children:e.jsx(Q,{name:"fileButton",control:r,render:({field:{ref:k,name:w,onBlur:M,onChange:H}})=>e.jsxs(O,{children:[e.jsx(t,{ref:k,name:w,onBlur:M,onChange:H,resetRef:n,children:"Upload"}),e.jsx(C,{onClick:y,children:"Reset"})]}),rules:{required:{message:"This is required.",value:!0}}})}),e.jsx(C,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => {
  return <>
