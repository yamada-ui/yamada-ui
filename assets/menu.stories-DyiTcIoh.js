...
}`,...(Ge=(Re=J.parameters)==null?void 0:Re.docs)==null?void 0:Ge.source}}};var Te,Ke,Ue;Y.parameters={...Y.parameters,docs:{...(Te=Y.parameters)==null?void 0:Te.docs,source:{originalSource:`() => {
  return <Menu>
      <MenuButton as={Button} rightIcon={<Icon size="xs" icon={faChevronDown} />}>
        Menu
      </MenuButton>
...
}`,...(Mn=(dn=re.parameters)==null?void 0:dn.docs)==null?void 0:Mn.source}}};const Rt=["basic","withCommand","withIcon","withInitialFocusRef","withPlacement","withAnimation","withOffset","withGutter","withDuration","withDivider","withGroup","withOptionGroup","withPortal","disabledCloseOnSelect","disabledCloseBlur","isDisabled","isFocusable","useLazy","customControl"];export{Rt as __namedExportsOrder,G as basic,re as customControl,At as default,Z as disabledCloseBlur,X as disabledCloseOnSelect,ee as isDisabled,ne as isFocusable,te as useLazy,j as withAnimation,T as withCommand,J as withDivider,H as withDuration,Y as withGroup,q as withGutter,K as withIcon,U as withInitialFocusRef,V as withOffset,$ as withOptionGroup,W as withPlacement,Q as withPortal};
