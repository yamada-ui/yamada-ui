import{j as e}from"./extends-CwFRzn3r.js";import{r as v}from"./index-BwDkhjyp.js";import{u as A}from"./index-CjlbPsry.js";import{u as pe}from"./index-myp615oj.js";import{u as E}from"./index-BRqXaXJK.js";import{f as N}from"./forward-ref-BWI-Phbn.js";import{u as xe}from"./use-component-style-vGTU0kmU.js";import{o as he}from"./theme-provider-HQUvgn6k.js";import{ah as ke,p as ae,b as H,c as I}from"./factory-BPGpAF5Z.js";import{A as fe}from"./avatar-Cgvvbnbj.js";import{H as Se}from"./heading-DLmWecw7.js";import{T as Ce}from"./text-Cf22NS09.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CoJrGj-T.js";import"./index-DMlaarLi.js";import"./index-B9JWsFAS.js";import"./icon-BYVaiKtb.js";import"./use-var-CHlP19MT.js";import"./use-image-uQJHIr1u.js";const o=N((r,t)=>{const[p,a]=xe("Skeleton",r);let{className:l,children:i,endColor:c,fadeDuration:d=.4,isFitContent:x,isLoaded:f,speed:h=.8,startColor:D,...m}=he(a);const[F]=ke(),S=ae(i),u=pe(f),k=E(D),C=E(c),de=!!S.length;x??(x=de);const le=A({duration:typeof d=="string"?d:`${d}s`,keyframes:{"0%":{opacity:0},"100%":{opacity:1}}}),ce=A({direction:"alternate",duration:typeof h=="string"?h:`${h}s`,iterationCount:"infinite",keyframes:{"0%":{background:k,borderColor:k},"100%":{background:C,borderColor:C}},timingFunction:"linear"}),me={"&::before, &::after, *":{visibility:"hidden"},backgroundClip:"padding-box",boxShadow:"none",color:"transparent",cursor:"default",h:x?"fit-content":"fallback(4, 1rem)",maxW:"100%",pointerEvents:"none",userSelect:"none",w:x?"fit-content":"100%",...p};if(f){const ue=!F()||u?"none":le;return e.jsx(H.div,{ref:t,className:I("ui-skeleton","ui-skeleton--loaded",l),...m,"aria-busy":"false",animation:ue,children:S})}else return e.jsx(H.div,{ref:t,className:I("ui-skeleton",l),__css:me,...m,"aria-busy":"true",animation:ce,children:S})});o.displayName="Skeleton";o.__ui__="Skeleton";const s=N(({className:r,boxSize:t="fallback(12, 3rem)",children:p,isFitContent:a,...l},i)=>{const c=ae(p),d=!!c.length;return a??(a=d),e.jsx(o,{ref:i,className:I("ui-skeleton__circle",r),isFitContent:a,rounded:"fallback(full, 9999px)",...a?{}:{boxSize:t},...l,children:c})});s.displayName="SkeletonCircle";s.__ui__="SkeletonCircle";const n=N(({className:r,children:t,endColor:p,fadeDuration:a,gap:l="fallback(2, 0.5rem)",isLoaded:i,lineClamp:c=3,speed:d,startColor:x,textHeight:f="fallback(2, 0.5rem)",...h},D)=>{const m=E(c),F={w:"100%"};return e.jsx(H.div,{ref:D,className:I("ui-skeleton__text",r),__css:F,...h,children:Array(m).fill(0).map((S,u)=>{if(i&&u>0)return null;const k=u+1===m,C=i?{}:{h:f,mb:k?void 0:l,w:m>1&&k?"80%":"100%"};return e.jsx(o,{endColor:p,fadeDuration:a,isLoaded:i,speed:d,startColor:x,...C,children:u===0?t:void 0},u)})})});n.displayName="SkeletonText";n.__ui__="SkeletonText";const Me={component:o,title:"Components / Feedback / Skeleton"},ie=async r=>new Promise(t=>{setTimeout(t,r)}),g=()=>e.jsxs(e.Fragment,{children:[e.jsx(o,{}),e.jsx(s,{}),e.jsx(n,{})]}),j=()=>e.jsxs(e.Fragment,{children:[e.jsx(o,{endColor:"orange.500",startColor:"pink.500"}),e.jsx(s,{endColor:"orange.500",startColor:"pink.500"}),e.jsx(n,{endColor:"orange.500",startColor:"pink.500"})]}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(o,{h:16}),e.jsx(s,{boxSize:16}),e.jsx(n,{textHeight:4})]}),b=()=>e.jsxs(e.Fragment,{children:[e.jsx(o,{speed:2}),e.jsx(s,{speed:2}),e.jsx(n,{speed:2})]}),_=()=>e.jsx(n,{gap:8}),w=()=>e.jsx(n,{lineClamp:5}),T=()=>{const[r,t]=v.useState(!1);return v.useEffect(()=>{ie(3e3).then(()=>{t(!0)})},[]),e.jsxs(e.Fragment,{children:[e.jsx(o,{isLoaded:r}),e.jsx(s,{isLoaded:r}),e.jsx(n,{isLoaded:r})]})},y=()=>{const[r,t]=v.useState(!1);return v.useEffect(()=>{ie(3e3).then(()=>{t(!0)})},[]),e.jsxs(e.Fragment,{children:[e.jsx(o,{fadeDuration:2,h:12,isLoaded:r,children:e.jsx(Se,{isTruncated:!0,children:"ギャルのパンティーおくれーーーっ！！！！！"})}),e.jsx(s,{fadeDuration:2,isLoaded:r,children:e.jsx(fe,{name:"Hirotomo Yamada"})}),e.jsx(n,{fadeDuration:2,isLoaded:r,children:e.jsx(Ce,{isTruncated:!0,children:"私の戦闘力は530000です。ですがもちろんフルパワーであなたと戦う気はありませんからご心配なく……"})})]})};var z,P,G;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`() => {
  return <>
      <Skeleton />
