...
:::tip
単一のデータをリストで表示したい場合は、[List](/docs/components/list)と組み合わせて使用します。
:::

:::tip
用語とその説明のリストを表示したい場合は、[DataList](/docs/components/data-list)と組み合わせて使用します。
:::

:::tip
項目の順序をドラッグアンドドロップで変更したい場合は、[Reorder](/docs/components/reorder)と組み合わせて使用します。
:::
