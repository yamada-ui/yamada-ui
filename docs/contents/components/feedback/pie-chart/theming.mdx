...
The `PieChart` is a [single part component](/styled-system/theming/component-styles#single-part-components).

:::note
`PieChart` inherits the style from [LineChart](/components/feedback/line-chart).
:::
