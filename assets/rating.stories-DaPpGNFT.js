import{j as e,a as k,F as D}from"./jsx-runtime-2xDJh5tt.js";import{I as _,f as L,u as ct,v as lt,w as it,x as ut,y as dt}from"./fontawesome-icon-Dp0uKqnG.js";import{r as o}from"./index-CBqU2yxZ.js";import{u as mt,C as ft}from"./index.esm-Dtxxx2aT.js";import{u as gt}from"./index-D4fsg9Nk.js";import{t as pt}from"./index-D4pp_ODl.js";import{b as ht}from"./icon-D30_Pagv.js";import{f as ie}from"./forward-ref-DuAegr0M.js";import{B as E,a7 as It,u as ae,c as re,v as St,a as bt,R as Ct,w as yt,o as Rt,h as v,M as z}from"./factory-DLpD49Xl.js";import{M as Vt}from"./motion-CIylrsRE.js";import{u as wt,g as Ft,F as ue}from"./form-control-AJrH3zEl.js";import{c as vt}from"./number-49BHn0Cl.js";import{a as xt}from"./use-component-style-D9HuanlY.js";import{o as kt}from"./theme-provider-DXhTM26K.js";import{V as Mt}from"./stack-BJO0HI5d.js";import{B as Pt}from"./button-DQ4BMoEA.js";import"./index-D3ylJrlI.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CpntKjHS.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-BPGUNDjC.js";import"./motion-JgkBPv6g.js";import"./use-ripple-Df_aFKka.js";import"./index-_tcQm2Fk.js";import"./loading-De1VEe6t.js";import"./index-DiSCNHbg.js";import"./index-5JVG-Iiz.js";const _t=ie(({className:r,groupValue:t,value:n,fractionValue:c,color:s,...d},g)=>{const{styles:m,inputProps:f,emptyIcon:V=e(he,{}),filledIcon:O=e(he,{}),itemProps:x}=oe(),{isActive:S,isFilled:p,getInputProps:w,getItemProps:b}=$t({value:n,groupValue:t,fractionValue:c}),I=E(x,n),C=E(f,n),l=s?{_filled:{color:It(s)?[s,s]:s}}:{},M={display:"block",lineHeight:"0",...m.item,...l};return k(D,{children:[e(ae.input,{...w(C,g)}),e(ae.label,{className:re("ui-rating__item",r),__css:M,...b({...I,...d}),children:e(Dt,{clipPath:c!==1?`inset(0 ${S?100-c*100:100}% 0 0)`:void 0,children:p?E(O,t):E(V,t)})})]})}),Dt=({className:r,children:t,...n})=>{const{styles:c}=oe(),d=St(t).map(m=>o.cloneElement(m,{focusable:!1,"aria-hidden":!0,style:{maxWidth:"1em",maxHeight:"1em"}})),g={display:"inline-flex",alignItems:"center",justifyContent:"center",...c.icon};return e(ae.div,{className:re("ui-rating__item__icon",r),__css:g,...n,children:d})},he=({...r})=>e(ht,{viewBox:"0 0 24 24",strokeLinecap:"round",strokeLinejoin:"round",...r,children:e("path",{d:"M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z"})}),Ot=ie(({className:r,value:t,items:n,color:c,...s},d)=>{const{styles:g,decimal:m,groupProps:f,getGroupProps:V}=oe(),O=E(f,t),x={...g.group};return e(Vt,{className:re("ui-rating__group",r),__css:x,...V({value:t,...O,...s},d),children:Array(n).fill(0).map((S,p)=>{const w=m*(t===1?p:p+1),b=le(t-1+w,m);return e(_t,{groupValue:t,value:b,fractionValue:w,color:c},`${t}-${w}`)})})}),le=(r,t)=>{var s;const n=Math.round(r/t)*t,c=((s=`${t}`.split(".")[1])==null?void 0:s.length)||0;return Number(n.toFixed(c))},[zt,oe]=bt({name:"RatingContext",errorMessage:`useRatingContext returned is 'undefined'. Seems you forgot to wrap the components in "<Rating />"`}),Tt=({name:r,color:t,value:n,defaultValue:c=0,onChange:s,items:d=5,fractions:g=1,highlightSelectedOnly:m=!1,onHover:f,groupProps:V,itemProps:O,inputProps:x,emptyIcon:S,filledIcon:p,...w})=>{let{id:b,...I}=wt(w);const{disabled:C,readOnly:l}=I,M=o.useRef(null),[T,$]=gt({value:n,defaultValue:c,onChange:s}),[y,F]=o.useState(-1),[N,j]=o.useState(!0);b??(b=o.useId()),r??(r=`rating-${b}`);const se=Ct(I,Ft({omit:["aria-readonly"]})),A=Math.floor(g),i=Math.floor(d),R=1/A,B=le(T,R),nt=y!==-1?y:B,G=o.useCallback(u=>{const{left:h,width:P}=M.current.getBoundingClientRect(),ce=P/i,st=(u-h)/ce;return vt(le(st+R/2,R),R,i)},[R,i]),de=o.useCallback(()=>{!C&&!l&&j(!1)},[C,l]),me=o.useCallback(()=>{C||l||(F(-1),j(!0),y!==-1&&(f==null||f(-1)))},[C,y,f,l,F]),fe=o.useCallback(u=>{u.preventDefault();const h=u.touches[0];if(!h)return;const P=G(h.clientX);$(P)},[G,$]),ge=o.useCallback(u=>{u.preventDefault()},[]),pe=o.useCallback(u=>{if(C||l)return;const h=G(u.clientX);F(h),h!==y&&(f==null||f(h))},[C,G,y,l,f]),at=o.useCallback((u={},h=null)=>({ref:yt(h,M),...Rt(I,["aria-readonly"]),...u,id:b,onMouseEnter:v(de,u.onMouseEnter,I.onMouseEnter),onMouseMove:v(pe,u.onMouseMove,I.onMouseMove),onMouseLeave:v(me,u.onMouseLeave,I.onMouseLeave),onTouchStart:v(fe,u.onTouchStart,I.onTouchStart),onTouchEnd:v(ge,u.onTouchEnd,I.onTouchEnd)}),[de,me,pe,ge,fe,b,I]),rt=o.useCallback(({value:u,...h},P=null)=>{const ce=!l&&Math.ceil(y)===u;return{ref:P,whileTap:!C&&!l?{y:-4}:void 0,...h,tabIndex:-1,"data-active":z(ce)}},[C,y,l]),ot=Array(i).fill(0).map((u,h)=>{const P=h+1;return e(Ot,{value:P,color:E(t,P),items:h===0?A+1:A},P)});return{getContainerProps:at,getGroupProps:rt,id:b,name:r,value:T,roundedValue:B,hoveredValue:y,resolvedValue:nt,isOutside:N,setValue:$,setHoveredValue:F,decimal:R,highlightSelectedOnly:m,formControlProps:se,groupProps:V,itemProps:O,inputProps:x,children:ot,emptyIcon:S,filledIcon:p}},$t=({groupValue:r,fractionValue:t,value:n})=>{const{id:c,name:s,formControlProps:d,isOutside:g,highlightSelectedOnly:m,roundedValue:f,resolvedValue:V,setValue:O,setHoveredValue:x}=oe(),{readOnly:S,disabled:p}=d,[w,b]=o.useState(!1),[I,C]=o.useState(!1),l=n===V,M=n===f,T=m?n===V:n<=V,$=o.useCallback(()=>{b(!1),g&&x(-1)},[g,x]),y=o.useCallback(i=>{if(S||p)return;const R=parseFloat(i.target.value);x(R)},[p,S,x]),F=o.useCallback(i=>{S||p||O(i)},[p,S,O]),N=o.useCallback(()=>{S||p||F(n)},[p,F,S,n]),j=o.useCallback(()=>{S||p||F(n)},[p,F,S,n]),se=o.useCallback((i={},R=null)=>{const B=l?1:-1;return{ref:R,htmlFor:`${c}-${r}-${n}`,...d,...i,zIndex:t!==1?B:void 0,onMouseDown:v(N,i.onMouseDown),onTouchStart:v(j,i.onTouchStart),"data-active":z(l),"data-filled":z(T),"data-focus":z(w),"data-focus-visible":z(w&&I)}},[d,t,r,c,l,T,I,w,N,j,n]),A=o.useCallback((i={},R=null)=>({ref:R,"aria-label":`${n}`,...d,...i,style:{border:"0px",clip:"rect(0px, 0px, 0px, 0px)",height:"1px",width:"1px",margin:"-1px",padding:"0px",overflow:"hidden",whiteSpace:"nowrap",position:"absolute"},type:"radio",id:`${c}-${r}-${n}`,name:s,value:n,checked:M,onChange:v(y,i.onChange),onFocus:v(()=>b(!0),i.onFocus),onBlur:v($,i.onBlur),onKeyDown:v(B=>B.key===" "?F(n):void 0,i.onKeyDown),"data-active":z(l),"data-checked":z(M)}),[n,d,c,r,s,M,y,$,l,F]);return o.useEffect(()=>pt(C),[]),{isActive:l,isChecked:M,isFilled:T,getItemProps:se,getInputProps:A}},a=ie((r,t)=>{const[n,c]=xt("Rating",r),{className:s,...d}=kt(c),{getContainerProps:g,children:m,...f}=Tt(d),V={display:"flex",...n.container};return e(zt,{value:{styles:n,...f},children:e(ae.div,{className:re("ui-rating",s),__css:V,...g({},t),children:m})})}),dn={title:"Components / Forms / Rating",component:a},U=()=>e(a,{}),Y=()=>k(D,{children:[e(a,{size:"xs",defaultValue:3}),e(a,{size:"sm",defaultValue:3}),e(a,{size:"md",defaultValue:3}),e(a,{size:"lg",defaultValue:3}),e(a,{size:"xl",defaultValue:3})]}),H=()=>k(D,{children:[e(a,{colorScheme:"purple",defaultValue:3}),e(a,{colorScheme:"pink",defaultValue:3})]}),K=()=>e(a,{defaultValue:3}),W=()=>k(D,{children:[e(a,{items:4}),e(a,{items:5}),e(a,{items:6})]}),X=()=>k(D,{children:[e(a,{fractions:2,defaultValue:1.5}),e(a,{fractions:3,defaultValue:2.33}),e(a,{fractions:4,defaultValue:3.75})]}),q=()=>e(a,{defaultValue:3,highlightSelectedOnly:!0}),J=()=>k(D,{children:[e(a,{isDisabled:!0,defaultValue:3}),e(ue,{isDisabled:!0,label:"How satisfied are you with Yamada UI?",children:e(a,{defaultValue:3})})]}),Q=()=>k(D,{children:[e(a,{isReadOnly:!0,defaultValue:3}),e(ue,{isReadOnly:!0,label:"How satisfied are you with Yamada UI?",children:e(a,{defaultValue:3})})]}),Z=()=>{const r=t=>{switch(t){case 1:return"red.500";case 2:return"orange.500";case 3:return"yellow.500";case 4:return"green.500";case 5:return"blue.500";default:return}};return k(D,{children:[e(a,{color:"green.500",defaultValue:3}),e(a,{color:r,defaultValue:3}),e(a,{color:r,defaultValue:3,fractions:3})]})},ee=()=>{const r=n=>{switch(n){case 1:return"red.500";case 2:return"orange.500";case 3:return"yellow.500";case 4:return"green.500";case 5:return"blue.500";default:return}},t=n=>{switch(n){case 1:return e(_,{icon:dt});case 2:return e(_,{icon:ut});case 3:return e(_,{icon:it});case 4:return e(_,{icon:lt});case 5:return e(_,{icon:ct});default:return null}};return k(D,{children:[e(a,{defaultValue:3,emptyIcon:e(_,{icon:L}),filledIcon:e(_,{icon:L})}),e(a,{defaultValue:2,fractions:3,emptyIcon:e(_,{icon:L}),filledIcon:e(_,{icon:L})}),e(a,{gap:"xs",emptyIcon:t,filledIcon:t}),e(a,{gap:"xs",color:r,emptyIcon:t,filledIcon:t}),e(a,{gap:"xs",fractions:3,emptyIcon:t,filledIcon:t})]})},te=()=>{const[r,t]=o.useState(3);return e(a,{value:r,onChange:t})},ne=()=>{var g;const r={rating:3},{control:t,handleSubmit:n,watch:c,formState:{errors:s}}=mt({defaultValues:r}),d=m=>console.log("submit:",m);return console.log("watch:",c()),k(Mt,{as:"form",onSubmit:n(d),children:[e(ue,{isInvalid:!!s.rating,label:"How satisfied are you with Yamada UI?",errorMessage:(g=s.rating)==null?void 0:g.message,children:e(ft,{name:"rating",control:t,render:({field:m})=>e(a,{...m})})}),e(Pt,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};var Ie,Se,be;U.parameters={...U.parameters,docs:{...(Ie=U.parameters)==null?void 0:Ie.docs,source:{originalSource:`() => {
  return <Rating />;
}`,...(be=(Se=U.parameters)==null?void 0:Se.docs)==null?void 0:be.source}}};var Ce,ye,Re;Y.parameters={...Y.parameters,docs:{...(Ce=Y.parameters)==null?void 0:Ce.docs,source:{originalSource:`() => {
  return <>
...
}`,...(Re=(ye=Y.parameters)==null?void 0:ye.docs)==null?void 0:Re.source}}};var Ve,we,Fe;H.parameters={...H.parameters,docs:{...(Ve=H.parameters)==null?void 0:Ve.docs,source:{originalSource:`() => {
  return <>
...
}`,...(Be=($e=q.parameters)==null?void 0:$e.docs)==null?void 0:Be.source}}};var Ee,je,Ae;J.parameters={...J.parameters,docs:{...(Ee=J.parameters)==null?void 0:Ee.docs,source:{originalSource:`() => {
  return <>
...
}`,...(Ae=(je=J.parameters)==null?void 0:je.docs)==null?void 0:Ae.source}}};var Ne,Ge,Le;Q.parameters={...Q.parameters,docs:{...(Ne=Q.parameters)==null?void 0:Ne.docs,source:{originalSource:`() => {
  return <>
...
}`,...(Le=(Ge=Q.parameters)==null?void 0:Ge.docs)==null?void 0:Le.source}}};var Ue,Ye,He;Z.parameters={...Z.parameters,docs:{...(Ue=Z.parameters)==null?void 0:Ue.docs,source:{originalSource:`() => {
...
}`,...(Xe=(We=ee.parameters)==null?void 0:We.docs)==null?void 0:Xe.source}}};var qe,Je,Qe;te.parameters={...te.parameters,docs:{...(qe=te.parameters)==null?void 0:qe.docs,source:{originalSource:`() => {
