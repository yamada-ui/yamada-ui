...
コンポーネント、フック、スタイルAPI、テーマの動作を追加または変更する場合は、[設計原則](./DESIGN.md)も確認してください。
...
3. 変更によって、未検証の動作、公開されている契約、アクセシビリティの動作、回帰、連携箇所が追加または変更される場合は、テストを追加または更新してください。`pnpm test`または`pnpm test <package-name>`を実行して、関連するテストが合格することを確認してください。更なるテストの情報は[テストのためのヒント](https://github.com/yamada-ui/yamada-ui/wiki/%E3%83%86%E3%82%B9%E3%83%88%E3%81%AE%E3%81%9F%E3%82%81%E3%81%AE%E3%83%92%E3%83%B3%E3%83%88)を確認してください。
