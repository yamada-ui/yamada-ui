...
import { RouteOff as OriginalRouteOff } from "lucide-react"
 ...
 */
export const RouteOffIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalRouteOff} {...props} />
))
