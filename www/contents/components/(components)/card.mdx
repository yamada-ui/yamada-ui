---
title: Card
description: "`Card` is a component that groups and displays related information. By default, it renders a `article` element."
tags: ["card", "data-display"]
...
::::tip
If you need a general-purpose section for layout rather than a card for related information, consider using [Container](/docs/components/container).
::::
