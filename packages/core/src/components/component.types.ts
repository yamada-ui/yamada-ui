...
export type ComponentProps<
  ...
  D extends object,
  H extends As,
> = (WithoutAs<Merge<Y, D>> | WithoutAs<Merge<M, D>>) & {
  as?: H
}
...
export type HTMLUIProps<Y extends As> = Merge<
  React.ComponentPropsWithoutRef<Y>,
  UIProps & { as?: As }
>

export type HTMLUIPropsWithoutAs<Y extends As> = Omit<HTMLUIProps<Y>, "as">

type HTMLUIPropsWithRef<Y extends As> = HTMLUIProps<Y> &
