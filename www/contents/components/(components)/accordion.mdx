...
:::tip
If you need to expand or collapse a single item and it is clear that multiple items will not be displayed in the future, use [Collapse](/docs/components/collapse).
:::
