...
}`,...(Te=(_e=J.parameters)==null?void 0:_e.docs)==null?void 0:Te.source}}};var Ge,je,Ke;$.parameters={...$.parameters,docs:{...(Ge=$.parameters)==null?void 0:Ge.docs,source:{originalSource:`() => {
  return <Menu>
      <MenuButton as={Button} rightIcon={<Icon size='xs' icon={faChevronDown} />}>
        Menu
      </MenuButton>
...
}`,...(Mn=(dn=re.parameters)==null?void 0:dn.docs)==null?void 0:Mn.source}}};const At=["basic","withCommand","withIcon","withInitialFocusRef","withPlacement","withAnimation","withOffset","withGutter","withDuration","withDivider","withGroup","withOptionGroup","withPortal","disabledCloseOnSelect","disabledCloseBlur","isDisabled","isFocusable","useLazy","customControl"];export{At as __namedExportsOrder,T as basic,re as customControl,Nt as default,Z as disabledCloseBlur,Y as disabledCloseOnSelect,ee as isDisabled,ne as isFocusable,te as useLazy,W as withAnimation,G as withCommand,J as withDivider,H as withDuration,$ as withGroup,q as withGutter,j as withIcon,K as withInitialFocusRef,V as withOffset,Q as withOptionGroup,U as withPlacement,X as withPortal};
//# sourceMappingURL=menu.stories-75b92ee1.js.map
