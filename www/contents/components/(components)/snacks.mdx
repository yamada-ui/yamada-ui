...
:::tip
If you want to control application notifications, use [useNotice](/docs/hooks/use-notice).
:::

:::tip
If you want to convey information to the user rather than present it as a notification, use [Alert](/docs/components/alert).
:::
