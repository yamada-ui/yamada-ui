...
:::tip
`Snacks` displays notifications as popups within a component. If you want to display popup notifications across the entire application, use [useNotice](/docs/hooks/use-notice).
:::

:::tip
If you want to visually highlight notes, hints, or supplementary information within text content rather than display them as notifications, use [Alert](/docs/components/alert).
:::
