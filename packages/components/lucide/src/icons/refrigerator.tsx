...
import { Refrigerator as OriginalRefrigerator } from "lucide-react"
 ...
 */
export const RefrigeratorIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalRefrigerator} {...props} />
))
