...
| -------------------------------------- | ------------------- | ------------------------------------------------------------ |
| `div.ui-rating__root`                  | `role="radiogroup"` | ラジオグループであることを示します。                         |
|                                        | `aria-label`        | 選択されたアイテムの数を示します。                           |
|                                        | `aria-readonly`     | `readOnly`が設定されている場合は`"true"`を設定します。       |
|                                        | `aria-disabled`     | `disabled`が設定されている場合は`"true"`を設定します。       |
| `.ui-rating__item input[type="radio"]` | `aria-label`        | 各評価項目の`value`を設定します。                            |
| `.ui-rating__icon svg`                 | `aria-hidden`       | 装飾用の評価アイコンをアクセシビリティツリーから除外します。 |
