...
As of Next.js 13, `server components` are used by default. However, **Yamada UI is a `client component`**.
...
```tsx live=false title=layout.tsx highlight={16,18,19,21,22}
"use client"
