import{a as d}from"./jsx-runtime-29545a09.js";import{a as p,b as a}from"./factory-ea08dcfd.js";import{B as u}from"./box-3f91afd2.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-55b21f7f.js";const x={title:"System / Styles / Color Scheme"},o=()=>{const{colorMode:e}=p();return d(u,{bg:["blackAlpha.800","whiteAlpha.800"],p:"md",rounded:"md",color:["whiteAlpha.800","blackAlpha.800"],transitionProperty:"all",transitionDuration:"normal",children:['The current colorMode is "',e,'"']})},r=()=>{const{colorMode:e}=p(),m=a("blackAlpha.800","whiteAlpha.800"),h=a("whiteAlpha.800","blackAlpha.800");return d(u,{bg:m,p:"md",rounded:"md",color:h,transitionProperty:"all",transitionDuration:"normal",children:['The current colorMode is "',e,'"']})};var t,l,s;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
...
//# sourceMappingURL=color-scheme.stories-f8ed3ecf.js.map
