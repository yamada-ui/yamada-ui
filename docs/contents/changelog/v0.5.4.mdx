---
title: Version 0.5.4
description: Explore the changelog for Yamada UI version 0.5.4. Learn about the latest features, bug fixes, and improvements.
release_url: https://github.com/hirotomoyamada/yamada-ui/pull/122
