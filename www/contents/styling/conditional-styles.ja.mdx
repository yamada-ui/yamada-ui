...
条件付きスタイルを使用することで、[擬似要素](/docs/styling/style-props#pseudo-elements)、[擬似クラス](/docs/styling/style-props#pseudo-classes)、[セレクター](/docs/styling/style-props#selectors)のスタイルを適用できます。
...
:::note
利用可能な擬似要素は[Style Propsのリファレンス](/docs/styling/style-props#pseudo-elements)をご覧ください。
:::
...
:::note
利用可能な擬似クラスは[Style Propsのリファレンス](/docs/styling/style-props#pseudo-classes)をご覧ください。
:::
...
:::note
利用可能なセレクターは[Style Propsのリファレンス](/docs/styling/style-props#selectors)をご覧ください。
:::
...
:::note
利用可能なグループセレクターは[Style Propsのリファレンス](/docs/styling/style-props#selectors)をご覧ください。
:::
...
:::note
利用可能な兄弟セレクターは[Style Propsのリファレンス](/docs/styling/style-props#selectors)をご覧ください。
:::
