...
:::note
`Motion`は、内部で[Motion](https://motion.dev)を使用しています。さらに詳しくコンポーネントの機能を知りたい場合は、[Motion component](https://motion.dev/docs/react-motion-component)をご覧ください。
:::
...
:::note
ホバーのアニメーションをもっと知りたい場合は、[Hover animation](https://motion.dev/docs/react-hover-animation)をご覧ください。
:::
...
:::note
ドラッグのアニメーションをもっと知りたい場合は、[Drag](https://motion.dev/docs/react-drag)をご覧ください。
:::
