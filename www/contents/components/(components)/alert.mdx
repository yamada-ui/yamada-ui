...
:::tip
If you want to display application notifications as popups, use [useNotice](/docs/hooks/use-notice).
:::

:::tip
If you want to display notifications such as form feedback as popup elements within a component, use [Snacks](/docs/components/snacks).
:::
...
| -------------------- | -------------------- | ------------------------------ |
| `div.ui-alert__root` | `role="alert"`       | Indicates that it is an alert. |
