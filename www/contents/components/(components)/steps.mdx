...
| `Enter`, `Space` | Activate the focused trigger and move to the next step. | -     |

### ARIA Roles and Attributes

| Element                   | Roles and Attributes  | Usage                                                    |
| ------------------------- | --------------------- | -------------------------------------------------------- |
| `li.ui-steps__item`       | `aria-current="step"` | Indicates the current step.                              |
|                           | `aria-labelledby`     | Sets the `id` of the associated `div.ui-steps__content`. |
| `div.ui-steps__separator` | `role="separator"`    | Indicates that this is a separator.                      |
