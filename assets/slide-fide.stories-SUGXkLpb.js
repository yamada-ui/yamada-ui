...
}`,...(f=(h=c.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var w,B,x;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`() => {
  const [isOpen, {
    toggle
  }] = useBoolean();
  return <>
...
}`,...(x=(B=p.parameters)==null?void 0:B.docs)==null?void 0:x.source}}};var O,b,C;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`() => {
  const [isOpen, {
    toggle
  }] = useBoolean();
  return <>
...
}`,...(C=(b=u.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};var k,S,F;a.parameters={...a.parameters,docs:{...(k=a.parameters)==null?void 0:k.docs,source:{originalSource:`() => {
  const [isOpen, {
    toggle
  }] = useBoolean();
  return <>
...
}`,...(X=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:X.source}}};const Z=["basic","withDuration","withOffsetX","withOffsetY","exitUnmount"];export{Z as __namedExportsOrder,c as basic,W as default,m as exitUnmount,p as withDuration,u as withOffsetX,a as withOffsetY};
