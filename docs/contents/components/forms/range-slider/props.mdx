...
<PropsCard
  ...
  name="thumbSize"
  type='UIValue<number | "px" | (string & {}) | "min" | "max" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "sm" | "md" | "lg" | "xl" | "2xl" | "-moz-max-content" | ... 59 more ... | "min-intrinsic">'
  description={
...
<PropsCard
  ...
  name="trackSize"
  type='UIValue<number | "px" | (string & {}) | "min" | "max" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "sm" | "md" | "lg" | "xl" | "2xl" | "-moz-max-content" | ... 55 more ... | "9xl">'
