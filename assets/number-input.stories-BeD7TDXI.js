...
}`,...(we=(Ve=y.parameters)==null?void 0:Ve.docs)==null?void 0:we.source}}};var Fe,Ce,De;V.parameters={...V.parameters,docs:{...(Fe=V.parameters)==null?void 0:Fe.docs,source:{originalSource:`() => {
  interface Data {
    numberInput: string;
  }
...
}`,...(De=(Ce=V.parameters)==null?void 0:Ce.docs)==null?void 0:De.source}}};const sr=["basic","withSize","withVariant","withBorderColor","withDefaultValue","withMinMax","withStep","withPrecision","disabledClampValueOnBlur","disabledKeepWithinRange","isDisabled","isReadonly","isInvalid","customStepper","customComponent","stylingPlaceholder","reactHookForm","reactHookFormWithDefaultValue"];export{sr as __namedExportsOrder,u as basic,N as customComponent,S as customStepper,tr as default,x as disabledClampValueOnBlur,f as disabledKeepWithinRange,g as isDisabled,j as isInvalid,I as isReadonly,y as reactHookForm,V as reactHookFormWithDefaultValue,v as stylingPlaceholder,m as withBorderColor,c as withDefaultValue,p as withMinMax,b as withPrecision,i as withSize,h as withStep,d as withVariant};
