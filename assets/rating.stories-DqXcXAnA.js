...
}`,...(Ne=(Ae=q.parameters)==null?void 0:Ae.docs)==null?void 0:Ne.source}}};var Ge,Le,Ue;J.parameters={...J.parameters,docs:{...(Ge=J.parameters)==null?void 0:Ge.docs,source:{originalSource:`() => {
...
}`,...(Ue=(Le=J.parameters)==null?void 0:Le.docs)==null?void 0:Ue.source}}};var Ye,He,Ke;Q.parameters={...Q.parameters,docs:{...(Ye=Q.parameters)==null?void 0:Ye.docs,source:{originalSource:`() => {
  const getColor = (value: number) => {
    switch (value) {
      case 1:
        return "red.500";
...
}`,...(Ke=(He=Q.parameters)==null?void 0:He.docs)==null?void 0:Ke.source}}};var We,Xe,qe;Z.parameters={...Z.parameters,docs:{...(We=Z.parameters)==null?void 0:We.docs,source:{originalSource:`() => {
  const [value, onChange] = useState<number>(3);
  return <Rating value={value} onChange={onChange} />;
}`,...(qe=(Xe=Z.parameters)==null?void 0:Xe.docs)==null?void 0:qe.source}}};var Je,Qe,Ze;ee.parameters={...ee.parameters,docs:{...(Je=ee.parameters)==null?void 0:Je.docs,source:{originalSource:`() => {
  type Data = {
    rating: number;
  };
...
}`,...(Ze=(Qe=ee.parameters)==null?void 0:Qe.docs)==null?void 0:Ze.source}}};const un=["basic","withSize","withColorScheme","withDefaultValue","withItems","withFractions","withHighlightSelectedOnly","isDisabled","isReadonly","customColor","customIcon","customControl","reactHookForm"];export{un as __namedExportsOrder,G as basic,J as customColor,Z as customControl,Q as customIcon,ln as default,X as isDisabled,q as isReadonly,ee as reactHookForm,U as withColorScheme,Y as withDefaultValue,K as withFractions,W as withHighlightSelectedOnly,H as withItems,L as withSize};
