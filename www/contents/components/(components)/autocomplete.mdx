...
:::tip
If you want users to select an item without filtering options based on input, use [Select](/docs/components/select).
:::
...
| ------------------------------ | ------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `div.ui-autocomplete__root`    | `role="group"`            | Indicates that this is a grouped input control container for the autocomplete field and related elements.       |
| `div.ui-autocomplete__field`   | `role="combobox"`         | Indicates that this is a combobox.                                                                              |
...
|                                | `aria-activedescendant`   | Sets the `id` of the focused option.                                                                            |
|                                | `aria-disabled`           | Sets to `"true"` when `disabled` or `readOnly` is set.                                                          |
|                                | `aria-labelledby`         | If `Autocomplete.Root` is within a `Field.Root` and `Field.Root` has a `label` or `Field.Label`, sets its `id`. |
| `div.ui-autocomplete__content` | `role="listbox"`          | Indicates that this is a listbox.                                                                               |
|                                | `id`                      | Used to associate with `aria-controls` of `div.ui-autocomplete__field`.                                         |
| `div.ui-autocomplete__option`  | `role="option"`           | Indicates that this is an option.                                                                               |
...
| `div.ui-autocomplete__group`   | `role="group"`            | Indicates that this is a group.                                                                                 |
|                                | `aria-labelledby`         | Sets the `id` of the associated `span.ui-autocomplete__label`.                                                  |
| `span.ui-autocomplete__label`  | `role="presentation"`     | Indicates that this is presentational.                                                                          |
|                                | `id`                      | Used to associate with `aria-labelledby` of `div.ui-autocomplete__group`.                                       |
| `div.ui-autocomplete__icon`    | `role="button"`           | When `clearable` is set and a value is selected, indicates that this is a button.                               |
|                                | `aria-label`              | When `clearable` is set and a value is selected, sets to `"Clear value"`.                                       |
|                                | `aria-disabled`           | When `clearable` is set and a value is selected, sets to `"true"` if `disabled` or `readOnly` is set.           |
