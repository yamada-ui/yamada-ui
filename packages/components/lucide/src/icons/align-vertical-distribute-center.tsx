...
import { AlignVerticalDistributeCenter as OriginalAlignVerticalDistributeCenter } from "lucide-react"
 ...
 */
export const AlignVerticalDistributeCenterIcon = forwardRef<IconProps, "svg">(
  (props, ref) => (
    <Icon ref={ref} as={OriginalAlignVerticalDistributeCenter} {...props} />
  ),
)
