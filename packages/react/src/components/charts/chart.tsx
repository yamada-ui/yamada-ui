...
interface ComponentContext
  extends Pick<ChartProps, "legendProps" | "tooltipProps"> {
  varMap: Dict<string>
}

export interface ChartProps<Y extends Dict = Dict>
  extends HTMLStyledProps,
    ThemeProps<ChartStyle> {
  components: {
...
interface ChartLegendContext
  extends Pick<UseChartLegendReturn, "getLegendItemProps"> {}
...
export interface ChartLegendProps
  extends Merge<HTMLStyledProps, UseChartLegendProps> {
  /**
