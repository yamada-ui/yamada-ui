...
import { SquareArrowOutDownLeft as OriginalSquareArrowOutDownLeft } from "lucide-react"
 ...
 */
export const SquareArrowOutDownLeftIcon = forwardRef<IconProps, "svg">(
  (props, ref) => (
    <Icon ref={ref} as={OriginalSquareArrowOutDownLeft} {...props} />
  ),
)
