...
import { BookOpenText as OriginalBookOpenText } from "lucide-react"
 ...
 */
export const BookOpenTextIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalBookOpenText} {...props} />
))
