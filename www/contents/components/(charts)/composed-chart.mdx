...
| ------------ | --------------------------------------------------------------------------- | -------------------- |
| `ArrowRight` | Updates the active data point to the next one and displays the tooltip.     | `withTooltip={true}` |
| `ArrowLeft`  | Updates the active data point to the previous one and displays the tooltip. | `withTooltip={true}` |
...
| --------- | -------------------- | ------------------------------------------------------------------------------------------ |
| `svg`     | `role="application"` | Indicates that this is an interactive chart surface.                                       |
| `svg`     | `tabIndex={0}`       | Makes the chart surface focusable while keyboard navigation updates the active data point. |
