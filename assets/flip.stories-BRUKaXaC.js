import{j as e}from"./extends-CwFRzn3r.js";import{r as w}from"./index-BwDkhjyp.js";import{u as Se}from"./index-DAOPkzwd.js";import{m as Fe}from"./forward-ref-scR1bmHx.js";import{a as ze}from"./use-component-style-Givb0biW.js";import{o as Oe}from"./theme-provider-B8NHi_rL.js";import{u as be,c as _,d as P}from"./factory-CBW6YcbY.js";import{m as R}from"./factory-B6ZnNkK9.js";import{A as x,C as f}from"./cherry-D-Ywsj_q.js";import{C as t}from"./center-CfmrFwEl.js";import{T as _e}from"./text-DSnzXlBX.js";import{A as Re}from"./avatar-YBG2YyzN.js";import"./_commonjsHelpers-BosuxZz1.js";import"./motion-B7t0mTYZ.js";import"./lucide-icon-4Wt4_XDL.js";import"./icon-CQ7oKYSm.js";import"./use-var-BcRMoVLh.js";import"./forward-ref-BWI-Phbn.js";import"./use-image-UAMWVfre.js";const ke={enter:({ident:n,isVisible:o,orientation:i})=>({[i==="horizontal"?"rotateY":"rotateX"]:n==="from"?o?180:0:o?0:180}),exit:({ident:n,orientation:o})=>({[o==="horizontal"?"rotateY":"rotateX"]:n==="from"?0:180})},E={animate:"enter",initial:"exit",variants:ke},r=Fe((n,o)=>{const[i,ce]=w.useState({}),y=w.useRef(null),S=w.useRef(null),[l,pe]=ze("Flip",n),{className:F,defaultValue:xe="from",delay:fe=0,duration:me=.4,from:de,isDisabled:k=!1,isReadOnly:D=!1,orientation:c="horizontal",to:ue,transition:he={},value:ge,onChange:je,...Ce}=Oe(pe),[A,ve]=Se({defaultValue:xe,value:ge,onChange:je}),B=A==="to",we=()=>{D||ve(p=>p==="from"?"to":"from")};be(()=>{const p=y.current,z=S.current;if(!p||!z)return;const O=p.offsetWidth,b=p.offsetHeight,W=z.offsetWidth,H=z.offsetHeight;(O!==W||b!==H)&&console.warn(`Dimensions do not match:
