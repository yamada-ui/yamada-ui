import{r as a,b2 as d,ci as u,j as e,bS as S,a6 as g,V as y,R as m,Q as r}from"./iframe-CDgLy_ZK.js";import{H as T}from"./h-stack-D_HrVrPH.js";import{F as o}from"./for-C8t6YAB3.js";import{H as k}from"./heading-BUeThgHW.js";import{W as s}from"./wrap-Df2J1p-e.js";import{B as f}from"./badge-BDYIzhyg.js";import{T as x}from"./tag-BPLFfjAK.js";import{C as j,a as C,b}from"./container-CdLVrUuA.js";import"./preload-helper-PPVm8Dsz.js";import"./flex-CPhLsyGS.js";import"./index-Cem_xUzx.js";import"./index-SAMFmuym.js";const I={title:"Theme / Theming"},c=()=>{const i=a.useMemo(()=>({...d,themeSchemes:{blue:{semanticTokens:{colorSchemes:{primary:"blue",secondary:"cyan"}}},pink:{semanticTokens:{colorSchemes:{primary:"pink",secondary:"violet"}}},purple:{semanticTokens:{colorSchemes:{primary:"purple",secondary:"green"}}}}}),[]),t=a.useMemo(()=>({...u,initialThemeScheme:"pink"}),[]),h=()=>{const{changeThemeScheme:p,themeScheme:l}=g();return e.jsxs(y,{children:[e.jsx(T,{children:e.jsx(o,{each:["base","pink","purple","blue"],children:n=>e.jsxs(m,{colorScheme:n==="base"?"mono":n,onClick:()=>p(n),children:[r(n)," Theme"]},n)})}),e.jsxs(j,{children:[e.jsx(C,{children:e.jsxs(k,{children:[r(l)," Theme"]})}),e.jsxs(b,{gap:"md",children:[e.jsx(s,{gap:"md",children:e.jsx(o,{each:["primary","secondary","info","success","warning","error"],children:n=>e.jsx(f,{colorScheme:n,children:n},n)})}),e.jsx(s,{gap:"md",children:e.jsx(o,{each:["primary","secondary","info","success","warning","error"],children:n=>e.jsx(x,{colorScheme:n,children:r(n)},n)})}),e.jsx(s,{gap:"md",children:e.jsx(o,{each:["primary","secondary","info","success","warning","error"],children:n=>e.jsx(m,{colorScheme:n,children:r(n)},n)})})]})]})]})};return e.jsx(S,{config:t,theme:i,children:e.jsx(h,{})})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => {
  const theme = useMemo(() => ({
    ...defaultTheme,
    themeSchemes: {
      blue: {
