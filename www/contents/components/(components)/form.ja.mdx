...
| 要素                            | ロールと属性       | 使い方                                                                         |
| ------------------------------- | ------------------ | ------------------------------------------------------------------------------ |
| `form.ui-form__root`            | `id`               | `button.ui-form__submit-button`と関連付けるために使用する`id`。                |
|                                 | `aria-labelledby`  | 関連した`h3.ui-form__title`と`p.ui-form__description`の`id`を設定します。      |
| `h3.ui-form__title`             | `id`               | `form.ui-form__root`や`p.ui-form__description`と関連付けるために使用する`id`。 |
| `p.ui-form__description`        | `id`               | `form.ui-form__root`と関連付けるために使用する`id`。                           |
|                                 | `aria-describedby` | 関連した`h3.ui-form__title`の`id`を設定します。                                |
| `button.ui-form__submit-button` | `form`             | 関連した`form.ui-form__root`の`id`を設定します。                               |
