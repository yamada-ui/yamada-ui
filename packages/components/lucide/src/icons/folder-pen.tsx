...
import { FolderPen as OriginalFolderPen } from "lucide-react"
 ...
 */
export const FolderPenIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalFolderPen} {...props} />
))
