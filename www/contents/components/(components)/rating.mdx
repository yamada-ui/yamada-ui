...
| -------------------------------------- | -------------------- | --------------------------------------------------------------- |
| `div.ui-rating__root`                  | `role="radiogroup"`  | Indicates that this is a radio group.                           |
...
| `.ui-rating__item input[type="radio"]` | `aria-label`         | Set to each rating item's `value`.                              |
| `.ui-rating__icon svg`                 | `aria-hidden`        | Exclude the decorative rating icon from the accessibility tree. |
