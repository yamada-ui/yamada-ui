...
| `div.ui-tree__item`       | `role="treeitem"`      | Indicates that the element is a tree item.                                                      |
...
|                           | `aria-labelledby`      | Sets the `id` of the related `span.ui-tree__label`.                                             |
| `span.ui-tree__label`     | `id`                   | Used to associate with `div.ui-tree__item`, `ul.ui-tree__group`, and `input.ui-tree__checkbox`. |
