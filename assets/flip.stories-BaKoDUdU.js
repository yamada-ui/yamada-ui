import{j as e}from"./jsx-runtime-CfatFE5O.js";import{r as w}from"./index-ClcD9ViR.js";import{u as ze}from"./index-DKQLNlvR.js";import{m as Oe}from"./forward-ref-2BKBy0Yi.js";import{a as be}from"./use-component-style-DXYrx7jC.js";import{o as _e}from"./theme-provider-BsBO7Bt7.js";import{u as Ie,c as k,d as H}from"./factory-Nur_zO5a.js";import{m as R}from"./factory-C7oui4wX.js";import{A as x,C as f}from"./cherry-BcwxjfdV.js";import{C as t}from"./center-DbI1M6cv.js";import{T as ke}from"./text-62Futka0.js";import{A as Re}from"./avatar-CnoCZyAe.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./proxy-BYKFXsWv.js";import"./icon-M07mMfJs.js";import"./use-var-BmU0CMcq.js";import"./forward-ref-D13m8o2p.js";import"./createLucideIcon-C_T9K6g-.js";import"./use-image-CmKgOqFG.js";const Ae={enter:({ident:n,isVisible:o,orientation:i})=>({[i==="horizontal"?"rotateY":"rotateX"]:n==="from"?o?180:0:o?0:180}),exit:({ident:n,orientation:o})=>({[o==="horizontal"?"rotateY":"rotateX"]:n==="from"?0:180})},P={animate:"enter",initial:"exit",variants:Ae},r=Oe((n,o)=>{const[i,ce]=w.useState({}),y=w.useRef(null),S=w.useRef(null),[l,pe]=be("Flip",n);let{className:F,defaultValue:xe="from",delay:fe=0,disabled:z,duration:me=.4,from:de,isDisabled:ue,isReadOnly:he,orientation:c="horizontal",readOnly:O,to:ge,transition:je={},value:Ce,onChange:ve,...we}=_e(pe);z??(z=ue),O??(O=he);const[A,ye]=ze({defaultValue:xe,value:Ce,onChange:ve}),B=A==="to",Se=()=>{O||ye(p=>p==="from"?"to":"from")};Ie(()=>{const p=y.current,b=S.current;if(!p||!b)return;const _=p.offsetWidth,I=p.offsetHeight,$=b.offsetWidth,W=b.offsetHeight;(_!==$||I!==W)&&console.warn(`Dimensions do not match:
