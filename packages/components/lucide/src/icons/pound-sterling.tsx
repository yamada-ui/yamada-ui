...
import { PoundSterling as OriginalPoundSterling } from "lucide-react"
 ...
 */
export const PoundSterlingIcon = forwardRef<IconProps, "svg">((props, ref) => (
  <Icon ref={ref} as={OriginalPoundSterling} {...props} />
))
