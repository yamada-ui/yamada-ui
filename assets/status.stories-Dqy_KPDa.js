import{d as b,j as e,s as h,l as k,V as w,P as z}from"./iframe-qjGiUz6b.js";import{P as y}from"./props-table-695isBmC.js";import{H as v}from"./h-stack-DHK9Cj-y.js";import"./preload-helper-C1FmrZbK.js";import"./grid-CZYREmgE.js";import"./grid-item-DMIxSy19.js";import"./for-BvpQiPtL.js";import"./flex-BMAQi8a8.js";import"./heading-CexfIZlJ.js";const C=b({base:{indicator:{bg:"colorScheme.solid",flexShrink:0,forcedColorAdjust:"none",rounded:"full"},label:{},root:{alignItems:"center",display:"inline-flex",gap:"sm"}},sizes:{sm:{indicator:{boxSize:"2"},label:{fontSize:"sm"}},md:{indicator:{boxSize:"2.5"},label:{fontSize:"md"}},lg:{indicator:{boxSize:"3"},label:{fontSize:"lg"}}},defaultProps:{size:"md"}}),{withContext:j,withProvider:P}=k("status",C),s=P(({children:r,indicatorProps:t,labelProps:a,...g})=>e.jsxs(h.div,{...g,children:[e.jsx(H,{...t}),e.jsx(T,{...a,children:r})]}),"root")(void 0,({colorScheme:r,value:t="info",...a})=>({colorScheme:r??t,...a})),H=j("div","indicator")(),T=j("p","label")(),R={component:s,title:"Components / Status"},o=()=>e.jsxs(v,{children:[e.jsx(s,{value:"info"}),e.jsx(s,{value:"success"}),e.jsx(s,{value:"warning"}),e.jsx(s,{value:"error"})]}),n=()=>e.jsxs(v,{children:[e.jsx(s,{value:"info",children:"Info"}),e.jsx(s,{value:"success",children:"Success"}),e.jsx(s,{value:"warning",children:"Warning"}),e.jsx(s,{value:"error",children:"Error"})]}),c=()=>e.jsx(w,{children:e.jsx(y,{columns:["info","success","warning","error"],rows:["sm","md","lg"],children:(r,t,a)=>e.jsx(s,{size:t,value:r,children:z(r)},a)})});var i,l,u;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return <HStack>
      <Status value="info" />
