import{az as c,j as p}from"./iframe-Bh9OJiMa.js";import{u as e}from"./index-IKP2hWx8.js";import{B as u}from"./box-Bg2AiZ11.js";import{u as d}from"./use-breakpoint-Ccmb_yNp.js";import"./preload-helper-C1FmrZbK.js";import"./use-breakpoint-value-DH9gKxXR.js";import"./use-color-mode-value-1gZklRVD.js";const M={title:"Hooks / useValue"},o=()=>{const{colorMode:s}=c(),a=d(),l=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),i=e(["whiteAlpha.800","blackAlpha.800"]);return p.jsxs(u,{bg:l,color:i,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',a,'", colorMode is "',s,'"']})};var r,t,n;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
