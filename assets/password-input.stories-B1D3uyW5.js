import{k as K,E as _,r as G,Z as W,j as e,F as Z,G as L,V as M,T as $,t as d,B,C as J}from"./iframe-Gd2wA5UH.js";import{u as E}from"./index.esm-DjpKUs6E.js";import{P as s}from"./password-input-BIA9zLEP.js";import{F as l}from"./for-C62laByO.js";import{K as i}from"./key-icon-BwPuF9yr.js";import{F as N,S as Q}from"./smile-icon-CHKVuGAh.js";import{P as T}from"./props-table-hQP5Z1dz.js";import{I as u,b as c,a as O}from"./input-group-Bit_JPDh.js";import{F as p}from"./use-field-props-D4qWu9wV.js";import"./preload-helper-PPVm8Dsz.js";import"./input-Br3BRLxR.js";import"./use-input-border-pIvjYctk.js";import"./index-BLsJQ0sw.js";import"./group-C7J6mywu.js";import"./index-B69f71zK.js";import"./use-breakpoint-_TvgYbTn.js";import"./use-breakpoint-value-M3SNOELf.js";import"./use-color-mode-value-BkyTpO3Y.js";import"./flex-mFnSfPNF.js";import"./grid-CakiebxH.js";import"./grid-item-Dj5TeVSg.js";import"./heading-CalVy3eO.js";const U=K({base:{indicator:{bg:"bg.subtle",flex:"1",h:"1",rounded:"l1"},indicators:{display:"flex",gap:"sm",transitionDuration:"moderate",transitionProperty:"common",w:"full"},label:{color:"fg.muted",fontSize:"xs"},root:{alignItems:"end",display:"flex",flexDirection:"column",gap:"xs",w:"full"}}}),X=({max:r=4,value:o,...a})=>{const{t}=_("passwordInput"),n=G.useCallback(h=>({"aria-label":t("Password strength meter"),"aria-valuemax":r,"aria-valuemin":0,"aria-valuenow":o,role:"meter",...a,...h}),[r,a,o,t]);return{getIndicatorProps:G.useCallback(({index:h,...x})=>({"data-selected":W(h<o),...x}),[o]),getRootProps:n}},{withContext:A,withProvider:ee}=L("strength-meter",U),re=ee(({max:r=4,value:o,withLabel:a=!0,getIndicatorProps:t,...n})=>{const m=o/r*100;t??=Y=>{switch(!0){case Y<33:return{label:"Low",_selected:{bg:"red.500"}};case Y<66:return{label:"Medium",_selected:{bg:"orange.500"}};default:return{label:"High",_selected:{bg:"green.500"}}}};const{label:x,...q}=t(m),{getIndicatorProps:z,getRootProps:H}=X({max:r,value:o,...n});return e.jsxs(Z.div,{...H(),children:[e.jsx(oe,{children:Array.from({length:r}).map((Y,D)=>e.jsx(se,{...z({index:D,...q})},D))}),a&&x?e.jsx(te,{children:x}):null]})},"root")(),oe=A("div","indicators")(),se=A("div","indicator")(),te=A("span","label")(),Fe={component:s,title:"Components / PasswordInput"},g=()=>e.jsx(s,{placeholder:"Your password"}),f=()=>e.jsx(T,{variant:"stack",columns:["outline","filled","flushed"],rows:J,children:(r,o,a)=>e.jsx(s,{colorScheme:o,variant:r,placeholder:d(r)},a)}),w=()=>e.jsx(T,{variant:"stack",columns:["xs","sm","md","lg","xl"],rows:["outline","filled","flushed"],children:(r,o,a)=>e.jsx(s,{size:r,variant:o,placeholder:`Size (${r})`},a)}),b=()=>e.jsx(s,{defaultValue:"password",defaultVisible:!0,placeholder:"Your password"}),I=()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(s,{variant:r,disabled:!0,placeholder:d(r)},o)}),e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(u,{variant:r,disabled:!0,children:[e.jsx(c,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:d(r)})]},o)}),e.jsx(p,{disabled:!0,helperMessage:"We'll never share your password.",label:"Password",children:e.jsx(s,{placeholder:"Your password"})})]}),S=()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(s,{variant:r,placeholder:d(r),readOnly:!0},o)}),e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(u,{variant:r,readOnly:!0,children:[e.jsx(c,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:d(r)})]},o)}),e.jsx(p,{helperMessage:"We'll never share your password.",label:"Password",readOnly:!0,children:e.jsx(s,{placeholder:"Your password"})})]}),j=()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsx(s,{variant:r,invalid:!0,placeholder:d(r)},o)}),e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(u,{variant:r,invalid:!0,children:[e.jsx(c,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:d(r)})]},o)}),e.jsx(p,{errorMessage:"Email is required.",invalid:!0,label:"Password",children:e.jsx(s,{placeholder:"Your password"})})]}),v=()=>e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(u,{variant:r,children:[e.jsx(c,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:"Your password"})]},o)}),P=()=>e.jsx(l,{each:["outline","filled","flushed"],children:(r,o)=>e.jsxs(u,{variant:r,children:[e.jsx(O,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:"Your password"})]},o)}),y=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{placeholder:"Default border color"}),e.jsx(s,{focusBorderColor:"green.500",placeholder:"Custom border color"}),e.jsxs(u,{variant:"flushed",focusBorderColor:"green.500",children:[e.jsx(O,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:"Custom border color"})]}),e.jsx(s,{errorBorderColor:"orange.500",invalid:!0,placeholder:"Custom border color"}),e.jsxs(u,{errorBorderColor:"orange.500",invalid:!0,children:[e.jsx(c,{children:e.jsx(i,{})}),e.jsx(s,{placeholder:"Custom border color"})]})]}),C=()=>{const[r,o]=G.useState("Password"),a=t=>{let n=0;return t.length>=8&&n++,/[A-Z]/.test(t)&&n++,/[0-9]/.test(t)&&n++,/[^A-Za-z0-9]/.test(t)&&n++,n};return e.jsxs(M,{children:[e.jsx(s,{placeholder:"Your password",value:r,onChange:t=>o(t.target.value)}),e.jsx(re,{value:a(r)})]})},F=()=>e.jsx(s,{placeholder:"Your password",visibilityIcon:{off:e.jsx(Q,{}),on:e.jsx(N,{})}}),R=()=>{const[r,o]=G.useState(!0);return e.jsxs(M,{children:[e.jsxs($,{children:["Password visibility: ",r?"show":"hide"]}),e.jsx(s,{placeholder:"Your password",visible:r,onVisibleChange:o})]})},k=()=>{const{formState:{errors:r},handleSubmit:o,register:a}=E(),t=n=>console.log("submit:",n);return e.jsxs(M,{as:"form",onSubmit:o(t),children:[e.jsx(p,{errorMessage:r.password?.message,invalid:!!r.password,label:"Password",children:e.jsx(s,{...a("password",{required:{message:"Password is required.",value:!0}})})}),e.jsx(B,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})},V=()=>{const r={password:"password"},{formState:{errors:o},handleSubmit:a,register:t}=E({defaultValues:r}),n=m=>console.log("submit:",m);return e.jsxs(M,{as:"form",onSubmit:a(n),children:[e.jsx(p,{errorMessage:o.password?.message,invalid:!!o.password,label:"Password",children:e.jsx(s,{...t("password",{required:{message:"Password is required.",value:!0}})})}),e.jsx(B,{type:"submit",alignSelf:"flex-end",children:"Submit"})]})};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {
