...
### Change Speed of Slide Transition
...
### Change Slide Alignment

To change the slide alignment, set `align` to `start`, `center`, `end`, or a number. By default, `center` is set.
...
### Change Number of Slides to Scroll
