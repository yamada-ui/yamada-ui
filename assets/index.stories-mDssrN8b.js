import{aC as a,j as l}from"./iframe-C__kp2ks.js";import{u as e}from"./index-D-M46-mS.js";import{B as i}from"./box-CzhcZ9L5.js";import{u as c}from"./use-breakpoint-C5KitVzQ.js";import"./preload-helper-PPVm8Dsz.js";import"./use-breakpoint-value-B8HA7l9O.js";import"./use-color-mode-value-sfPGuesh.js";const g={title:"Hooks / useValue"},o=()=>{const{colorMode:r}=a(),t=c(),n=e({base:"red.500",sm:"purple.500",md:"yellow.500",lg:"green.500",xl:"blue.500"}),s=e(["whiteAlpha.800","blackAlpha.800"]);return l.jsxs(i,{bg:n,color:s,p:"md",rounded:"l2",transitionDuration:"moderate",transitionProperty:"all",children:['The current breakpoint is "',t,'", colorMode is "',r,'"']})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
  const {
    colorMode
  } = useColorMode();
