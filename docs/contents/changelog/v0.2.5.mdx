---
title: Version 0.2.5
description: Explore the changelog for Yamada UI version 0.2.5. Learn about the latest features, bug fixes, and improvements.
release_url: https://github.com/hirotomoyamada/yamada-ui/pull/96
