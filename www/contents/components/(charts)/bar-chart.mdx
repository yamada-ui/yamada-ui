...
| ------------ | ---------------------------------------------------------- | -------------------- |
| `ArrowRight` | Moves to the next data point and displays the tooltip.     | `withTooltip={true}` |
| `ArrowLeft`  | Moves to the previous data point and displays the tooltip. | `withTooltip={true}` |
