...
::::card-group
:::card{href="/docs/get-started/advanced" title="Learn the Advanced"}

Learn the applications of styling, responsiveness, dark mode, and animations of Yamada UI.

:::
:::card{href="/docs/components" title="Explore the Components"}

Yamada UI provides over 130 flexible components. All components support animations and dark mode.

:::
:::card{href="/docs/styling" title="Learn the Styling"}

All components are designed to be styled using props.

:::
:::card{href="https://github.com/yamada-ui/yamada-ui" title="Explore the Source Code"}
