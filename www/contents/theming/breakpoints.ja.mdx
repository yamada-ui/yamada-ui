...
:::tip
概要は[レスポンシブデザインのドキュメント](/docs/styling/responsive-design)をご覧ください。
:::
...
テーマに定義されているブレイクポイントは[breakpoints.ts](https://github.com/yamada-ui/yamada-ui/blob/main/packages/react/src/theme/tokens/breakpoints.ts)にあります。
