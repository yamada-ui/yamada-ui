...
- `DialogOverlay`: The overlay component that exists behind the dialog.
...
:::note
The dialog is a simplified component of a modal.
:::
...
You can set `props` for `cancel` and `success` buttons.
...
If you want to customize the `DialogCloseButton` by passing `props`, do not omit it and set it accordingly.
...
If you want to customize the `DialogOverlay` by passing `props`, do not omit it and set it accordingly.
