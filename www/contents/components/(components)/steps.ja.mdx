...
| キー             | 説明                                       | 状態                                     |
| ---------------- | ------------------------------------------ | ---------------------------------------- |
| `Tab`            | 次のフォーカス可能な要素に移動します。     | -                                        |
| `Space`, `Enter` | ボタンをクリックし、ステップを移動します。 | `Steps.PrevTrigger`, `Steps.NextTrigger` |

### ARIAロールと属性

| コンポーネント    | ロールと属性          | 使い方                                      |
| ----------------- | --------------------- | ------------------------------------------- |
| `Steps.Item`      | `aria-current="step"` | 現在のステップを示します。                  |
|                   | `aria-labelledby`     | 関連する`Steps.Content`の`id`を設定します。 |
| `Steps.Separator` | `role="separator"`    | セパレーターであることを示します。          |
